...
class Api @Inject() (ws: WSClient) extends PlayApi {
	...
	object membershipsLevels {
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.MembershipsLevelListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.MembershipsLevelListResponse])
		}
		object list {
			def apply(part: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"youtube/v3/membershipsLevels").addQueryStringParameters("part" -> part.toString))
	...
	object superChatEvents {
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SuperChatEventListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SuperChatEventListResponse])
		}
		object list {
			def apply(pageToken: String, hl: String, maxResults: Int, part: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"youtube/v3/superChatEvents").addQueryStringParameters("pageToken" -> pageToken.toString, "hl" -> hl.toString, "maxResults" -> maxResults.toString, "part" -> part.toString))
			given Conversion[list, Future[Schema.SuperChatEventListResponse]] = (fun: list) => fun.apply()
		}
	}
	object thirdPartyLinks {
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withThirdPartyLink(body: Schema.ThirdPartyLink) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.ThirdPartyLink])
		}
		object update {
			def apply(part: String, externalChannelId: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"youtube/v3/thirdPartyLinks").addQueryStringParameters("part" -> part.toString, "externalChannelId" -> externalChannelId.toString))
		}
		...
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withThirdPartyLink(body: Schema.ThirdPartyLink) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.ThirdPartyLink])
		}
		object insert {
			def apply(part: String, externalChannelId: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(ws.url(BASE_URL + s"youtube/v3/thirdPartyLinks").addQueryStringParameters("part" -> part.toString, "externalChannelId" -> externalChannelId.toString))
		}
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ThirdPartyLinkListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ThirdPartyLinkListResponse])
		}
		object list {
	...
	object liveChatMessages {
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withLiveChatMessage(body: Schema.LiveChatMessage) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.LiveChatMessage])
		}
		object insert {
			def apply(part: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(ws.url(BASE_URL + s"youtube/v3/liveChat/messages").addQueryStringParameters("part" -> part.toString))
		}
		class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Unit]) {
			def apply() = auth.exec(req,_.execute("DELETE")).map(_ => ())
		}
		object delete {
			def apply(id: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"youtube/v3/liveChat/messages").addQueryStringParameters("id" -> id.toString))
			given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
		}
		class transition(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.LiveChatMessage]) {
			def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.LiveChatMessage])
		}
		object transition {
			def apply(status: String, id: String)(using auth: AuthToken, ec: ExecutionContext): transition = new transition(ws.url(BASE_URL + s"youtube/v3/liveChat/messages/transition").addQueryStringParameters("status" -> status.toString, "id" -> id.toString))
		...
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.LiveChatMessageListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.LiveChatMessageListResponse])
		}
		object list {
	...
	object playlistItems {
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withPlaylistItem(body: Schema.PlaylistItem) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.PlaylistItem])
		}
		object update {
			def apply(onBehalfOfContentOwner: String, part: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"youtube/v3/playlistItems").addQueryStringParameters("onBehalfOfContentOwner" -> onBehalfOfContentOwner.toString, "part" -> part.toString))
		}
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withPlaylistItem(body: Schema.PlaylistItem) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.PlaylistItem])
		}
		object insert {
			def apply(part: String, onBehalfOfContentOwner: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(ws.url(BASE_URL + s"youtube/v3/playlistItems").addQueryStringParameters("part" -> part.toString, "onBehalfOfContentOwner" -> onBehalfOfContentOwner.toString))
		}
		class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Unit]) {
			def apply() = auth.exec(req,_.execute("DELETE")).map(_ => ())
		}
		object delete {
			def apply(id: String, onBehalfOfContentOwner: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"youtube/v3/playlistItems").addQueryStringParameters("id" -> id.toString, "onBehalfOfContentOwner" -> onBehalfOfContentOwner.toString))
			given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
		}
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.PlaylistItemListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.PlaylistItemListResponse])
		}
		object list {
	...
	object commentThreads {
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withCommentThread(body: Schema.CommentThread) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.CommentThread])
		}
		object insert {
			def apply(part: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(ws.url(BASE_URL + s"youtube/v3/commentThreads").addQueryStringParameters("part" -> part.toString))
		}
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.CommentThreadListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.CommentThreadListResponse])
		}
		object list {
	...
	object liveBroadcasts {
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withLiveBroadcast(body: Schema.LiveBroadcast) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.LiveBroadcast])
		}
		object insert {
		...
		class transition(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.LiveBroadcast]) {
			def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.LiveBroadcast])
		}
		object transition {
		...
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withLiveBroadcast(body: Schema.LiveBroadcast) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.LiveBroadcast])
		}
		object update {
		...
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.LiveBroadcastListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.LiveBroadcastListResponse])
		}
		object list {
		...
		class insertCuepoint(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withCuepoint(body: Schema.Cuepoint) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Cuepoint])
		}
	...
	object videoAbuseReportReasons {
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.VideoAbuseReportReasonListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.VideoAbuseReportReasonListResponse])
		}
		object list {
			def apply(part: String, hl: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"youtube/v3/videoAbuseReportReasons").addQueryStringParameters("part" -> part.toString, "hl" -> hl.toString))
	...
	object playlists {
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.PlaylistListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.PlaylistListResponse])
		}
		object list {
		...
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withPlaylist(body: Schema.Playlist) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.Playlist])
		}
		object update {
			def apply(part: String, onBehalfOfContentOwner: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"youtube/v3/playlists").addQueryStringParameters("part" -> part.toString, "onBehalfOfContentOwner" -> onBehalfOfContentOwner.toString))
		}
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withPlaylist(body: Schema.Playlist) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Playlist])
		}
		object insert {
		...
		object delete {
			def apply(id: String, onBehalfOfContentOwner: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"youtube/v3/playlists").addQueryStringParameters("id" -> id.toString, "onBehalfOfContentOwner" -> onBehalfOfContentOwner.toString))
			given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
		}
	}
	object activities {
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ActivityListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ActivityListResponse])
		}
		object list {
	...
	object tests {
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withTestItem(body: Schema.TestItem) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.TestItem])
		}
		object insert {
			def apply(part: String, externalChannelId: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(ws.url(BASE_URL + s"youtube/v3/tests").addQueryStringParameters("part" -> part.toString, "externalChannelId" -> externalChannelId.toString))
		}
	}
	object liveChatBans {
		class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Unit]) {
		...
		object delete {
			def apply(id: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"youtube/v3/liveChat/bans").addQueryStringParameters("id" -> id.toString))
			given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
		}
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withLiveChatBan(body: Schema.LiveChatBan) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.LiveChatBan])
		}
		object insert {
			def apply(part: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(ws.url(BASE_URL + s"youtube/v3/liveChat/bans").addQueryStringParameters("part" -> part.toString))
		}
	}
	object comments {
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
		...
		object insert {
			def apply(part: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(ws.url(BASE_URL + s"youtube/v3/comments").addQueryStringParameters("part" -> part.toString))
		}
		class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Unit]) {
			def apply() = auth.exec(req,_.execute("DELETE")).map(_ => ())
		}
		object delete {
			def apply(id: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"youtube/v3/comments").addQueryStringParameters("id" -> id.toString))
			given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
		}
		...
		object markAsSpam {
			def apply(id: String)(using auth: AuthToken, ec: ExecutionContext): markAsSpam = new markAsSpam(ws.url(BASE_URL + s"youtube/v3/comments/markAsSpam").addQueryStringParameters("id" -> id.toString))
			given Conversion[markAsSpam, Future[Unit]] = (fun: markAsSpam) => fun.apply()
		}
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withComment(body: Schema.Comment) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.Comment])
		}
		object update {
			def apply(part: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"youtube/v3/comments").addQueryStringParameters("part" -> part.toString))
		}
		...
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.CommentListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.CommentListResponse])
		}
		object list {
	...
	object watermarks {
		class set(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withInvideoBranding(body: Schema.InvideoBranding) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_ => ())
		}
		object set {
			def apply(onBehalfOfContentOwner: String, channelId: String)(using auth: AuthToken, ec: ExecutionContext): set = new set(ws.url(BASE_URL + s"youtube/v3/watermarks/set").addQueryStringParameters("onBehalfOfContentOwner" -> onBehalfOfContentOwner.toString, "channelId" -> channelId.toString))
		}
		class unset(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Unit]) {
			def apply() = auth.exec(req,_.execute("POST")).map(_ => ())
		}
		object unset {
			def apply(channelId: String, onBehalfOfContentOwner: String)(using auth: AuthToken, ec: ExecutionContext): unset = new unset(ws.url(BASE_URL + s"youtube/v3/watermarks/unset").addQueryStringParameters("channelId" -> channelId.toString, "onBehalfOfContentOwner" -> onBehalfOfContentOwner.toString))
	...
	object i18nRegions {
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.I18nRegionListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.I18nRegionListResponse])
		}
		object list {
			def apply(hl: String, part: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"youtube/v3/i18nRegions").addQueryStringParameters("hl" -> hl.toString, "part" -> part.toString))
	...
	object liveStreams {
		...
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.LiveStreamListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.LiveStreamListResponse])
		}
		object list {
		...
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withLiveStream(body: Schema.LiveStream) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.LiveStream])
		}
		object update {
		...
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withLiveStream(body: Schema.LiveStream) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.LiveStream])
		}
		object insert {
	...
	object abuseReports {
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withAbuseReport(body: Schema.AbuseReport) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.AbuseReport])
		}
		object insert {
			def apply(part: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(ws.url(BASE_URL + s"youtube/v3/abuseReports").addQueryStringParameters("part" -> part.toString))
		}
	}
	object videoCategories {
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.VideoCategoryListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.VideoCategoryListResponse])
		}
		object list {
			def apply(id: String, regionCode: String, hl: String, part: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"youtube/v3/videoCategories").addQueryStringParameters("id" -> id.toString, "regionCode" -> regionCode.toString, "hl" -> hl.toString, "part" -> part.toString))
	...
	object videos {
		...
		object rate {
			def apply(rating: String, id: String)(using auth: AuthToken, ec: ExecutionContext): rate = new rate(ws.url(BASE_URL + s"youtube/v3/videos/rate").addQueryStringParameters("rating" -> rating.toString, "id" -> id.toString))
		...
		class reportAbuse(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withVideoAbuseReport(body: Schema.VideoAbuseReport) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_ => ())
		}
		object reportAbuse {
			def apply(onBehalfOfContentOwner: String)(using auth: AuthToken, ec: ExecutionContext): reportAbuse = new reportAbuse(ws.url(BASE_URL + s"youtube/v3/videos/reportAbuse").addQueryStringParameters("onBehalfOfContentOwner" -> onBehalfOfContentOwner.toString))
		}
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withVideo(body: Schema.Video) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Video])
		}
		object insert {
		...
		class getRating(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.VideoGetRatingResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.VideoGetRatingResponse])
		}
		object getRating {
			def apply(onBehalfOfContentOwner: String, id: String)(using auth: AuthToken, ec: ExecutionContext): getRating = new getRating(ws.url(BASE_URL + s"youtube/v3/videos/getRating").addQueryStringParameters("onBehalfOfContentOwner" -> onBehalfOfContentOwner.toString, "id" -> id.toString))
		...
		object delete {
			def apply(id: String, onBehalfOfContentOwner: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"youtube/v3/videos").addQueryStringParameters("id" -> id.toString, "onBehalfOfContentOwner" -> onBehalfOfContentOwner.toString))
			given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
		}
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withVideo(body: Schema.Video) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.Video])
		}
		object update {
			def apply(onBehalfOfContentOwner: String, part: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"youtube/v3/videos").addQueryStringParameters("onBehalfOfContentOwner" -> onBehalfOfContentOwner.toString, "part" -> part.toString))
		}
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.VideoListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.VideoListResponse])
		}
		object list {
	...
	object channelSections {
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ChannelSectionListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ChannelSectionListResponse])
		}
		object list {
		...
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withChannelSection(body: Schema.ChannelSection) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.ChannelSection])
		}
		object update {
			def apply(part: String, onBehalfOfContentOwner: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"youtube/v3/channelSections").addQueryStringParameters("part" -> part.toString, "onBehalfOfContentOwner" -> onBehalfOfContentOwner.toString))
		}
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withChannelSection(body: Schema.ChannelSection) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.ChannelSection])
		}
		object insert {
		...
		object delete {
			def apply(id: String, onBehalfOfContentOwner: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"youtube/v3/channelSections").addQueryStringParameters("id" -> id.toString, "onBehalfOfContentOwner" -> onBehalfOfContentOwner.toString))
			given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
		}
	}
	object channels {
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withChannel(body: Schema.Channel) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.Channel])
		}
		object update {
			def apply(part: String, onBehalfOfContentOwner: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"youtube/v3/channels").addQueryStringParameters("part" -> part.toString, "onBehalfOfContentOwner" -> onBehalfOfContentOwner.toString))
		}
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ChannelListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ChannelListResponse])
		}
		object list {
	...
	object liveChatModerators {
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withLiveChatModerator(body: Schema.LiveChatModerator) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.LiveChatModerator])
		}
		object insert {
			def apply(part: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(ws.url(BASE_URL + s"youtube/v3/liveChat/moderators").addQueryStringParameters("part" -> part.toString))
		}
		class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Unit]) {
			def apply() = auth.exec(req,_.execute("DELETE")).map(_ => ())
		}
		object delete {
			def apply(id: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"youtube/v3/liveChat/moderators").addQueryStringParameters("id" -> id.toString))
			given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
		}
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.LiveChatModeratorListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.LiveChatModeratorListResponse])
		}
		object list {
	...
	object thumbnails {
		class set(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ThumbnailSetResponse]) {
			def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.ThumbnailSetResponse])
		}
		object set {
			def apply(onBehalfOfContentOwner: String, videoId: String)(using auth: AuthToken, ec: ExecutionContext): set = new set(ws.url(BASE_URL + s"youtube/v3/thumbnails/set").addQueryStringParameters("onBehalfOfContentOwner" -> onBehalfOfContentOwner.toString, "videoId" -> videoId.toString))
	...
	object search {
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SearchListResponse])
		}
		object list {
	...
	object members {
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.MemberListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.MemberListResponse])
		}
		object list {
	...
	object captions {
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withCaption(body: Schema.Caption) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Caption])
		}
		object insert {
		...
		object delete {
			def apply(onBehalfOf: String, id: String, onBehalfOfContentOwner: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"youtube/v3/captions").addQueryStringParameters("onBehalfOf" -> onBehalfOf.toString, "id" -> id.toString, "onBehalfOfContentOwner" -> onBehalfOfContentOwner.toString))
			given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
		}
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withCaption(body: Schema.Caption) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.Caption])
		}
		object update {
		...
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.CaptionListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.CaptionListResponse])
		}
		object list {
	...
	object youtube {
		object v3 {
			class updateCommentThreads(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withCommentThread(body: Schema.CommentThread) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.CommentThread])
			}
			object updateCommentThreads {
				def apply(part: String)(using auth: AuthToken, ec: ExecutionContext): updateCommentThreads = new updateCommentThreads(ws.url(BASE_URL + s"youtube/v3/commentThreads").addQueryStringParameters("part" -> part.toString))
			}
			object liveChat {
				object messages {
	...
	object i18nLanguages {
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.I18nLanguageListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.I18nLanguageListResponse])
		}
		object list {
			def apply(part: String, hl: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"youtube/v3/i18nLanguages").addQueryStringParameters("part" -> part.toString, "hl" -> hl.toString))
			given Conversion[list, Future[Schema.I18nLanguageListResponse]] = (fun: list) => fun.apply()
		}
	}
	object playlistImages {
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withPlaylistImage(body: Schema.PlaylistImage) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.PlaylistImage])
		}
		object update {
			def apply(part: String, onBehalfOfContentOwner: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"youtube/v3/playlistImages").addQueryStringParameters("part" -> part.toString, "onBehalfOfContentOwner" -> onBehalfOfContentOwner.toString))
		}
		class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Unit]) {
			def apply() = auth.exec(req,_.execute("DELETE")).map(_ => ())
		}
		object delete {
			def apply(onBehalfOfContentOwner: String, id: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"youtube/v3/playlistImages").addQueryStringParameters("onBehalfOfContentOwner" -> onBehalfOfContentOwner.toString, "id" -> id.toString))
			given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
		}
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.PlaylistImageListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.PlaylistImageListResponse])
		}
		object list {
		...
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withPlaylistImage(body: Schema.PlaylistImage) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.PlaylistImage])
		}
		object insert {
	...
	object channelBanners {
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withChannelBannerResource(body: Schema.ChannelBannerResource) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.ChannelBannerResource])
		}
		object insert {
	...
	object subscriptions {
		...
		object delete {
			def apply(id: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"youtube/v3/subscriptions").addQueryStringParameters("id" -> id.toString))
			given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
		}
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SubscriptionListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SubscriptionListResponse])
		}
		object list {
		...
		object insert {
			def apply(part: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(ws.url(BASE_URL + s"youtube/v3/subscriptions").addQueryStringParameters("part" -> part.toString))
		}
	}
}
