...
class Api @Inject() (ws: WSClient) extends PlayApi {
	...
	object projects {
		object locations {
			...
			object catalogs {
				class updateGenerativeQuestion(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					def withGoogleCloudRetailV2GenerativeQuestionConfig(body: Schema.GoogleCloudRetailV2GenerativeQuestionConfig) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudRetailV2GenerativeQuestionConfig])
				}
				...
				class getDefaultBranch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRetailV2GetDefaultBranchResponse]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRetailV2GetDefaultBranchResponse])
				}
				...
				class getCompletionConfig(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRetailV2CompletionConfig]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRetailV2CompletionConfig])
				}
				...
				class updateGenerativeQuestionFeature(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					def withGoogleCloudRetailV2GenerativeQuestionsFeatureConfig(body: Schema.GoogleCloudRetailV2GenerativeQuestionsFeatureConfig) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudRetailV2GenerativeQuestionsFeatureConfig])
				}
				...
				class completeQuery(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRetailV2CompleteQueryResponse]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRetailV2CompleteQueryResponse])
				}
				...
				class getGenerativeQuestionFeature(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRetailV2GenerativeQuestionsFeatureConfig]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRetailV2GenerativeQuestionsFeatureConfig])
				}
				...
				class updateAttributesConfig(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudRetailV2AttributesConfig(body: Schema.GoogleCloudRetailV2AttributesConfig) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudRetailV2AttributesConfig])
				}
				...
				class getAttributesConfig(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRetailV2AttributesConfig]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRetailV2AttributesConfig])
				}
				...
				class updateCompletionConfig(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudRetailV2CompletionConfig(body: Schema.GoogleCloudRetailV2CompletionConfig) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudRetailV2CompletionConfig])
				}
				...
				class exportAnalyticsMetrics(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudRetailV2ExportAnalyticsMetricsRequest(body: Schema.GoogleCloudRetailV2ExportAnalyticsMetricsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
				}
				...
				class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudRetailV2Catalog(body: Schema.GoogleCloudRetailV2Catalog) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudRetailV2Catalog])
				}
				object patch {
				...
				class setDefaultBranch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudRetailV2SetDefaultBranchRequest(body: Schema.GoogleCloudRetailV2SetDefaultBranchRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleProtobufEmpty])
				}
				...
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRetailV2ListCatalogsResponse]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRetailV2ListCatalogsResponse])
				}
				object list {
				...
				object userEvents {
					class rejoin(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2RejoinUserEventsRequest(body: Schema.GoogleCloudRetailV2RejoinUserEventsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object rejoin {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): rejoin = new rejoin(ws.url(BASE_URL + s"v2/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/userEvents:rejoin").addQueryStringParameters("parent" -> parent.toString))
					}
					class purge(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2PurgeUserEventsRequest(body: Schema.GoogleCloudRetailV2PurgeUserEventsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object purge {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): purge = new purge(ws.url(BASE_URL + s"v2/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/userEvents:purge").addQueryStringParameters("parent" -> parent.toString))
					}
					class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2ImportUserEventsRequest(body: Schema.GoogleCloudRetailV2ImportUserEventsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object `import` {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): `import` = new `import`(ws.url(BASE_URL + s"v2/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/userEvents:import").addQueryStringParameters("parent" -> parent.toString))
					}
					...
					class write(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2UserEvent(body: Schema.GoogleCloudRetailV2UserEvent) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRetailV2UserEvent])
					}
					object write {
				...
				object servingConfigs {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2ServingConfig(body: Schema.GoogleCloudRetailV2ServingConfig) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRetailV2ServingConfig])
					}
					object create {
					...
					class addControl(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2AddControlRequest(body: Schema.GoogleCloudRetailV2AddControlRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRetailV2ServingConfig])
					}
					object addControl {
					...
					class removeControl(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2RemoveControlRequest(body: Schema.GoogleCloudRetailV2RemoveControlRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRetailV2ServingConfig])
					}
					...
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2ServingConfig(body: Schema.GoogleCloudRetailV2ServingConfig) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudRetailV2ServingConfig])
					}
					object patch {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRetailV2ServingConfig]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRetailV2ServingConfig])
					}
					object get {
					...
					class predict(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2PredictRequest(body: Schema.GoogleCloudRetailV2PredictRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRetailV2PredictResponse])
					}
					object predict {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRetailV2ListServingConfigsResponse]) {
						...
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRetailV2ListServingConfigsResponse])
					}
					object list {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v2/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/servingConfigs").addQueryStringParameters("parent" -> parent.toString))
					...
					class search(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2SearchRequest(body: Schema.GoogleCloudRetailV2SearchRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRetailV2SearchResponse])
					}
					object search {
				...
				object models {
					class tune(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2TuneModelRequest(body: Schema.GoogleCloudRetailV2TuneModelRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object tune {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, modelsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): tune = new tune(ws.url(BASE_URL + s"v2/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/models/${modelsId}:tune").addQueryStringParameters("name" -> name.toString))
					}
					class resume(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2ResumeModelRequest(body: Schema.GoogleCloudRetailV2ResumeModelRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRetailV2Model])
					}
					object resume {
					...
					object delete {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, modelsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v2/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/models/${modelsId}").addQueryStringParameters("name" -> name.toString))
						given Conversion[delete, Future[Schema.GoogleProtobufEmpty]] = (fun: delete) => fun.apply()
					}
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRetailV2Model]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRetailV2Model])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, modelsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v2/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/models/${modelsId}").addQueryStringParameters("name" -> name.toString))
					...
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						...
						def withGoogleCloudRetailV2Model(body: Schema.GoogleCloudRetailV2Model) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudRetailV2Model])
					}
					object patch {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, modelsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(ws.url(BASE_URL + s"v2/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/models/${modelsId}").addQueryStringParameters("name" -> name.toString))
					}
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRetailV2ListModelsResponse]) {
						...
						def withPageToken(pageToken: String) = new list(req.addQueryStringParameters("pageToken" -> pageToken.toString))
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRetailV2ListModelsResponse])
					}
					object list {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v2/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/models").addQueryStringParameters("parent" -> parent.toString))
					...
					class pause(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2PauseModelRequest(body: Schema.GoogleCloudRetailV2PauseModelRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRetailV2Model])
					}
					object pause {
					...
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						...
						def withGoogleCloudRetailV2Model(body: Schema.GoogleCloudRetailV2Model) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object create {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v2/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/models").addQueryStringParameters("parent" -> parent.toString))
					}
				}
				object operations {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleLongrunningListOperationsResponse]) {
				...
				object attributesConfig {
					class addCatalogAttribute(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2AddCatalogAttributeRequest(body: Schema.GoogleCloudRetailV2AddCatalogAttributeRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRetailV2AttributesConfig])
					}
					...
					class removeCatalogAttribute(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2RemoveCatalogAttributeRequest(body: Schema.GoogleCloudRetailV2RemoveCatalogAttributeRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRetailV2AttributesConfig])
					}
					...
					class replaceCatalogAttribute(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2ReplaceCatalogAttributeRequest(body: Schema.GoogleCloudRetailV2ReplaceCatalogAttributeRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRetailV2AttributesConfig])
					}
				...
				object generativeQuestion {
					class batchUpdate(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						...
						def withGoogleCloudRetailV2BatchUpdateGenerativeQuestionConfigsRequest(body: Schema.GoogleCloudRetailV2BatchUpdateGenerativeQuestionConfigsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRetailV2BatchUpdateGenerativeQuestionConfigsResponse])
					}
					object batchUpdate {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi)(using auth: AuthToken, ec: ExecutionContext): batchUpdate = new batchUpdate(ws.url(BASE_URL + s"v2/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/generativeQuestion:batchUpdate").addQueryStringParameters())
					}
				}
				object branches {
					object operations {
					...
					object products {
						class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudRetailV2Product(body: Schema.GoogleCloudRetailV2Product) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRetailV2Product])
						}
						object create {
						...
						class purge(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudRetailV2PurgeProductsRequest(body: Schema.GoogleCloudRetailV2PurgeProductsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
						}
						object purge {
						...
						class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudRetailV2ImportProductsRequest(body: Schema.GoogleCloudRetailV2ImportProductsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
						}
						object `import` {
						...
						class addFulfillmentPlaces(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudRetailV2AddFulfillmentPlacesRequest(body: Schema.GoogleCloudRetailV2AddFulfillmentPlacesRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
						}
						...
						class addLocalInventories(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudRetailV2AddLocalInventoriesRequest(body: Schema.GoogleCloudRetailV2AddLocalInventoriesRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
						}
						...
						class setInventory(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudRetailV2SetInventoryRequest(body: Schema.GoogleCloudRetailV2SetInventoryRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
						}
						object setInventory {
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRetailV2Product]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRetailV2Product])
						}
						object get {
							def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, branchesId :PlayApi, productsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v2/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/branches/${branchesId}/products/${productsId}").addQueryStringParameters("name" -> name.toString))
						...
						class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudRetailV2Product(body: Schema.GoogleCloudRetailV2Product) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudRetailV2Product])
						}
						object patch {
						...
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRetailV2ListProductsResponse]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRetailV2ListProductsResponse])
						}
						object list {
						...
						class removeFulfillmentPlaces(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudRetailV2RemoveFulfillmentPlacesRequest(body: Schema.GoogleCloudRetailV2RemoveFulfillmentPlacesRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
						}
						...
						class removeLocalInventories(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudRetailV2RemoveLocalInventoriesRequest(body: Schema.GoogleCloudRetailV2RemoveLocalInventoriesRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
						}
				...
				object generativeQuestions {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRetailV2ListGenerativeQuestionConfigsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRetailV2ListGenerativeQuestionConfigsResponse])
					}
					object list {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v2/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/generativeQuestions").addQueryStringParameters("parent" -> parent.toString))
				...
				object completionData {
					class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2ImportCompletionDataRequest(body: Schema.GoogleCloudRetailV2ImportCompletionDataRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object `import` {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): `import` = new `import`(ws.url(BASE_URL + s"v2/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/completionData:import").addQueryStringParameters("parent" -> parent.toString))
					}
				}
				object controls {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2Control(body: Schema.GoogleCloudRetailV2Control) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRetailV2Control])
					}
					object create {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRetailV2Control]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRetailV2Control])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, controlsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v2/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/controls/${controlsId}").addQueryStringParameters("name" -> name.toString))
						given Conversion[get, Future[Schema.GoogleCloudRetailV2Control]] = (fun: get) => fun.apply()
					}
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRetailV2Control(body: Schema.GoogleCloudRetailV2Control) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudRetailV2Control])
					}
					object patch {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRetailV2ListControlsResponse]) {
						...
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRetailV2ListControlsResponse])
					}
					object list {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v2/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/controls").addQueryStringParameters("parent" -> parent.toString))
		...
		object operations {
			...
			object get {
				def apply(projectsId :PlayApi, operationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v2/projects/${projectsId}/operations/${operationsId}").addQueryStringParameters("name" -> name.toString))
				given Conversion[get, Future[Schema.GoogleLongrunningOperation]] = (fun: get) => fun.apply()
			}
		}
	}
