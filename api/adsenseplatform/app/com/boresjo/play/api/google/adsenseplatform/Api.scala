	...
	object platforms {
		object accounts {
			class lookup(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.LookupAccountResponse]) {
				...
				def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.LookupAccountResponse])
			}
			object lookup {
				def apply(platformsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): lookup = new lookup(ws.url(BASE_URL + s"v1/platforms/${platformsId}/accounts:lookup").addQueryStringParameters("parent" -> parent.toString))
			...
			object create {
				def apply(platformsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/platforms/${platformsId}/accounts").addQueryStringParameters("parent" -> parent.toString))
			}
			...
			object get {
				def apply(platformsId :PlayApi, accountsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/platforms/${platformsId}/accounts/${accountsId}").addQueryStringParameters("name" -> name.toString))
			...
			class close(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withCloseAccountRequest(body: Schema.CloseAccountRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.CloseAccountResponse])
			}
			object close {
				def apply(platformsId :PlayApi, accountsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): close = new close(ws.url(BASE_URL + s"v1/platforms/${platformsId}/accounts/${accountsId}:close").addQueryStringParameters("name" -> name.toString))
			}
			...
			object list {
				def apply(platformsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/platforms/${platformsId}/accounts").addQueryStringParameters("parent" -> parent.toString))
			...
			object sites {
				...
				object create {
					def apply(platformsId :PlayApi, accountsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/platforms/${platformsId}/accounts/${accountsId}/sites").addQueryStringParameters("parent" -> parent.toString))
				}
				class requestReview(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.RequestSiteReviewResponse]) {
					def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.RequestSiteReviewResponse])
				}
				object requestReview {
					def apply(platformsId :PlayApi, accountsId :PlayApi, sitesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): requestReview = new requestReview(ws.url(BASE_URL + s"v1/platforms/${platformsId}/accounts/${accountsId}/sites/${sitesId}:requestReview").addQueryStringParameters("name" -> name.toString))
				...
				object delete {
					def apply(platformsId :PlayApi, accountsId :PlayApi, sitesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/platforms/${platformsId}/accounts/${accountsId}/sites/${sitesId}").addQueryStringParameters("name" -> name.toString))
				...
				object get {
					def apply(platformsId :PlayApi, accountsId :PlayApi, sitesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/platforms/${platformsId}/accounts/${accountsId}/sites/${sitesId}").addQueryStringParameters("name" -> name.toString))
			...
			object events {
				...
				object create {
					def apply(platformsId :PlayApi, accountsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/platforms/${platformsId}/accounts/${accountsId}/events").addQueryStringParameters("parent" -> parent.toString))
				}
			}
		}
	}
