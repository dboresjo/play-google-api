		...
		object projects {
			object locations {
				object operations {
					...
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, operationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/admin/projects/${projectsId}/locations/${locationsId}/operations/${operationsId}").addQueryStringParameters("name" -> name.toString))
					...
					object delete {
						def apply(projectsId :PlayApi, locationsId :PlayApi, operationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/admin/projects/${projectsId}/locations/${locationsId}/operations/${operationsId}").addQueryStringParameters("name" -> name.toString))
					...
					object cancel {
						def apply(projectsId :PlayApi, locationsId :PlayApi, operationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): cancel = new cancel(ws.url(BASE_URL + s"v1/admin/projects/${projectsId}/locations/${locationsId}/operations/${operationsId}:cancel").addQueryStringParameters("name" -> name.toString))
					}
				}
				object topics {
					...
					object create {
						def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, topicId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/admin/projects/${projectsId}/locations/${locationsId}/topics").addQueryStringParameters("parent" -> parent.toString, "topicId" -> topicId.toString))
					}
					class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Empty]) {
						def apply() = auth.exec(req,_.execute("DELETE")).map(_.json.as[Schema.Empty])
					}
					object delete {
						def apply(projectsId :PlayApi, locationsId :PlayApi, topicsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/admin/projects/${projectsId}/locations/${locationsId}/topics/${topicsId}").addQueryStringParameters("name" -> name.toString))
						given Conversion[delete, Future[Schema.Empty]] = (fun: delete) => fun.apply()
					}
					...
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, topicsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/admin/projects/${projectsId}/locations/${locationsId}/topics/${topicsId}").addQueryStringParameters("name" -> name.toString))
					...
					class getPartitions(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.TopicPartitions]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.TopicPartitions])
					}
					object getPartitions {
						def apply(projectsId :PlayApi, locationsId :PlayApi, topicsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): getPartitions = new getPartitions(ws.url(BASE_URL + s"v1/admin/projects/${projectsId}/locations/${locationsId}/topics/${topicsId}/partitions").addQueryStringParameters("name" -> name.toString))
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListTopicsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListTopicsResponse])
					}
					object list {
					...
					object subscriptions {
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListTopicSubscriptionsResponse]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListTopicSubscriptionsResponse])
						}
						object list {
				...
				object subscriptions {
					class seek(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withSeekSubscriptionRequest(body: Schema.SeekSubscriptionRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					object seek {
						def apply(projectsId :PlayApi, locationsId :PlayApi, subscriptionsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): seek = new seek(ws.url(BASE_URL + s"v1/admin/projects/${projectsId}/locations/${locationsId}/subscriptions/${subscriptionsId}:seek").addQueryStringParameters("name" -> name.toString))
					}
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					object delete {
						def apply(projectsId :PlayApi, locationsId :PlayApi, subscriptionsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/admin/projects/${projectsId}/locations/${locationsId}/subscriptions/${subscriptionsId}").addQueryStringParameters("name" -> name.toString))
						given Conversion[delete, Future[Schema.Empty]] = (fun: delete) => fun.apply()
					}
					...
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, subscriptionsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/admin/projects/${projectsId}/locations/${locationsId}/subscriptions/${subscriptionsId}").addQueryStringParameters("name" -> name.toString))
				...
				object reservations {
					...
					object delete {
						def apply(projectsId :PlayApi, locationsId :PlayApi, reservationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/admin/projects/${projectsId}/locations/${locationsId}/reservations/${reservationsId}").addQueryStringParameters("name" -> name.toString))
						given Conversion[delete, Future[Schema.Empty]] = (fun: delete) => fun.apply()
					}
					...
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, reservationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/admin/projects/${projectsId}/locations/${locationsId}/reservations/${reservationsId}").addQueryStringParameters("name" -> name.toString))
					...
					object topics {
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListReservationTopicsResponse]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListReservationTopicsResponse])
						}
						object list {
			...
			object locations {
				object subscriptions {
					class commitCursor(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withCommitCursorRequest(body: Schema.CommitCursorRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.CommitCursorResponse])
					}
					object commitCursor {
					...
					object cursors {
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListPartitionCursorsResponse]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListPartitionCursorsResponse])
						}
						object list {
			...
			object locations {
				object topics {
					class computeMessageStats(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withComputeMessageStatsRequest(body: Schema.ComputeMessageStatsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.ComputeMessageStatsResponse])
					}
					...
					class computeHeadCursor(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withComputeHeadCursorRequest(body: Schema.ComputeHeadCursorRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.ComputeHeadCursorResponse])
					}
					...
					class computeTimeCursor(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withComputeTimeCursorRequest(body: Schema.ComputeTimeCursorRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.ComputeTimeCursorResponse])
					}
