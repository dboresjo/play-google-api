...
class Api @Inject() (ws: WSClient) extends PlayApi {
	...
	object people {
		class deleteContactPhoto(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.DeleteContactPhotoResponse]) {
			...
			def apply() = auth.exec(req,_.execute("DELETE")).map(_.json.as[Schema.DeleteContactPhotoResponse])
		}
		object deleteContactPhoto {
			def apply(peopleId :PlayApi, resourceName: String)(using auth: AuthToken, ec: ExecutionContext): deleteContactPhoto = new deleteContactPhoto(ws.url(BASE_URL + s"v1/people/${peopleId}:deleteContactPhoto").addQueryStringParameters("resourceName" -> resourceName.toString))
		...
		class batchUpdateContacts(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withBatchUpdateContactsRequest(body: Schema.BatchUpdateContactsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.BatchUpdateContactsResponse])
		}
		object batchUpdateContacts {
			def apply()(using auth: AuthToken, ec: ExecutionContext): batchUpdateContacts = new batchUpdateContacts(ws.url(BASE_URL + s"v1/people:batchUpdateContacts").addQueryStringParameters())
		}
		class batchCreateContacts(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withBatchCreateContactsRequest(body: Schema.BatchCreateContactsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.BatchCreateContactsResponse])
		}
		object batchCreateContacts {
			def apply()(using auth: AuthToken, ec: ExecutionContext): batchCreateContacts = new batchCreateContacts(ws.url(BASE_URL + s"v1/people:batchCreateContacts").addQueryStringParameters())
		}
		class createContact(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			...
			def withPerson(body: Schema.Person) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Person])
		}
		object createContact {
			def apply(personFields: String)(using auth: AuthToken, ec: ExecutionContext): createContact = new createContact(ws.url(BASE_URL + s"v1/people:createContact").addQueryStringParameters("personFields" -> personFields.toString))
		}
		class searchDirectoryPeople(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchDirectoryPeopleResponse]) {
			...
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SearchDirectoryPeopleResponse])
		}
		object searchDirectoryPeople {
			def apply(query: String, readMask: String, sources: String)(using auth: AuthToken, ec: ExecutionContext): searchDirectoryPeople = new searchDirectoryPeople(ws.url(BASE_URL + s"v1/people:searchDirectoryPeople").addQueryStringParameters("query" -> query.toString, "readMask" -> readMask.toString, "sources" -> sources.toString))
		...
		class updateContact(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			...
			def withPerson(body: Schema.Person) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.Person])
		}
		...
		object deleteContact {
			def apply(peopleId :PlayApi, resourceName: String)(using auth: AuthToken, ec: ExecutionContext): deleteContact = new deleteContact(ws.url(BASE_URL + s"v1/people/${peopleId}:deleteContact").addQueryStringParameters("resourceName" -> resourceName.toString))
		...
		class updateContactPhoto(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withUpdateContactPhotoRequest(body: Schema.UpdateContactPhotoRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.UpdateContactPhotoResponse])
		}
		object updateContactPhoto {
			def apply(peopleId :PlayApi, resourceName: String)(using auth: AuthToken, ec: ExecutionContext): updateContactPhoto = new updateContactPhoto(ws.url(BASE_URL + s"v1/people/${peopleId}:updateContactPhoto").addQueryStringParameters("resourceName" -> resourceName.toString))
		}
		...
		object searchContacts {
			def apply(query: String, readMask: String)(using auth: AuthToken, ec: ExecutionContext): searchContacts = new searchContacts(ws.url(BASE_URL + s"v1/people:searchContacts").addQueryStringParameters("query" -> query.toString, "readMask" -> readMask.toString))
		...
		class getBatchGet(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GetPeopleResponse]) {
			...
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GetPeopleResponse])
		}
		object getBatchGet {
		...
		class batchDeleteContacts(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withBatchDeleteContactsRequest(body: Schema.BatchDeleteContactsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Empty])
		}
		object batchDeleteContacts {
			def apply()(using auth: AuthToken, ec: ExecutionContext): batchDeleteContacts = new batchDeleteContacts(ws.url(BASE_URL + s"v1/people:batchDeleteContacts").addQueryStringParameters())
		}
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Person]) {
			...
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.Person])
		}
		object get {
		...
		class listDirectoryPeople(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListDirectoryPeopleResponse]) {
			...
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListDirectoryPeopleResponse])
		}
		object listDirectoryPeople {
			def apply(readMask: String, sources: String)(using auth: AuthToken, ec: ExecutionContext): listDirectoryPeople = new listDirectoryPeople(ws.url(BASE_URL + s"v1/people:listDirectoryPeople").addQueryStringParameters("readMask" -> readMask.toString, "sources" -> sources.toString))
	...
	object otherContacts {
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListOtherContactsResponse]) {
			...
			def withSources(sources: String) = new list(req.addQueryStringParameters("sources" -> sources.toString))
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListOtherContactsResponse])
		}
		object list {
			def apply(readMask: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/otherContacts").addQueryStringParameters("readMask" -> readMask.toString))
		...
		class copyOtherContactToMyContactsGroup(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withCopyOtherContactToMyContactsGroupRequest(body: Schema.CopyOtherContactToMyContactsGroupRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Person])
		}
		...
		object search {
			def apply(query: String, readMask: String)(using auth: AuthToken, ec: ExecutionContext): search = new search(ws.url(BASE_URL + s"v1/otherContacts:search").addQueryStringParameters("query" -> query.toString, "readMask" -> readMask.toString))
			given Conversion[search, Future[Schema.SearchResponse]] = (fun: search) => fun.apply()
		}
	}
	object contactGroups {
		class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withCreateContactGroupRequest(body: Schema.CreateContactGroupRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.ContactGroup])
		}
		object create {
			def apply()(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/contactGroups").addQueryStringParameters())
		}
		...
		object delete {
			def apply(contactGroupsId :PlayApi, resourceName: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/contactGroups/${contactGroupsId}").addQueryStringParameters("resourceName" -> resourceName.toString))
		...
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ContactGroup]) {
			...
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ContactGroup])
		}
		object get {
			def apply(contactGroupsId :PlayApi, resourceName: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/contactGroups/${contactGroupsId}").addQueryStringParameters("resourceName" -> resourceName.toString))
			given Conversion[get, Future[Schema.ContactGroup]] = (fun: get) => fun.apply()
		}
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withUpdateContactGroupRequest(body: Schema.UpdateContactGroupRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.ContactGroup])
		}
		object update {
			def apply(contactGroupsId :PlayApi, resourceName: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"v1/contactGroups/${contactGroupsId}").addQueryStringParameters("resourceName" -> resourceName.toString))
		}
		class batchGet(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.BatchGetContactGroupsResponse]) {
			...
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.BatchGetContactGroupsResponse])
		}
		object batchGet {
			def apply(resourceNames: String)(using auth: AuthToken, ec: ExecutionContext): batchGet = new batchGet(ws.url(BASE_URL + s"v1/contactGroups:batchGet").addQueryStringParameters("resourceNames" -> resourceNames.toString))
		...
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListContactGroupsResponse]) {
			...
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListContactGroupsResponse])
		}
		object list {
			def apply()(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/contactGroups").addQueryStringParameters())
		...
		object members {
			class modify(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withModifyContactGroupMembersRequest(body: Schema.ModifyContactGroupMembersRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.ModifyContactGroupMembersResponse])
			}
			object modify {
				def apply(contactGroupsId :PlayApi, resourceName: String)(using auth: AuthToken, ec: ExecutionContext): modify = new modify(ws.url(BASE_URL + s"v1/contactGroups/${contactGroupsId}/members:modify").addQueryStringParameters("resourceName" -> resourceName.toString))
			}
		}
	}
}
