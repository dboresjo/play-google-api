		...
		object locations {
			object catalogs {
				class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					def withGoogleCloudRecommendationengineV1beta1Catalog(body: Schema.GoogleCloudRecommendationengineV1beta1Catalog) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudRecommendationengineV1beta1Catalog])
				}
				object patch {
					def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(ws.url(BASE_URL + s"v1beta1/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}").addQueryStringParameters("name" -> name.toString))
				}
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRecommendationengineV1beta1ListCatalogsResponse]) {
					...
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRecommendationengineV1beta1ListCatalogsResponse])
				}
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1beta1/projects/${projectsId}/locations/${locationsId}/catalogs").addQueryStringParameters("parent" -> parent.toString))
				...
				object catalogItems {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRecommendationengineV1beta1CatalogItem(body: Schema.GoogleCloudRecommendationengineV1beta1CatalogItem) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRecommendationengineV1beta1CatalogItem])
					}
					object create {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1beta1/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/catalogItems").addQueryStringParameters("parent" -> parent.toString))
					}
					class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRecommendationengineV1beta1ImportCatalogItemsRequest(body: Schema.GoogleCloudRecommendationengineV1beta1ImportCatalogItemsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object `import` {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): `import` = new `import`(ws.url(BASE_URL + s"v1beta1/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/catalogItems:import").addQueryStringParameters("parent" -> parent.toString))
					}
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRecommendationengineV1beta1CatalogItem]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRecommendationengineV1beta1CatalogItem])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, catalogItemsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1beta1/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/catalogItems/${catalogItemsId}").addQueryStringParameters("name" -> name.toString))
					...
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						...
						def withUpdateMask(updateMask: String) = new patch(req.addQueryStringParameters("updateMask" -> updateMask.toString))
						def withGoogleCloudRecommendationengineV1beta1CatalogItem(body: Schema.GoogleCloudRecommendationengineV1beta1CatalogItem) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudRecommendationengineV1beta1CatalogItem])
					}
					object patch {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRecommendationengineV1beta1ListCatalogItemsResponse]) {
						...
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRecommendationengineV1beta1ListCatalogItemsResponse])
					}
					object list {
						def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1beta1/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/catalogItems").addQueryStringParameters("parent" -> parent.toString))
				...
				object eventStores {
					...
					object predictionApiKeyRegistrations {
						...
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRecommendationengineV1beta1ListPredictionApiKeyRegistrationsResponse]) {
							...
							def withPageToken(pageToken: String) = new list(req.addQueryStringParameters("pageToken" -> pageToken.toString))
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRecommendationengineV1beta1ListPredictionApiKeyRegistrationsResponse])
						}
						object list {
							def apply(projectsId :PlayApi, locationsId :PlayApi, catalogsId :PlayApi, eventStoresId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1beta1/projects/${projectsId}/locations/${locationsId}/catalogs/${catalogsId}/eventStores/${eventStoresId}/predictionApiKeyRegistrations").addQueryStringParameters("parent" -> parent.toString))
					...
					object placements {
						class predict(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudRecommendationengineV1beta1PredictRequest(body: Schema.GoogleCloudRecommendationengineV1beta1PredictRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRecommendationengineV1beta1PredictResponse])
						}
						object predict {
					...
					object userEvents {
						class rejoin(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudRecommendationengineV1beta1RejoinUserEventsRequest(body: Schema.GoogleCloudRecommendationengineV1beta1RejoinUserEventsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
						}
						object rejoin {
						...
						class purge(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudRecommendationengineV1beta1PurgeUserEventsRequest(body: Schema.GoogleCloudRecommendationengineV1beta1PurgeUserEventsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
						}
						object purge {
						...
						class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudRecommendationengineV1beta1ImportUserEventsRequest(body: Schema.GoogleCloudRecommendationengineV1beta1ImportUserEventsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
						}
						object `import` {
						...
						class write(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudRecommendationengineV1beta1UserEvent(body: Schema.GoogleCloudRecommendationengineV1beta1UserEvent) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRecommendationengineV1beta1UserEvent])
						}
						object write {
						...
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRecommendationengineV1beta1ListUserEventsResponse]) {
							...
							def withFilter(filter: String) = new list(req.addQueryStringParameters("filter" -> filter.toString))
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRecommendationengineV1beta1ListUserEventsResponse])
						}
						object list {
