...
class Api @Inject() (ws: WSClient) extends PlayApi {
	...
	object achievementDefinitions {
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AchievementDefinitionsListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AchievementDefinitionsListResponse])
		}
		object list {
			def apply(language: String, maxResults: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"games/v1/achievements").addQueryStringParameters("language" -> language.toString, "maxResults" -> maxResults.toString, "pageToken" -> pageToken.toString))
	...
	object achievements {
		class reveal(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AchievementRevealResponse]) {
			def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.AchievementRevealResponse])
		}
		object reveal {
			def apply(achievementId: String)(using auth: AuthToken, ec: ExecutionContext): reveal = new reveal(ws.url(BASE_URL + s"games/v1/achievements/${achievementId}/reveal").addQueryStringParameters())
		...
		class setStepsAtLeast(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AchievementSetStepsAtLeastResponse]) {
			def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.AchievementSetStepsAtLeastResponse])
		}
		object setStepsAtLeast {
			def apply(achievementId: String, steps: Int)(using auth: AuthToken, ec: ExecutionContext): setStepsAtLeast = new setStepsAtLeast(ws.url(BASE_URL + s"games/v1/achievements/${achievementId}/setStepsAtLeast").addQueryStringParameters("steps" -> steps.toString))
		...
		class unlock(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AchievementUnlockResponse]) {
			def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.AchievementUnlockResponse])
		}
		object unlock {
			def apply(achievementId: String)(using auth: AuthToken, ec: ExecutionContext): unlock = new unlock(ws.url(BASE_URL + s"games/v1/achievements/${achievementId}/unlock").addQueryStringParameters())
		...
		class updateMultiple(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withAchievementUpdateMultipleRequest(body: Schema.AchievementUpdateMultipleRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.AchievementUpdateMultipleResponse])
		}
		object updateMultiple {
			def apply()(using auth: AuthToken, ec: ExecutionContext): updateMultiple = new updateMultiple(ws.url(BASE_URL + s"games/v1/achievements/updateMultiple").addQueryStringParameters())
		}
		class increment(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AchievementIncrementResponse]) {
			def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.AchievementIncrementResponse])
		}
		object increment {
			def apply(achievementId: String, requestId: String, stepsToIncrement: Int)(using auth: AuthToken, ec: ExecutionContext): increment = new increment(ws.url(BASE_URL + s"games/v1/achievements/${achievementId}/increment").addQueryStringParameters("requestId" -> requestId.toString, "stepsToIncrement" -> stepsToIncrement.toString))
		...
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.PlayerAchievementListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.PlayerAchievementListResponse])
		}
		object list {
	...
	object applications {
		...
		object get {
			def apply(applicationId: String, language: String, platformType: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"games/v1/applications/${applicationId}").addQueryStringParameters("language" -> language.toString, "platformType" -> platformType.toString))
		...
		object played {
			def apply()(using auth: AuthToken, ec: ExecutionContext): played = new played(ws.url(BASE_URL + s"games/v1/applications/played").addQueryStringParameters())
		...
		class verify(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ApplicationVerifyResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ApplicationVerifyResponse])
		}
		object verify {
			def apply(applicationId: String)(using auth: AuthToken, ec: ExecutionContext): verify = new verify(ws.url(BASE_URL + s"games/v1/applications/${applicationId}/verify").addQueryStringParameters())
		...
		class getEndPoint(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.EndPoint]) {
			def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.EndPoint])
		}
		object getEndPoint {
			def apply(applicationId: String, endPointType: String)(using auth: AuthToken, ec: ExecutionContext): getEndPoint = new getEndPoint(ws.url(BASE_URL + s"games/v1/applications/getEndPoint").addQueryStringParameters("applicationId" -> applicationId.toString, "endPointType" -> endPointType.toString))
	...
	object events {
		class listByPlayer(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.PlayerEventListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.PlayerEventListResponse])
		}
		object listByPlayer {
			def apply(language: String, maxResults: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): listByPlayer = new listByPlayer(ws.url(BASE_URL + s"games/v1/events").addQueryStringParameters("language" -> language.toString, "maxResults" -> maxResults.toString, "pageToken" -> pageToken.toString))
		...
		class listDefinitions(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.EventDefinitionListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.EventDefinitionListResponse])
		}
		object listDefinitions {
			def apply(language: String, maxResults: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): listDefinitions = new listDefinitions(ws.url(BASE_URL + s"games/v1/eventDefinitions").addQueryStringParameters("language" -> language.toString, "maxResults" -> maxResults.toString, "pageToken" -> pageToken.toString))
		...
		class record(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withEventRecordRequest(body: Schema.EventRecordRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.EventUpdateResponse])
		}
		object record {
			def apply(language: String)(using auth: AuthToken, ec: ExecutionContext): record = new record(ws.url(BASE_URL + s"games/v1/events").addQueryStringParameters("language" -> language.toString))
		}
	}
	object leaderboards {
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Leaderboard]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.Leaderboard])
		}
		object get {
			def apply(leaderboardId: String, language: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"games/v1/leaderboards/${leaderboardId}").addQueryStringParameters("language" -> language.toString))
		...
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.LeaderboardListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.LeaderboardListResponse])
		}
		object list {
			def apply(language: String, maxResults: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"games/v1/leaderboards").addQueryStringParameters("language" -> language.toString, "maxResults" -> maxResults.toString, "pageToken" -> pageToken.toString))
	...
	object metagame {
		class getMetagameConfig(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.MetagameConfig]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.MetagameConfig])
		}
		object getMetagameConfig {
			def apply()(using auth: AuthToken, ec: ExecutionContext): getMetagameConfig = new getMetagameConfig(ws.url(BASE_URL + s"games/v1/metagameConfig").addQueryStringParameters())
		...
		class listCategoriesByPlayer(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.CategoryListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.CategoryListResponse])
		}
	...
	object players {
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Player]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.Player])
		}
		object get {
			def apply(playerId: String, language: String, playerIdConsistencyToken: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"games/v1/players/${playerId}").addQueryStringParameters("language" -> language.toString, "playerIdConsistencyToken" -> playerIdConsistencyToken.toString))
		...
		class getScopedPlayerIds(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ScopedPlayerIds]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ScopedPlayerIds])
		}
		object getScopedPlayerIds {
			def apply()(using auth: AuthToken, ec: ExecutionContext): getScopedPlayerIds = new getScopedPlayerIds(ws.url(BASE_URL + s"games/v1/players/me/scopedIds").addQueryStringParameters())
		...
		class getMultipleApplicationPlayerIds(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GetMultipleApplicationPlayerIdsResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GetMultipleApplicationPlayerIdsResponse])
		}
		object getMultipleApplicationPlayerIds {
			def apply(applicationIds: String)(using auth: AuthToken, ec: ExecutionContext): getMultipleApplicationPlayerIds = new getMultipleApplicationPlayerIds(ws.url(BASE_URL + s"games/v1/players/me/multipleApplicationPlayerIds").addQueryStringParameters("applicationIds" -> applicationIds.toString))
		...
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.PlayerListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.PlayerListResponse])
		}
		object list {
			def apply(collection: String, language: String, maxResults: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"games/v1/players/me/players/${collection}").addQueryStringParameters("language" -> language.toString, "maxResults" -> maxResults.toString, "pageToken" -> pageToken.toString))
	...
	object revisions {
		class check(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.RevisionCheckResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.RevisionCheckResponse])
		}
		object check {
			def apply(clientRevision: String)(using auth: AuthToken, ec: ExecutionContext): check = new check(ws.url(BASE_URL + s"games/v1/revisions/check").addQueryStringParameters("clientRevision" -> clientRevision.toString))
	...
	object scores {
		class listWindow(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.LeaderboardScores]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.LeaderboardScores])
		}
		object listWindow {
		...
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.PlayerLeaderboardScoreListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.PlayerLeaderboardScoreListResponse])
		}
		object get {
		...
		class submitMultiple(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withPlayerScoreSubmissionList(body: Schema.PlayerScoreSubmissionList) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.PlayerScoreListResponse])
		}
		object submitMultiple {
			def apply(language: String)(using auth: AuthToken, ec: ExecutionContext): submitMultiple = new submitMultiple(ws.url(BASE_URL + s"games/v1/leaderboards/scores").addQueryStringParameters("language" -> language.toString))
		}
		class submit(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.PlayerScoreResponse]) {
			def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.PlayerScoreResponse])
		}
		object submit {
			def apply(leaderboardId: String, language: String, score: String, scoreTag: String)(using auth: AuthToken, ec: ExecutionContext): submit = new submit(ws.url(BASE_URL + s"games/v1/leaderboards/${leaderboardId}/scores").addQueryStringParameters("language" -> language.toString, "score" -> score.toString, "scoreTag" -> scoreTag.toString))
	...
	object snapshots {
		...
		object get {
			def apply(snapshotId: String, language: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"games/v1/snapshots/${snapshotId}").addQueryStringParameters("language" -> language.toString))
		...
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SnapshotListResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SnapshotListResponse])
		}
		object list {
			def apply(playerId: String, language: String, maxResults: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"games/v1/players/${playerId}/snapshots").addQueryStringParameters("language" -> language.toString, "maxResults" -> maxResults.toString, "pageToken" -> pageToken.toString))
	...
	object stats {
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.StatsResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.StatsResponse])
		}
		object get {
			def apply()(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"games/v1/stats").addQueryStringParameters())
	...
	object recall {
		class lastTokenFromAllDeveloperGames(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.RetrieveDeveloperGamesLastPlayerTokenResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.RetrieveDeveloperGamesLastPlayerTokenResponse])
		}
		object lastTokenFromAllDeveloperGames {
			def apply(sessionId: String)(using auth: AuthToken, ec: ExecutionContext): lastTokenFromAllDeveloperGames = new lastTokenFromAllDeveloperGames(ws.url(BASE_URL + s"games/v1/recall/developerGamesLastPlayerToken/${sessionId}").addQueryStringParameters())
		...
		class resetPersona(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withResetPersonaRequest(body: Schema.ResetPersonaRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.ResetPersonaResponse])
		}
		object resetPersona {
			def apply()(using auth: AuthToken, ec: ExecutionContext): resetPersona = new resetPersona(ws.url(BASE_URL + s"games/v1/recall:resetPersona").addQueryStringParameters())
		}
		class retrieveTokens(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.RetrievePlayerTokensResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.RetrievePlayerTokensResponse])
		}
		object retrieveTokens {
			def apply(sessionId: String)(using auth: AuthToken, ec: ExecutionContext): retrieveTokens = new retrieveTokens(ws.url(BASE_URL + s"games/v1/recall/tokens/${sessionId}").addQueryStringParameters())
		...
		class gamesPlayerTokens(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.RetrieveGamesPlayerTokensResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.RetrieveGamesPlayerTokensResponse])
		}
		object gamesPlayerTokens {
			def apply(sessionId: String, applicationIds: String)(using auth: AuthToken, ec: ExecutionContext): gamesPlayerTokens = new gamesPlayerTokens(ws.url(BASE_URL + s"games/v1/recall/gamesPlayerTokens/${sessionId}").addQueryStringParameters("applicationIds" -> applicationIds.toString))
		...
		class unlinkPersona(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withUnlinkPersonaRequest(body: Schema.UnlinkPersonaRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.UnlinkPersonaResponse])
		}
		object unlinkPersona {
			def apply()(using auth: AuthToken, ec: ExecutionContext): unlinkPersona = new unlinkPersona(ws.url(BASE_URL + s"games/v1/recall:unlinkPersona").addQueryStringParameters())
		}
		class linkPersona(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withLinkPersonaRequest(body: Schema.LinkPersonaRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.LinkPersonaResponse])
		}
		object linkPersona {
			def apply()(using auth: AuthToken, ec: ExecutionContext): linkPersona = new linkPersona(ws.url(BASE_URL + s"games/v1/recall:linkPersona").addQueryStringParameters())
		}
	}
	object accesstokens {
		class generatePlayGroupingApiToken(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GeneratePlayGroupingApiTokenResponse]) {
			def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.GeneratePlayGroupingApiTokenResponse])
		}
		object generatePlayGroupingApiToken {
			def apply(packageName: String, persona: String)(using auth: AuthToken, ec: ExecutionContext): generatePlayGroupingApiToken = new generatePlayGroupingApiToken(ws.url(BASE_URL + s"games/v1/accesstokens/generatePlayGroupingApiToken").addQueryStringParameters("packageName" -> packageName.toString, "persona" -> persona.toString))
		...
		class generateRecallPlayGroupingApiToken(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GenerateRecallPlayGroupingApiTokenResponse]) {
			def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.GenerateRecallPlayGroupingApiTokenResponse])
		}
