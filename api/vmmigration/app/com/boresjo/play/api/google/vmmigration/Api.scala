		...
		object locations {
			...
			object groups {
				class removeGroupMigration(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withRemoveGroupMigrationRequest(body: Schema.RemoveGroupMigrationRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				...
				class addGroupMigration(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withAddGroupMigrationRequest(body: Schema.AddGroupMigrationRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				...
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/groups").addQueryStringParameters("parent" -> parent.toString, "pageToken" -> pageToken.toString))
			...
			object imageImports {
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					def withImageImport(body: Schema.ImageImport) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object create {
				...
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, imageImportsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/imageImports/${imageImportsId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.Operation]] = (fun: delete) => fun.apply()
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ImageImport]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ImageImport])
				}
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, imageImportsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/imageImports/${imageImportsId}").addQueryStringParameters("name" -> name.toString))
				...
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListImageImportsResponse]) {
					...
					def withOrderBy(orderBy: String) = new list(req.addQueryStringParameters("orderBy" -> orderBy.toString))
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListImageImportsResponse])
				}
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/imageImports").addQueryStringParameters("parent" -> parent.toString))
				...
				object imageImportJobs {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListImageImportJobsResponse]) {
						...
						/** Optional. The order by fields for the result (according to AIP-132). Currently ordering is only possible by "name" field. */
						def withOrderBy(orderBy: String) = new list(req.addQueryStringParameters("orderBy" -> orderBy.toString))
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListImageImportJobsResponse])
					}
					object list {
						def apply(projectsId :PlayApi, locationsId :PlayApi, imageImportsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/imageImports/${imageImportsId}/imageImportJobs").addQueryStringParameters("parent" -> parent.toString))
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ImageImportJob]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ImageImportJob])
					}
					object get {
					...
					class cancel(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withCancelImageImportJobRequest(body: Schema.CancelImageImportJobRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					object cancel {
			...
			object targetProjects {
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withTargetProject(body: Schema.TargetProject) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object create {
				...
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, targetProjectsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/targetProjects/${targetProjectsId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.Operation]] = (fun: delete) => fun.apply()
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.TargetProject]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.TargetProject])
				}
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, targetProjectsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/targetProjects/${targetProjectsId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[get, Future[Schema.TargetProject]] = (fun: get) => fun.apply()
				}
				class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withTargetProject(body: Schema.TargetProject) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.Operation])
				}
				object patch {
				...
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListTargetProjectsResponse]) {
					...
					/** Optional. the order by fields for the result. */
					def withOrderBy(orderBy: String) = new list(req.addQueryStringParameters("orderBy" -> orderBy.toString))
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListTargetProjectsResponse])
				}
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/targetProjects").addQueryStringParameters("parent" -> parent.toString, "pageToken" -> pageToken.toString))
			...
			object sources {
				...
				class fetchInventory(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.FetchInventoryResponse]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.FetchInventoryResponse])
				}
				...
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/sources").addQueryStringParameters("parent" -> parent.toString, "pageToken" -> pageToken.toString))
				...
				object utilizationReports {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListUtilizationReportsResponse]) {
						...
						/** Optional. the order by fields for the result. */
						def withOrderBy(orderBy: String) = new list(req.addQueryStringParameters("orderBy" -> orderBy.toString))
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListUtilizationReportsResponse])
					}
					object list {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.UtilizationReport]) {
						...
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.UtilizationReport])
					}
					object get {
					...
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withUtilizationReport(body: Schema.UtilizationReport) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					object create {
				...
				object datacenterConnectors {
					class upgradeAppliance(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withUpgradeApplianceRequest(body: Schema.UpgradeApplianceRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					...
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withDatacenterConnector(body: Schema.DatacenterConnector) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					object create {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.DatacenterConnector]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.DatacenterConnector])
					}
					object get {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListDatacenterConnectorsResponse]) {
						...
						/** Optional. the order by fields for the result. */
						def withOrderBy(orderBy: String) = new list(req.addQueryStringParameters("orderBy" -> orderBy.toString))
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListDatacenterConnectorsResponse])
					}
					object list {
				...
				object migratingVms {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withMigratingVm(body: Schema.MigratingVm) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					object create {
					...
					class finalizeMigration(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withFinalizeMigrationRequest(body: Schema.FinalizeMigrationRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					...
					class pauseMigration(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withPauseMigrationRequest(body: Schema.PauseMigrationRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.MigratingVm]) {
						...
						def withView(view: String) = new get(req.addQueryStringParameters("view" -> view.toString))
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.MigratingVm])
					}
					object get {
					...
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withMigratingVm(body: Schema.MigratingVm) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.Operation])
					}
					object patch {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListMigratingVmsResponse]) {
						...
						def withView(view: String) = new list(req.addQueryStringParameters("view" -> view.toString))
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListMigratingVmsResponse])
					}
					object list {
					...
					class startMigration(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withStartMigrationRequest(body: Schema.StartMigrationRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					...
					class resumeMigration(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withResumeMigrationRequest(body: Schema.ResumeMigrationRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					...
					object cloneJobs {
						class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withCloneJob(body: Schema.CloneJob) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
						}
						object create {
						...
						class cancel(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withCancelCloneJobRequest(body: Schema.CancelCloneJobRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
						}
						object cancel {
						...
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListCloneJobsResponse]) {
							...
							/** Optional. the order by fields for the result. */
							def withOrderBy(orderBy: String) = new list(req.addQueryStringParameters("orderBy" -> orderBy.toString))
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListCloneJobsResponse])
						}
						object list {
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.CloneJob]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.CloneJob])
						}
						object get {
					...
					object cutoverJobs {
						class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withCutoverJob(body: Schema.CutoverJob) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
						}
						object create {
						...
						class cancel(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withCancelCutoverJobRequest(body: Schema.CancelCutoverJobRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
						}
						object cancel {
						...
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListCutoverJobsResponse]) {
							...
							/** Optional. the order by fields for the result. */
							def withOrderBy(orderBy: String) = new list(req.addQueryStringParameters("orderBy" -> orderBy.toString))
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListCutoverJobsResponse])
						}
						object list {
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.CutoverJob]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.CutoverJob])
						}
						object get {
					...
					object replicationCycles {
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListReplicationCyclesResponse]) {
							...
							/** Optional. the order by fields for the result. */
							def withOrderBy(orderBy: String) = new list(req.addQueryStringParameters("orderBy" -> orderBy.toString))
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListReplicationCyclesResponse])
						}
						object list {
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ReplicationCycle]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ReplicationCycle])
						}
						object get {
