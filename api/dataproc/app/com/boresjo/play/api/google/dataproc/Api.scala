	...
	object projects {
		object regions {
			object operations {
				...
				object cancel {
					def apply(projectsId :PlayApi, regionsId :PlayApi, operationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): cancel = new cancel(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/operations/${operationsId}:cancel").addQueryStringParameters("name" -> name.toString))
				...
				object delete {
					def apply(projectsId :PlayApi, regionsId :PlayApi, operationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/operations/${operationsId}").addQueryStringParameters("name" -> name.toString))
				...
				object get {
					def apply(projectsId :PlayApi, regionsId :PlayApi, operationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/operations/${operationsId}").addQueryStringParameters("name" -> name.toString))
			...
			object clusters {
				...
				class diagnose(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withDiagnoseClusterRequest(body: Schema.DiagnoseClusterRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object diagnose {
					def apply(projectId: String, region: String, clusterName: String)(using auth: AuthToken, ec: ExecutionContext): diagnose = new diagnose(ws.url(BASE_URL + s"v1/projects/${projectId}/regions/${region}/clusters/${clusterName}:diagnose").addQueryStringParameters())
				}
				class stop(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withStopClusterRequest(body: Schema.StopClusterRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object stop {
					def apply(projectId: String, region: String, clusterName: String)(using auth: AuthToken, ec: ExecutionContext): stop = new stop(ws.url(BASE_URL + s"v1/projects/${projectId}/regions/${region}/clusters/${clusterName}:stop").addQueryStringParameters())
				}
				class repair(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withRepairClusterRequest(body: Schema.RepairClusterRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object repair {
					def apply(projectId: String, region: String, clusterName: String)(using auth: AuthToken, ec: ExecutionContext): repair = new repair(ws.url(BASE_URL + s"v1/projects/${projectId}/regions/${region}/clusters/${clusterName}:repair").addQueryStringParameters())
				}
				class getIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGetIamPolicyRequest(body: Schema.GetIamPolicyRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Policy])
				}
				object getIamPolicy {
					def apply(projectsId :PlayApi, regionsId :PlayApi, clustersId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): getIamPolicy = new getIamPolicy(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/clusters/${clustersId}:getIamPolicy").addQueryStringParameters("resource" -> resource.toString))
				}
				...
				object delete {
					def apply(projectId: String, region: String, clusterName: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectId}/regions/${region}/clusters/${clusterName}").addQueryStringParameters())
					given Conversion[delete, Future[Schema.Operation]] = (fun: delete) => fun.apply()
				}
				class injectCredentials(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withInjectCredentialsRequest(body: Schema.InjectCredentialsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				...
				object get {
					def apply(projectId: String, region: String, clusterName: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectId}/regions/${region}/clusters/${clusterName}").addQueryStringParameters())
				...
				object list {
					def apply(projectId: String, region: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectId}/regions/${region}/clusters").addQueryStringParameters())
				...
				object create {
					def apply(projectId: String, region: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectId}/regions/${region}/clusters").addQueryStringParameters())
				}
				class setIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withSetIamPolicyRequest(body: Schema.SetIamPolicyRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Policy])
				}
				object setIamPolicy {
					def apply(projectsId :PlayApi, regionsId :PlayApi, clustersId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): setIamPolicy = new setIamPolicy(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/clusters/${clustersId}:setIamPolicy").addQueryStringParameters("resource" -> resource.toString))
				}
				...
				object patch {
					def apply(projectId: String, region: String, clusterName: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(ws.url(BASE_URL + s"v1/projects/${projectId}/regions/${region}/clusters/${clusterName}").addQueryStringParameters("updateMask" -> updateMask.toString))
				}
				class start(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withStartClusterRequest(body: Schema.StartClusterRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object start {
					def apply(projectId: String, region: String, clusterName: String)(using auth: AuthToken, ec: ExecutionContext): start = new start(ws.url(BASE_URL + s"v1/projects/${projectId}/regions/${region}/clusters/${clusterName}:start").addQueryStringParameters())
				}
				object nodeGroups {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						...
						def withNodeGroup(body: Schema.NodeGroup) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					object create {
						def apply(projectsId :PlayApi, regionsId :PlayApi, clustersId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/clusters/${clustersId}/nodeGroups").addQueryStringParameters("parent" -> parent.toString))
					}
					class resize(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withResizeNodeGroupRequest(body: Schema.ResizeNodeGroupRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					object resize {
					...
					class repair(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withRepairNodeGroupRequest(body: Schema.RepairNodeGroupRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					object repair {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.NodeGroup]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.NodeGroup])
					}
					object get {
						def apply(projectsId :PlayApi, regionsId :PlayApi, clustersId :PlayApi, nodeGroupsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/clusters/${clustersId}/nodeGroups/${nodeGroupsId}").addQueryStringParameters("name" -> name.toString))
			...
			object jobs {
				...
				class cancel(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withCancelJobRequest(body: Schema.CancelJobRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Job])
				}
				object cancel {
					def apply(projectId: String, region: String, jobId: String)(using auth: AuthToken, ec: ExecutionContext): cancel = new cancel(ws.url(BASE_URL + s"v1/projects/${projectId}/regions/${region}/jobs/${jobId}:cancel").addQueryStringParameters())
				}
				class submitAsOperation(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withSubmitJobRequest(body: Schema.SubmitJobRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object submitAsOperation {
					def apply(projectId: String, region: String)(using auth: AuthToken, ec: ExecutionContext): submitAsOperation = new submitAsOperation(ws.url(BASE_URL + s"v1/projects/${projectId}/regions/${region}/jobs:submitAsOperation").addQueryStringParameters())
				}
				class setIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withSetIamPolicyRequest(body: Schema.SetIamPolicyRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Policy])
				}
				object setIamPolicy {
					def apply(projectsId :PlayApi, regionsId :PlayApi, jobsId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): setIamPolicy = new setIamPolicy(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/jobs/${jobsId}:setIamPolicy").addQueryStringParameters("resource" -> resource.toString))
				}
				class submit(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withSubmitJobRequest(body: Schema.SubmitJobRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Job])
				}
				object submit {
					def apply(projectId: String, region: String)(using auth: AuthToken, ec: ExecutionContext): submit = new submit(ws.url(BASE_URL + s"v1/projects/${projectId}/regions/${region}/jobs:submit").addQueryStringParameters())
				}
				class getIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGetIamPolicyRequest(body: Schema.GetIamPolicyRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Policy])
				}
				object getIamPolicy {
					def apply(projectsId :PlayApi, regionsId :PlayApi, jobsId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): getIamPolicy = new getIamPolicy(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/jobs/${jobsId}:getIamPolicy").addQueryStringParameters("resource" -> resource.toString))
				}
				class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Empty]) {
					def apply() = auth.exec(req,_.execute("DELETE")).map(_.json.as[Schema.Empty])
				}
				object delete {
					def apply(projectId: String, region: String, jobId: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectId}/regions/${region}/jobs/${jobId}").addQueryStringParameters())
					given Conversion[delete, Future[Schema.Empty]] = (fun: delete) => fun.apply()
				}
				...
				object get {
					def apply(projectId: String, region: String, jobId: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectId}/regions/${region}/jobs/${jobId}").addQueryStringParameters())
				...
				object patch {
					def apply(projectId: String, region: String, jobId: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(ws.url(BASE_URL + s"v1/projects/${projectId}/regions/${region}/jobs/${jobId}").addQueryStringParameters("updateMask" -> updateMask.toString))
				}
				...
				object list {
					def apply(projectId: String, region: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectId}/regions/${region}/jobs").addQueryStringParameters())
			...
			object workflowTemplates {
				...
				class instantiateInline(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					def withWorkflowTemplate(body: Schema.WorkflowTemplate) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object instantiateInline {
					def apply(projectsId :PlayApi, regionsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): instantiateInline = new instantiateInline(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/workflowTemplates:instantiateInline").addQueryStringParameters("parent" -> parent.toString))
				}
				class instantiate(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withInstantiateWorkflowTemplateRequest(body: Schema.InstantiateWorkflowTemplateRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object instantiate {
				...
				object delete {
					def apply(projectsId :PlayApi, regionsId :PlayApi, workflowTemplatesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/workflowTemplates/${workflowTemplatesId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.Empty]] = (fun: delete) => fun.apply()
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.WorkflowTemplate]) {
					...
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.WorkflowTemplate])
				}
				object get {
					def apply(projectsId :PlayApi, regionsId :PlayApi, workflowTemplatesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/workflowTemplates/${workflowTemplatesId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[get, Future[Schema.WorkflowTemplate]] = (fun: get) => fun.apply()
				}
				class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withWorkflowTemplate(body: Schema.WorkflowTemplate) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.WorkflowTemplate])
				}
				object update {
					def apply(projectsId :PlayApi, regionsId :PlayApi, workflowTemplatesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/workflowTemplates/${workflowTemplatesId}").addQueryStringParameters("name" -> name.toString))
				}
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListWorkflowTemplatesResponse]) {
					...
					/** Optional. The page token, returned by a previous call, to request the next page of results. */
					def withPageToken(pageToken: String) = new list(req.addQueryStringParameters("pageToken" -> pageToken.toString))
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListWorkflowTemplatesResponse])
				}
				object list {
					def apply(projectsId :PlayApi, regionsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/workflowTemplates").addQueryStringParameters("parent" -> parent.toString))
					given Conversion[list, Future[Schema.ListWorkflowTemplatesResponse]] = (fun: list) => fun.apply()
				}
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withWorkflowTemplate(body: Schema.WorkflowTemplate) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.WorkflowTemplate])
				}
				object create {
					def apply(projectsId :PlayApi, regionsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/workflowTemplates").addQueryStringParameters("parent" -> parent.toString))
				}
				class setIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withSetIamPolicyRequest(body: Schema.SetIamPolicyRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Policy])
				}
			...
			object autoscalingPolicies {
				...
				object delete {
					def apply(projectsId :PlayApi, regionsId :PlayApi, autoscalingPoliciesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/autoscalingPolicies/${autoscalingPoliciesId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.Empty]] = (fun: delete) => fun.apply()
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AutoscalingPolicy]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AutoscalingPolicy])
				}
				object get {
					def apply(projectsId :PlayApi, regionsId :PlayApi, autoscalingPoliciesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/autoscalingPolicies/${autoscalingPoliciesId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[get, Future[Schema.AutoscalingPolicy]] = (fun: get) => fun.apply()
				}
				class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withAutoscalingPolicy(body: Schema.AutoscalingPolicy) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.AutoscalingPolicy])
				}
				object update {
					def apply(projectsId :PlayApi, regionsId :PlayApi, autoscalingPoliciesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/autoscalingPolicies/${autoscalingPoliciesId}").addQueryStringParameters("name" -> name.toString))
				}
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListAutoscalingPoliciesResponse]) {
					...
					/** Optional. The page token, returned by a previous call, to request the next page of results. */
					def withPageToken(pageToken: String) = new list(req.addQueryStringParameters("pageToken" -> pageToken.toString))
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListAutoscalingPoliciesResponse])
				}
				object list {
					def apply(projectsId :PlayApi, regionsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/autoscalingPolicies").addQueryStringParameters("parent" -> parent.toString))
					given Conversion[list, Future[Schema.ListAutoscalingPoliciesResponse]] = (fun: list) => fun.apply()
				}
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withAutoscalingPolicy(body: Schema.AutoscalingPolicy) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.AutoscalingPolicy])
				}
				object create {
					def apply(projectsId :PlayApi, regionsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/regions/${regionsId}/autoscalingPolicies").addQueryStringParameters("parent" -> parent.toString))
				}
				class setIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withSetIamPolicyRequest(body: Schema.SetIamPolicyRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Policy])
				}
		...
		object locations {
			object sessions {
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					def withRequestId(requestId: String) = new create(req.addQueryStringParameters("requestId" -> requestId.toString))
					def withSession(body: Schema.Session) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, sessionId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/sessions").addQueryStringParameters("parent" -> parent.toString, "sessionId" -> sessionId.toString))
				}
				class terminate(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withTerminateSessionRequest(body: Schema.TerminateSessionRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object terminate {
					def apply(projectsId :PlayApi, locationsId :PlayApi, sessionsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): terminate = new terminate(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/sessions/${sessionsId}:terminate").addQueryStringParameters("name" -> name.toString))
				}
				class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Operation]) {
				...
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, sessionsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/sessions/${sessionsId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.Operation]] = (fun: delete) => fun.apply()
				}
				...
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, sessionsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/sessions/${sessionsId}").addQueryStringParameters("name" -> name.toString))
				...
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/sessions").addQueryStringParameters("parent" -> parent.toString))
				...
				object sparkApplications {
					class searchExecutors(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchSessionSparkApplicationExecutorsResponse]) {
						...
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SearchSessionSparkApplicationExecutorsResponse])
					}
					...
					class accessJob(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AccessSessionSparkApplicationJobResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AccessSessionSparkApplicationJobResponse])
					}
					object accessJob {
					...
					class accessSqlQuery(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AccessSessionSparkApplicationSqlQueryResponse]) {
						...
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AccessSessionSparkApplicationSqlQueryResponse])
					}
					...
					class summarizeJobs(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SummarizeSessionSparkApplicationJobsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SummarizeSessionSparkApplicationJobsResponse])
					}
					...
					class summarizeStages(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SummarizeSessionSparkApplicationStagesResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SummarizeSessionSparkApplicationStagesResponse])
					}
					...
					class searchStages(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchSessionSparkApplicationStagesResponse]) {
						...
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SearchSessionSparkApplicationStagesResponse])
					}
					object searchStages {
					...
					class summarizeExecutors(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SummarizeSessionSparkApplicationExecutorsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SummarizeSessionSparkApplicationExecutorsResponse])
					}
					...
					class summarizeStageAttemptTasks(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SummarizeSessionSparkApplicationStageAttemptTasksResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SummarizeSessionSparkApplicationStageAttemptTasksResponse])
					}
					...
					class accessStageAttempt(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AccessSessionSparkApplicationStageAttemptResponse]) {
						...
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AccessSessionSparkApplicationStageAttemptResponse])
					}
					...
					class write(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withWriteSessionSparkApplicationContextRequest(body: Schema.WriteSessionSparkApplicationContextRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.WriteSessionSparkApplicationContextResponse])
					}
					object write {
					...
					class searchExecutorStageSummary(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchSessionSparkApplicationExecutorStageSummaryResponse]) {
						...
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SearchSessionSparkApplicationExecutorStageSummaryResponse])
					}
					...
					class searchJobs(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchSessionSparkApplicationJobsResponse]) {
						...
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SearchSessionSparkApplicationJobsResponse])
					}
					object searchJobs {
					...
					class accessEnvironmentInfo(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AccessSessionSparkApplicationEnvironmentInfoResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AccessSessionSparkApplicationEnvironmentInfoResponse])
					}
					...
					class searchStageAttempts(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchSessionSparkApplicationStageAttemptsResponse]) {
						...
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SearchSessionSparkApplicationStageAttemptsResponse])
					}
					...
					class searchSqlQueries(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchSessionSparkApplicationSqlQueriesResponse]) {
						...
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SearchSessionSparkApplicationSqlQueriesResponse])
					}
					...
					class searchStageAttemptTasks(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchSessionSparkApplicationStageAttemptTasksResponse]) {
						...
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SearchSessionSparkApplicationStageAttemptTasksResponse])
					}
					...
					class accessStageRddGraph(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AccessSessionSparkApplicationStageRddOperationGraphResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AccessSessionSparkApplicationStageRddOperationGraphResponse])
					}
					...
					class accessSqlPlan(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AccessSessionSparkApplicationSqlSparkPlanGraphResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AccessSessionSparkApplicationSqlSparkPlanGraphResponse])
					}
					...
					class access(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AccessSessionSparkApplicationResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AccessSessionSparkApplicationResponse])
					}
					object access {
					...
					class search(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchSessionSparkApplicationsResponse]) {
						...
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SearchSessionSparkApplicationsResponse])
					}
					object search {
						def apply(projectsId :PlayApi, locationsId :PlayApi, sessionsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): search = new search(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/sessions/${sessionsId}/sparkApplications:search").addQueryStringParameters("parent" -> parent.toString))
			...
			object autoscalingPolicies {
				...
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, autoscalingPoliciesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/autoscalingPolicies/${autoscalingPoliciesId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.Empty]] = (fun: delete) => fun.apply()
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AutoscalingPolicy]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AutoscalingPolicy])
				...
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, autoscalingPoliciesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/autoscalingPolicies/${autoscalingPoliciesId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[get, Future[Schema.AutoscalingPolicy]] = (fun: get) => fun.apply()
				}
				class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withAutoscalingPolicy(body: Schema.AutoscalingPolicy) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.AutoscalingPolicy])
				...
				object update {
					def apply(projectsId :PlayApi, locationsId :PlayApi, autoscalingPoliciesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/autoscalingPolicies/${autoscalingPoliciesId}").addQueryStringParameters("name" -> name.toString))
				}
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListAutoscalingPoliciesResponse]) {
					/** Optional. The maximum number of results to return in each response. Must be less than or equal to 1000. Defaults to 100.<br>Format: int32 */
					def withPageSize(pageSize: Int) = new list(req.addQueryStringParameters("pageSize" -> pageSize.toString))
				...
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/autoscalingPolicies").addQueryStringParameters("parent" -> parent.toString))
					given Conversion[list, Future[Schema.ListAutoscalingPoliciesResponse]] = (fun: list) => fun.apply()
				}
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withAutoscalingPolicy(body: Schema.AutoscalingPolicy) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.AutoscalingPolicy])
				...
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/autoscalingPolicies").addQueryStringParameters("parent" -> parent.toString))
				}
				class setIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withSetIamPolicyRequest(body: Schema.SetIamPolicyRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Policy])
				}
			...
			object batches {
				class analyze(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withAnalyzeBatchRequest(body: Schema.AnalyzeBatchRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object analyze {
					def apply(projectsId :PlayApi, locationsId :PlayApi, batchesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): analyze = new analyze(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/batches/${batchesId}:analyze").addQueryStringParameters("name" -> name.toString))
				}
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					def withRequestId(requestId: String) = new create(req.addQueryStringParameters("requestId" -> requestId.toString))
					def withBatch(body: Schema.Batch) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/batches").addQueryStringParameters("parent" -> parent.toString))
				}
				class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Empty]) {
					def apply() = auth.exec(req,_.execute("DELETE")).map(_.json.as[Schema.Empty])
				}
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, batchesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/batches/${batchesId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.Empty]] = (fun: delete) => fun.apply()
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Batch]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.Batch])
				}
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, batchesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/batches/${batchesId}").addQueryStringParameters("name" -> name.toString))
				...
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListBatchesResponse]) {
					...
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListBatchesResponse])
				}
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/batches").addQueryStringParameters("parent" -> parent.toString))
				...
				object sparkApplications {
					class searchExecutors(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchSparkApplicationExecutorsResponse]) {
						...
						def withPageToken(pageToken: String) = new searchExecutors(req.addQueryStringParameters("pageToken" -> pageToken.toString))
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SearchSparkApplicationExecutorsResponse])
					}
					object searchExecutors {
					...
					class accessJob(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AccessSparkApplicationJobResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AccessSparkApplicationJobResponse])
					}
					object accessJob {
					...
					class accessSqlQuery(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AccessSparkApplicationSqlQueryResponse]) {
						...
						/** Optional. Enables/ disables physical plan description on demand */
						def withPlanDescription(planDescription: Boolean) = new accessSqlQuery(req.addQueryStringParameters("planDescription" -> planDescription.toString))
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AccessSparkApplicationSqlQueryResponse])
					}
					object accessSqlQuery {
					...
					class summarizeJobs(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SummarizeSparkApplicationJobsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SummarizeSparkApplicationJobsResponse])
					}
					object summarizeJobs {
					...
					class summarizeStages(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SummarizeSparkApplicationStagesResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SummarizeSparkApplicationStagesResponse])
					}
					object summarizeStages {
					...
					class searchStages(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchSparkApplicationStagesResponse]) {
						...
						/** Optional. The list of summary metrics fields to include. Empty list will default to skip all summary metrics fields. Example, if the response should include TaskQuantileMetrics, the request should have task_quantile_metrics in summary_metrics_mask field<br>Format: google-fieldmask */
						def withSummaryMetricsMask(summaryMetricsMask: String) = new searchStages(req.addQueryStringParameters("summaryMetricsMask" -> summaryMetricsMask.toString))
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SearchSparkApplicationStagesResponse])
					}
					object searchStages {
					...
					class summarizeExecutors(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SummarizeSparkApplicationExecutorsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SummarizeSparkApplicationExecutorsResponse])
					}
					object summarizeExecutors {
					...
					class summarizeStageAttemptTasks(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SummarizeSparkApplicationStageAttemptTasksResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SummarizeSparkApplicationStageAttemptTasksResponse])
					}
					object summarizeStageAttemptTasks {
					...
					class accessStageAttempt(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AccessSparkApplicationStageAttemptResponse]) {
						/** Optional. The list of summary metrics fields to include. Empty list will default to skip all summary metrics fields. Example, if the response should include TaskQuantileMetrics, the request should have task_quantile_metrics in summary_metrics_mask field<br>Format: google-fieldmask */
						def withSummaryMetricsMask(summaryMetricsMask: String) = new accessStageAttempt(req.addQueryStringParameters("summaryMetricsMask" -> summaryMetricsMask.toString))
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AccessSparkApplicationStageAttemptResponse])
					}
					object accessStageAttempt {
					...
					class write(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withWriteSparkApplicationContextRequest(body: Schema.WriteSparkApplicationContextRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.WriteSparkApplicationContextResponse])
					}
					object write {
					...
					class searchExecutorStageSummary(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchSparkApplicationExecutorStageSummaryResponse]) {
						...
						/** Optional. A page token received from a previous AccessSparkApplicationExecutorsList call. Provide this token to retrieve the subsequent page. */
						def withPageToken(pageToken: String) = new searchExecutorStageSummary(req.addQueryStringParameters("pageToken" -> pageToken.toString))
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SearchSparkApplicationExecutorStageSummaryResponse])
					}
					object searchExecutorStageSummary {
					...
					class searchJobs(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchSparkApplicationJobsResponse]) {
						...
						def withPageToken(pageToken: String) = new searchJobs(req.addQueryStringParameters("pageToken" -> pageToken.toString))
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SearchSparkApplicationJobsResponse])
					}
					object searchJobs {
					...
					class accessEnvironmentInfo(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AccessSparkApplicationEnvironmentInfoResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AccessSparkApplicationEnvironmentInfoResponse])
					}
					object accessEnvironmentInfo {
					...
					class searchStageAttempts(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchSparkApplicationStageAttemptsResponse]) {
						...
						/** Optional. The list of summary metrics fields to include. Empty list will default to skip all summary metrics fields. Example, if the response should include TaskQuantileMetrics, the request should have task_quantile_metrics in summary_metrics_mask field<br>Format: google-fieldmask */
						def withSummaryMetricsMask(summaryMetricsMask: String) = new searchStageAttempts(req.addQueryStringParameters("summaryMetricsMask" -> summaryMetricsMask.toString))
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SearchSparkApplicationStageAttemptsResponse])
					}
					object searchStageAttempts {
					...
					class searchSqlQueries(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchSparkApplicationSqlQueriesResponse]) {
						...
						def withPageToken(pageToken: String) = new searchSqlQueries(req.addQueryStringParameters("pageToken" -> pageToken.toString))
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SearchSparkApplicationSqlQueriesResponse])
					}
					object searchSqlQueries {
					...
					class searchStageAttemptTasks(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchSparkApplicationStageAttemptTasksResponse]) {
						...
						def withPageToken(pageToken: String) = new searchStageAttemptTasks(req.addQueryStringParameters("pageToken" -> pageToken.toString))
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SearchSparkApplicationStageAttemptTasksResponse])
					}
					object searchStageAttemptTasks {
					...
					class accessStageRddGraph(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AccessSparkApplicationStageRddOperationGraphResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AccessSparkApplicationStageRddOperationGraphResponse])
					}
					object accessStageRddGraph {
					...
					class accessSqlPlan(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AccessSparkApplicationSqlSparkPlanGraphResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AccessSparkApplicationSqlSparkPlanGraphResponse])
					}
					object accessSqlPlan {
					...
					class access(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AccessSparkApplicationResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AccessSparkApplicationResponse])
					}
					object access {
					...
					class search(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchSparkApplicationsResponse]) {
						...
						def withPageToken(pageToken: String) = new search(req.addQueryStringParameters("pageToken" -> pageToken.toString))
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SearchSparkApplicationsResponse])
					}
					object search {
						def apply(projectsId :PlayApi, locationsId :PlayApi, batchesId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): search = new search(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/batches/${batchesId}/sparkApplications:search").addQueryStringParameters("parent" -> parent.toString))
			...
			object workflowTemplates {
				...
				object instantiateInline {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): instantiateInline = new instantiateInline(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workflowTemplates:instantiateInline").addQueryStringParameters("parent" -> parent.toString))
				}
				class instantiate(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withInstantiateWorkflowTemplateRequest(body: Schema.InstantiateWorkflowTemplateRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				...
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, workflowTemplatesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workflowTemplates/${workflowTemplatesId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.Empty]] = (fun: delete) => fun.apply()
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.WorkflowTemplate]) {
					/** Optional. The version of workflow template to retrieve. Only previously instantiated versions can be retrieved.If unspecified, retrieves the current version.<br>Format: int32 */
				...
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, workflowTemplatesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workflowTemplates/${workflowTemplatesId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[get, Future[Schema.WorkflowTemplate]] = (fun: get) => fun.apply()
				}
				class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withWorkflowTemplate(body: Schema.WorkflowTemplate) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.WorkflowTemplate])
				...
				object update {
					def apply(projectsId :PlayApi, locationsId :PlayApi, workflowTemplatesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workflowTemplates/${workflowTemplatesId}").addQueryStringParameters("name" -> name.toString))
				}
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListWorkflowTemplatesResponse]) {
					/** Optional. The maximum number of results to return in each response.<br>Format: int32 */
					def withPageSize(pageSize: Int) = new list(req.addQueryStringParameters("pageSize" -> pageSize.toString))
				...
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workflowTemplates").addQueryStringParameters("parent" -> parent.toString))
					given Conversion[list, Future[Schema.ListWorkflowTemplatesResponse]] = (fun: list) => fun.apply()
				}
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withWorkflowTemplate(body: Schema.WorkflowTemplate) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.WorkflowTemplate])
				...
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workflowTemplates").addQueryStringParameters("parent" -> parent.toString))
				}
				class setIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withSetIamPolicyRequest(body: Schema.SetIamPolicyRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Policy])
				}
			...
			object sessionTemplates {
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withSessionTemplate(body: Schema.SessionTemplate) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.SessionTemplate])
				}
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/sessionTemplates").addQueryStringParameters("parent" -> parent.toString))
				}
				class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Empty]) {
					def apply() = auth.exec(req,_.execute("DELETE")).map(_.json.as[Schema.Empty])
				}
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, sessionTemplatesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/sessionTemplates/${sessionTemplatesId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.Empty]] = (fun: delete) => fun.apply()
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SessionTemplate]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SessionTemplate])
				}
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, sessionTemplatesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/sessionTemplates/${sessionTemplatesId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[get, Future[Schema.SessionTemplate]] = (fun: get) => fun.apply()
				}
				class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withSessionTemplate(body: Schema.SessionTemplate) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.SessionTemplate])
				}
				object patch {
					def apply(projectsId :PlayApi, locationsId :PlayApi, sessionTemplatesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/sessionTemplates/${sessionTemplatesId}").addQueryStringParameters("name" -> name.toString))
				}
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListSessionTemplatesResponse]) {
					...
					def withFilter(filter: String) = new list(req.addQueryStringParameters("filter" -> filter.toString))
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListSessionTemplatesResponse])
				}
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/sessionTemplates").addQueryStringParameters("parent" -> parent.toString))
