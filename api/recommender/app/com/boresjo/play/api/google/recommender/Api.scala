			...
			object recommenders {
				object recommendations {
					class markClaimed(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRecommenderV1MarkRecommendationClaimedRequest(body: Schema.GoogleCloudRecommenderV1MarkRecommendationClaimedRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRecommenderV1Recommendation])
					}
					object markClaimed {
					...
					class markSucceeded(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRecommenderV1MarkRecommendationSucceededRequest(body: Schema.GoogleCloudRecommenderV1MarkRecommendationSucceededRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRecommenderV1Recommendation])
					}
					...
					class markDismissed(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRecommenderV1MarkRecommendationDismissedRequest(body: Schema.GoogleCloudRecommenderV1MarkRecommendationDismissedRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRecommenderV1Recommendation])
					}
					...
					class markFailed(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRecommenderV1MarkRecommendationFailedRequest(body: Schema.GoogleCloudRecommenderV1MarkRecommendationFailedRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRecommenderV1Recommendation])
					}
					object markFailed {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRecommenderV1Recommendation]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRecommenderV1Recommendation])
					}
					object get {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRecommenderV1ListRecommendationsResponse]) {
						...
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRecommenderV1ListRecommendationsResponse])
					}
					object list {
			...
			object insightTypes {
				object insights {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRecommenderV1ListInsightsResponse]) {
						...
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRecommenderV1ListInsightsResponse])
					}
					object list {
						def apply(foldersId :PlayApi, locationsId :PlayApi, insightTypesId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/folders/${foldersId}/locations/${locationsId}/insightTypes/${insightTypesId}/insights").addQueryStringParameters("parent" -> parent.toString))
					...
					class markAccepted(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRecommenderV1MarkInsightAcceptedRequest(body: Schema.GoogleCloudRecommenderV1MarkInsightAcceptedRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRecommenderV1Insight])
					}
					object markAccepted {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRecommenderV1Insight]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRecommenderV1Insight])
					}
					object get {
		...
		object locations {
			object insightTypes {
				class getConfig(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRecommenderV1InsightTypeConfig]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRecommenderV1InsightTypeConfig])
				}
				object getConfig {
				...
				class updateConfig(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudRecommenderV1InsightTypeConfig(body: Schema.GoogleCloudRecommenderV1InsightTypeConfig) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudRecommenderV1InsightTypeConfig])
				}
				object updateConfig {
			...
			object recommenders {
				class updateConfig(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudRecommenderV1RecommenderConfig(body: Schema.GoogleCloudRecommenderV1RecommenderConfig) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudRecommenderV1RecommenderConfig])
				}
				object updateConfig {
				...
				class getConfig(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRecommenderV1RecommenderConfig]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudRecommenderV1RecommenderConfig])
				}
				object getConfig {
	...
	object projects {
		object locations {
			object insightTypes {
				...
				object getConfig {
					def apply(projectsId :PlayApi, locationsId :PlayApi, insightTypesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): getConfig = new getConfig(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/insightTypes/${insightTypesId}/config").addQueryStringParameters("name" -> name.toString))
					given Conversion[getConfig, Future[Schema.GoogleCloudRecommenderV1InsightTypeConfig]] = (fun: getConfig) => fun.apply()
				}
				object insights {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudRecommenderV1ListInsightsResponse]) {
					...
					object list {
						def apply(projectsId :PlayApi, locationsId :PlayApi, insightTypesId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/insightTypes/${insightTypesId}/insights").addQueryStringParameters("parent" -> parent.toString))
						given Conversion[list, Future[Schema.GoogleCloudRecommenderV1ListInsightsResponse]] = (fun: list) => fun.apply()
					}
					class markAccepted(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudRecommenderV1MarkInsightAcceptedRequest(body: Schema.GoogleCloudRecommenderV1MarkInsightAcceptedRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudRecommenderV1Insight])
			...
			object recommenders {
				...
				object getConfig {
					def apply(projectsId :PlayApi, locationsId :PlayApi, recommendersId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): getConfig = new getConfig(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/recommenders/${recommendersId}/config").addQueryStringParameters("name" -> name.toString))
					given Conversion[getConfig, Future[Schema.GoogleCloudRecommenderV1RecommenderConfig]] = (fun: getConfig) => fun.apply()
				}
				object recommendations {
					class markClaimed(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
