...
class Api @Inject() (ws: WSClient) extends PlayApi {
	...
	object customers {
		...
		object patch {
			def apply(customersId :PlayApi, updateMask: String, name: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1alpha1/customers/${customersId}")).addQueryStringParameters("updateMask" -> updateMask.toString, "name" -> name.toString))
		}
		object nodes {
			...
			object list {
				def apply(customersId :PlayApi, parent: String, pageSize: Int, filter: String, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1alpha1/customers/${customersId}/nodes")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "filter" -> filter.toString, "pageToken" -> pageToken.toString))
			...
			object nodes {
				...
				object list {
					def apply(customersId :PlayApi, nodesId :PlayApi, pageToken: String, filter: String, parent: String, pageSize: Int)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1alpha1/customers/${customersId}/nodes/${nodesId}/nodes")).addQueryStringParameters("pageToken" -> pageToken.toString, "filter" -> filter.toString, "parent" -> parent.toString, "pageSize" -> pageSize.toString))
					given Conversion[list, Future[Schema.SasPortalListNodesResponse]] = (fun: list) => fun.apply()
				}
			}
			object deployments {
				...
				object list {
					def apply(customersId :PlayApi, nodesId :PlayApi, parent: String, pageSize: Int, filter: String, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1alpha1/customers/${customersId}/nodes/${nodesId}/deployments")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "filter" -> filter.toString, "pageToken" -> pageToken.toString))
		...
		object deployments {
			...
			object patch {
				def apply(customersId :PlayApi, deploymentsId :PlayApi, updateMask: String, name: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1alpha1/customers/${customersId}/deployments/${deploymentsId}")).addQueryStringParameters("updateMask" -> updateMask.toString, "name" -> name.toString))
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SasPortalListDeploymentsResponse]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.SasPortalListDeploymentsResponse])
			}
		...
		object devices {
			...
			object patch {
				def apply(customersId :PlayApi, devicesId :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1alpha1/customers/${customersId}/devices/${devicesId}")).addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SasPortalListDevicesResponse]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.SasPortalListDevicesResponse])
			}
	...
	object nodes {
		...
		object devices {
			...
			object patch {
				def apply(nodesId :PlayApi, devicesId :PlayApi, updateMask: String, name: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1alpha1/nodes/${nodesId}/devices/${devicesId}")).addQueryStringParameters("updateMask" -> updateMask.toString, "name" -> name.toString))
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SasPortalListDevicesResponse]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.SasPortalListDevicesResponse])
			}
			object list {
				def apply(nodesId :PlayApi, filter: String, pageToken: String, pageSize: Int, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1alpha1/nodes/${nodesId}/devices")).addQueryStringParameters("filter" -> filter.toString, "pageToken" -> pageToken.toString, "pageSize" -> pageSize.toString, "parent" -> parent.toString))
				given Conversion[list, Future[Schema.SasPortalListDevicesResponse]] = (fun: list) => fun.apply()
			}
		}
		object nodes {
			...
			object patch {
				def apply(nodesId :PlayApi, nodesId1 :PlayApi, updateMask: String, name: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1alpha1/nodes/${nodesId}/nodes/${nodesId1}")).addQueryStringParameters("updateMask" -> updateMask.toString, "name" -> name.toString))
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SasPortalListNodesResponse]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.SasPortalListNodesResponse])
			}
			object list {
				def apply(nodesId :PlayApi, pageSize: Int, parent: String, filter: String, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1alpha1/nodes/${nodesId}/nodes")).addQueryStringParameters("pageSize" -> pageSize.toString, "parent" -> parent.toString, "filter" -> filter.toString, "pageToken" -> pageToken.toString))
				given Conversion[list, Future[Schema.SasPortalListNodesResponse]] = (fun: list) => fun.apply()
			}
			object nodes {
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SasPortalListNodesResponse]) {
				...
				object list {
					def apply(nodesId :PlayApi, nodesId1 :PlayApi, parent: String, pageSize: Int, filter: String, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1alpha1/nodes/${nodesId}/nodes/${nodesId1}/nodes")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "filter" -> filter.toString, "pageToken" -> pageToken.toString))
					given Conversion[list, Future[Schema.SasPortalListNodesResponse]] = (fun: list) => fun.apply()
				}
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withSasPortalNode(body: Schema.SasPortalNode) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.SasPortalNode])
			...
			object deployments {
				...
				object list {
					def apply(nodesId :PlayApi, nodesId1 :PlayApi, pageToken: String, pageSize: Int, parent: String, filter: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1alpha1/nodes/${nodesId}/nodes/${nodesId1}/deployments")).addQueryStringParameters("pageToken" -> pageToken.toString, "pageSize" -> pageSize.toString, "parent" -> parent.toString, "filter" -> filter.toString))
					given Conversion[list, Future[Schema.SasPortalListDeploymentsResponse]] = (fun: list) => fun.apply()
				}
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withSasPortalDeployment(body: Schema.SasPortalDeployment) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.SasPortalDeployment])
			...
			object devices {
				...
				object list {
					def apply(nodesId :PlayApi, nodesId1 :PlayApi, filter: String, pageSize: Int, parent: String, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1alpha1/nodes/${nodesId}/nodes/${nodesId1}/devices")).addQueryStringParameters("filter" -> filter.toString, "pageSize" -> pageSize.toString, "parent" -> parent.toString, "pageToken" -> pageToken.toString))
					given Conversion[list, Future[Schema.SasPortalListDevicesResponse]] = (fun: list) => fun.apply()
				}
			}
		}
		object deployments {
			...
			object patch {
				def apply(nodesId :PlayApi, deploymentsId :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1alpha1/nodes/${nodesId}/deployments/${deploymentsId}")).addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SasPortalListDeploymentsResponse]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.SasPortalListDeploymentsResponse])
			}
			object list {
				def apply(nodesId :PlayApi, parent: String, pageSize: Int, pageToken: String, filter: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1alpha1/nodes/${nodesId}/deployments")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString, "filter" -> filter.toString))
				given Conversion[list, Future[Schema.SasPortalListDeploymentsResponse]] = (fun: list) => fun.apply()
			}
			object devices {
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
	...
	object deployments {
		...
		object devices {
			...
			object patch {
				def apply(deploymentsId :PlayApi, devicesId :PlayApi, updateMask: String, name: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1alpha1/deployments/${deploymentsId}/devices/${devicesId}")).addQueryStringParameters("updateMask" -> updateMask.toString, "name" -> name.toString))
			}
		}
	}
	object installer {
