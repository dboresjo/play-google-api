	...
	object projects {
		object locations {
			class fetchStaticIps(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.FetchStaticIpsResponse]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.FetchStaticIpsResponse])
			}
			object fetchStaticIps {
				def apply(projectsId :PlayApi, locationsId :PlayApi, name: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): fetchStaticIps = new fetchStaticIps(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}:fetchStaticIps")).addQueryStringParameters("name" -> name.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
			...
			object conversionWorkspaces {
				...
				class searchBackgroundJobs(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SearchBackgroundJobsResponse]) {
					...
					def apply() = req.execute("GET").map(_.json.as[Schema.SearchBackgroundJobsResponse])
				}
				object searchBackgroundJobs {
					def apply(projectsId :PlayApi, locationsId :PlayApi, conversionWorkspacesId :PlayApi, conversionWorkspace: String)(using auth: AuthToken, ec: ExecutionContext): searchBackgroundJobs = new searchBackgroundJobs(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/conversionWorkspaces/${conversionWorkspacesId}:searchBackgroundJobs")).addQueryStringParameters("conversionWorkspace" -> conversionWorkspace.toString))
				...
				class rollback(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withRollbackConversionWorkspaceRequest(body: Schema.RollbackConversionWorkspaceRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
				}
				object rollback {
					def apply(projectsId :PlayApi, locationsId :PlayApi, conversionWorkspacesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): rollback = new rollback(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/conversionWorkspaces/${conversionWorkspacesId}:rollback")).addQueryStringParameters("name" -> name.toString))
				}
				class apply(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withApplyConversionWorkspaceRequest(body: Schema.ApplyConversionWorkspaceRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
				}
				object apply {
					def apply(projectsId :PlayApi, locationsId :PlayApi, conversionWorkspacesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): apply = new apply(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/conversionWorkspaces/${conversionWorkspacesId}:apply")).addQueryStringParameters("name" -> name.toString))
				}
				...
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ConversionWorkspace]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.ConversionWorkspace])
				}
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, conversionWorkspacesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/conversionWorkspaces/${conversionWorkspacesId}")).addQueryStringParameters("name" -> name.toString))
					given Conversion[get, Future[Schema.ConversionWorkspace]] = (fun: get) => fun.apply()
				}
				class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withConversionWorkspace(body: Schema.ConversionWorkspace) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.Operation])
				}
				object patch {
					def apply(projectsId :PlayApi, locationsId :PlayApi, conversionWorkspacesId :PlayApi, name: String, updateMask: String, requestId: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/conversionWorkspaces/${conversionWorkspacesId}")).addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString, "requestId" -> requestId.toString))
				}
				class convert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withConvertConversionWorkspaceRequest(body: Schema.ConvertConversionWorkspaceRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
				}
				object convert {
					def apply(projectsId :PlayApi, locationsId :PlayApi, conversionWorkspacesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): convert = new convert(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/conversionWorkspaces/${conversionWorkspacesId}:convert")).addQueryStringParameters("name" -> name.toString))
				}
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListConversionWorkspacesResponse]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.ListConversionWorkspacesResponse])
				}
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, pageSize: Int, pageToken: String, filter: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/conversionWorkspaces")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString, "filter" -> filter.toString))
				...
				object testIamPermissions {
					def apply(projectsId :PlayApi, locationsId :PlayApi, conversionWorkspacesId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): testIamPermissions = new testIamPermissions(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/conversionWorkspaces/${conversionWorkspacesId}:testIamPermissions")).addQueryStringParameters("resource" -> resource.toString))
				}
				class describeDatabaseEntities(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.DescribeDatabaseEntitiesResponse]) {
					...
					def apply() = req.execute("GET").map(_.json.as[Schema.DescribeDatabaseEntitiesResponse])
				}
				object describeDatabaseEntities {
					def apply(projectsId :PlayApi, locationsId :PlayApi, conversionWorkspacesId :PlayApi, conversionWorkspace: String, tree: String)(using auth: AuthToken, ec: ExecutionContext): describeDatabaseEntities = new describeDatabaseEntities(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/conversionWorkspaces/${conversionWorkspacesId}:describeDatabaseEntities")).addQueryStringParameters("conversionWorkspace" -> conversionWorkspace.toString, "tree" -> tree.toString))
				...
				class commit(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withCommitConversionWorkspaceRequest(body: Schema.CommitConversionWorkspaceRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
				}
				object commit {
					def apply(projectsId :PlayApi, locationsId :PlayApi, conversionWorkspacesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): commit = new commit(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/conversionWorkspaces/${conversionWorkspacesId}:commit")).addQueryStringParameters("name" -> name.toString))
				}
				class seed(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withSeedConversionWorkspaceRequest(body: Schema.SeedConversionWorkspaceRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
				}
				object seed {
					def apply(projectsId :PlayApi, locationsId :PlayApi, conversionWorkspacesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): seed = new seed(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/conversionWorkspaces/${conversionWorkspacesId}:seed")).addQueryStringParameters("name" -> name.toString))
				}
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withConversionWorkspace(body: Schema.ConversionWorkspace) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
				}
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, conversionWorkspaceId: String, requestId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/conversionWorkspaces")).addQueryStringParameters("parent" -> parent.toString, "conversionWorkspaceId" -> conversionWorkspaceId.toString, "requestId" -> requestId.toString))
				}
				...
				object setIamPolicy {
					def apply(projectsId :PlayApi, locationsId :PlayApi, conversionWorkspacesId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): setIamPolicy = new setIamPolicy(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/conversionWorkspaces/${conversionWorkspacesId}:setIamPolicy")).addQueryStringParameters("resource" -> resource.toString))
				}
				object mappingRules {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withMappingRule(body: Schema.MappingRule) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.MappingRule])
					}
					object create {
						def apply(projectsId :PlayApi, locationsId :PlayApi, conversionWorkspacesId :PlayApi, parent: String, mappingRuleId: String, requestId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/conversionWorkspaces/${conversionWorkspacesId}/mappingRules")).addQueryStringParameters("parent" -> parent.toString, "mappingRuleId" -> mappingRuleId.toString, "requestId" -> requestId.toString))
					}
					class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withImportMappingRulesRequest(body: Schema.ImportMappingRulesRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
					}
					object `import` {
						def apply(projectsId :PlayApi, locationsId :PlayApi, conversionWorkspacesId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): `import` = new `import`(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/conversionWorkspaces/${conversionWorkspacesId}/mappingRules:import")).addQueryStringParameters("parent" -> parent.toString))
					}
					class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Empty]) {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.MappingRule]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.MappingRule])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, conversionWorkspacesId :PlayApi, mappingRulesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/conversionWorkspaces/${conversionWorkspacesId}/mappingRules/${mappingRulesId}")).addQueryStringParameters("name" -> name.toString))
			...
			object privateConnections {
				...
				object testIamPermissions {
					def apply(projectsId :PlayApi, locationsId :PlayApi, privateConnectionsId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): testIamPermissions = new testIamPermissions(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/privateConnections/${privateConnectionsId}:testIamPermissions")).addQueryStringParameters("resource" -> resource.toString))
				}
				class getIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Policy]) {
					/** Optional. The maximum policy version that will be used to format the policy. Valid values are 0, 1, and 3. Requests specifying an invalid value will be rejected. Requests for policies with any conditional role bindings must specify version 3. Policies with no conditional role bindings may specify any valid value or leave the field unset. The policy in the response might use the policy version that you specified, or it might use a lower policy version. For example, if you specify version 3, but the policy has no conditional role bindings, the response uses version 1. To learn which resources support conditions in their IAM policies, see the [IAM documentation](https://cloud.google.com/iam/help/conditions/resource-policies).<br>Format: int32 */
					def withOptionsRequestedPolicyVersion(optionsRequestedPolicyVersion: Int) = new getIamPolicy(req.addQueryStringParameters("options.requestedPolicyVersion" -> optionsRequestedPolicyVersion.toString))
				...
				object getIamPolicy {
					def apply(projectsId :PlayApi, locationsId :PlayApi, privateConnectionsId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): getIamPolicy = new getIamPolicy(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/privateConnections/${privateConnectionsId}:getIamPolicy")).addQueryStringParameters("resource" -> resource.toString))
					given Conversion[getIamPolicy, Future[Schema.Policy]] = (fun: getIamPolicy) => fun.apply()
				}
				class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Operation]) {
					/** Optional. A unique ID used to identify the request. If the server receives two requests with the same ID, then the second request is ignored. It is recommended to always set this value to a UUID. The ID must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and hyphens (-). The maximum length is 40 characters. */
				...
				object setIamPolicy {
					def apply(projectsId :PlayApi, locationsId :PlayApi, privateConnectionsId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): setIamPolicy = new setIamPolicy(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/privateConnections/${privateConnectionsId}:setIamPolicy")).addQueryStringParameters("resource" -> resource.toString))
				}
			}
			object migrationJobs {
				...
				object testIamPermissions {
					def apply(projectsId :PlayApi, locationsId :PlayApi, migrationJobsId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): testIamPermissions = new testIamPermissions(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs/${migrationJobsId}:testIamPermissions")).addQueryStringParameters("resource" -> resource.toString))
				}
				class resume(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withResumeMigrationJobRequest(body: Schema.ResumeMigrationJobRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
				}
				object resume {
					def apply(projectsId :PlayApi, locationsId :PlayApi, migrationJobsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): resume = new resume(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs/${migrationJobsId}:resume")).addQueryStringParameters("name" -> name.toString))
				}
				class stop(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withStopMigrationJobRequest(body: Schema.StopMigrationJobRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
				}
				object stop {
					def apply(projectsId :PlayApi, locationsId :PlayApi, migrationJobsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): stop = new stop(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs/${migrationJobsId}:stop")).addQueryStringParameters("name" -> name.toString))
				}
				class getIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Policy]) {
					/** Optional. The maximum policy version that will be used to format the policy. Valid values are 0, 1, and 3. Requests specifying an invalid value will be rejected. Requests for policies with any conditional role bindings must specify version 3. Policies with no conditional role bindings may specify any valid value or leave the field unset. The policy in the response might use the policy version that you specified, or it might use a lower policy version. For example, if you specify version 3, but the policy has no conditional role bindings, the response uses version 1. To learn which resources support conditions in their IAM policies, see the [IAM documentation](https://cloud.google.com/iam/help/conditions/resource-policies).<br>Format: int32 */
					def withOptionsRequestedPolicyVersion(optionsRequestedPolicyVersion: Int) = new getIamPolicy(req.addQueryStringParameters("options.requestedPolicyVersion" -> optionsRequestedPolicyVersion.toString))
				...
				object getIamPolicy {
					def apply(projectsId :PlayApi, locationsId :PlayApi, migrationJobsId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): getIamPolicy = new getIamPolicy(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs/${migrationJobsId}:getIamPolicy")).addQueryStringParameters("resource" -> resource.toString))
					given Conversion[getIamPolicy, Future[Schema.Policy]] = (fun: getIamPolicy) => fun.apply()
				}
				class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Operation]) {
					def apply() = req.execute("DELETE").map(_.json.as[Schema.Operation])
				...
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, migrationJobsId :PlayApi, name: String, requestId: String, force: Boolean)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs/${migrationJobsId}")).addQueryStringParameters("name" -> name.toString, "requestId" -> requestId.toString, "force" -> force.toString))
					given Conversion[delete, Future[Schema.Operation]] = (fun: delete) => fun.apply()
				}
				class demoteDestination(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withDemoteDestinationRequest(body: Schema.DemoteDestinationRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
				}
				object demoteDestination {
					def apply(projectsId :PlayApi, locationsId :PlayApi, migrationJobsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): demoteDestination = new demoteDestination(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs/${migrationJobsId}:demoteDestination")).addQueryStringParameters("name" -> name.toString))
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.MigrationJob]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.MigrationJob])
				}
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, migrationJobsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs/${migrationJobsId}")).addQueryStringParameters("name" -> name.toString))
				...
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListMigrationJobsResponse]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.ListMigrationJobsResponse])
				}
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, pageSize: Int, pageToken: String, filter: String, orderBy: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString, "filter" -> filter.toString, "orderBy" -> orderBy.toString))
				...
				class verify(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withVerifyMigrationJobRequest(body: Schema.VerifyMigrationJobRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
				}
				object verify {
					def apply(projectsId :PlayApi, locationsId :PlayApi, migrationJobsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): verify = new verify(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs/${migrationJobsId}:verify")).addQueryStringParameters("name" -> name.toString))
				}
				class generateTcpProxyScript(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGenerateTcpProxyScriptRequest(body: Schema.GenerateTcpProxyScriptRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.TcpProxyScript])
				}
				object generateTcpProxyScript {
					def apply(projectsId :PlayApi, locationsId :PlayApi, migrationJobsId :PlayApi, migrationJob: String)(using auth: AuthToken, ec: ExecutionContext): generateTcpProxyScript = new generateTcpProxyScript(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs/${migrationJobsId}:generateTcpProxyScript")).addQueryStringParameters("migrationJob" -> migrationJob.toString))
				}
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					/** Optional. A unique ID used to identify the request. If the server receives two requests with the same ID, then the second request is ignored. It is recommended to always set this value to a UUID. The ID must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and hyphens (-). The maximum length is 40 characters. */
					def withRequestId(requestId: String) = new create(req.addQueryStringParameters("requestId" -> requestId.toString))
					def withMigrationJob(body: Schema.MigrationJob) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
				}
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, migrationJobId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs")).addQueryStringParameters("parent" -> parent.toString, "migrationJobId" -> migrationJobId.toString))
				}
				class setIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withSetIamPolicyRequest(body: Schema.SetIamPolicyRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Policy])
				}
				object setIamPolicy {
					def apply(projectsId :PlayApi, locationsId :PlayApi, migrationJobsId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): setIamPolicy = new setIamPolicy(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs/${migrationJobsId}:setIamPolicy")).addQueryStringParameters("resource" -> resource.toString))
				}
				class promote(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withPromoteMigrationJobRequest(body: Schema.PromoteMigrationJobRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
				}
				object promote {
					def apply(projectsId :PlayApi, locationsId :PlayApi, migrationJobsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): promote = new promote(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs/${migrationJobsId}:promote")).addQueryStringParameters("name" -> name.toString))
				}
				class generateSshScript(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGenerateSshScriptRequest(body: Schema.GenerateSshScriptRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.SshScript])
				}
				object generateSshScript {
					def apply(projectsId :PlayApi, locationsId :PlayApi, migrationJobsId :PlayApi, migrationJob: String)(using auth: AuthToken, ec: ExecutionContext): generateSshScript = new generateSshScript(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs/${migrationJobsId}:generateSshScript")).addQueryStringParameters("migrationJob" -> migrationJob.toString))
				}
				class restart(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withRestartMigrationJobRequest(body: Schema.RestartMigrationJobRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
				}
				object restart {
					def apply(projectsId :PlayApi, locationsId :PlayApi, migrationJobsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): restart = new restart(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs/${migrationJobsId}:restart")).addQueryStringParameters("name" -> name.toString))
				}
				class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withMigrationJob(body: Schema.MigrationJob) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.Operation])
				}
				object patch {
					def apply(projectsId :PlayApi, locationsId :PlayApi, migrationJobsId :PlayApi, name: String, updateMask: String, requestId: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs/${migrationJobsId}")).addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString, "requestId" -> requestId.toString))
				}
				class start(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withStartMigrationJobRequest(body: Schema.StartMigrationJobRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
				}
				object start {
					def apply(projectsId :PlayApi, locationsId :PlayApi, migrationJobsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): start = new start(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs/${migrationJobsId}:start")).addQueryStringParameters("name" -> name.toString))
				}
				object objects {
					class setIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withSetIamPolicyRequest(body: Schema.SetIamPolicyRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Policy])
					...
					object setIamPolicy {
						def apply(projectsId :PlayApi, locationsId :PlayApi, migrationJobsId :PlayApi, objectsId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): setIamPolicy = new setIamPolicy(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs/${migrationJobsId}/objects/${objectsId}:setIamPolicy")).addQueryStringParameters("resource" -> resource.toString))
					}
					class getIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Policy]) {
						/** Optional. The maximum policy version that will be used to format the policy. Valid values are 0, 1, and 3. Requests specifying an invalid value will be rejected. Requests for policies with any conditional role bindings must specify version 3. Policies with no conditional role bindings may specify any valid value or leave the field unset. The policy in the response might use the policy version that you specified, or it might use a lower policy version. For example, if you specify version 3, but the policy has no conditional role bindings, the response uses version 1. To learn which resources support conditions in their IAM policies, see the [IAM documentation](https://cloud.google.com/iam/help/conditions/resource-policies).<br>Format: int32 */
						def withOptionsRequestedPolicyVersion(optionsRequestedPolicyVersion: Int) = new getIamPolicy(req.addQueryStringParameters("options.requestedPolicyVersion" -> optionsRequestedPolicyVersion.toString))
					...
					object getIamPolicy {
						def apply(projectsId :PlayApi, locationsId :PlayApi, migrationJobsId :PlayApi, objectsId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): getIamPolicy = new getIamPolicy(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs/${migrationJobsId}/objects/${objectsId}:getIamPolicy")).addQueryStringParameters("resource" -> resource.toString))
						given Conversion[getIamPolicy, Future[Schema.Policy]] = (fun: getIamPolicy) => fun.apply()
					}
					class testIamPermissions(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withTestIamPermissionsRequest(body: Schema.TestIamPermissionsRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.TestIamPermissionsResponse])
					...
					object testIamPermissions {
						def apply(projectsId :PlayApi, locationsId :PlayApi, migrationJobsId :PlayApi, objectsId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): testIamPermissions = new testIamPermissions(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/migrationJobs/${migrationJobsId}/objects/${objectsId}:testIamPermissions")).addQueryStringParameters("resource" -> resource.toString))
					}
				}
			}
			object connectionProfiles {
				...
				object testIamPermissions {
					def apply(projectsId :PlayApi, locationsId :PlayApi, connectionProfilesId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): testIamPermissions = new testIamPermissions(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/connectionProfiles/${connectionProfilesId}:testIamPermissions")).addQueryStringParameters("resource" -> resource.toString))
				}
				class getIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Policy]) {
					/** Optional. The maximum policy version that will be used to format the policy. Valid values are 0, 1, and 3. Requests specifying an invalid value will be rejected. Requests for policies with any conditional role bindings must specify version 3. Policies with no conditional role bindings may specify any valid value or leave the field unset. The policy in the response might use the policy version that you specified, or it might use a lower policy version. For example, if you specify version 3, but the policy has no conditional role bindings, the response uses version 1. To learn which resources support conditions in their IAM policies, see the [IAM documentation](https://cloud.google.com/iam/help/conditions/resource-policies).<br>Format: int32 */
					def withOptionsRequestedPolicyVersion(optionsRequestedPolicyVersion: Int) = new getIamPolicy(req.addQueryStringParameters("options.requestedPolicyVersion" -> optionsRequestedPolicyVersion.toString))
				...
				object getIamPolicy {
					def apply(projectsId :PlayApi, locationsId :PlayApi, connectionProfilesId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): getIamPolicy = new getIamPolicy(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/connectionProfiles/${connectionProfilesId}:getIamPolicy")).addQueryStringParameters("resource" -> resource.toString))
					given Conversion[getIamPolicy, Future[Schema.Policy]] = (fun: getIamPolicy) => fun.apply()
				}
				class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Operation]) {
					def apply() = req.execute("DELETE").map(_.json.as[Schema.Operation])
				...
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, connectionProfilesId :PlayApi, name: String, requestId: String, force: Boolean)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/connectionProfiles/${connectionProfilesId}")).addQueryStringParameters("name" -> name.toString, "requestId" -> requestId.toString, "force" -> force.toString))
					given Conversion[delete, Future[Schema.Operation]] = (fun: delete) => fun.apply()
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ConnectionProfile]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.ConnectionProfile])
				}
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, connectionProfilesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/connectionProfiles/${connectionProfilesId}")).addQueryStringParameters("name" -> name.toString))
				...
				class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					def withConnectionProfile(body: Schema.ConnectionProfile) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.Operation])
				}
				object patch {
					def apply(projectsId :PlayApi, locationsId :PlayApi, connectionProfilesId :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/connectionProfiles/${connectionProfilesId}")).addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
				}
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListConnectionProfilesResponse]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.ListConnectionProfilesResponse])
				}
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, pageSize: Int, pageToken: String, filter: String, orderBy: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/connectionProfiles")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString, "filter" -> filter.toString, "orderBy" -> orderBy.toString))
				...
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					def withSkipValidation(skipValidation: Boolean) = new create(req.addQueryStringParameters("skipValidation" -> skipValidation.toString))
					def withConnectionProfile(body: Schema.ConnectionProfile) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
				}
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, connectionProfileId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/connectionProfiles")).addQueryStringParameters("parent" -> parent.toString, "connectionProfileId" -> connectionProfileId.toString))
				}
				class setIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withSetIamPolicyRequest(body: Schema.SetIamPolicyRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Policy])
				}
				object setIamPolicy {
					def apply(projectsId :PlayApi, locationsId :PlayApi, connectionProfilesId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): setIamPolicy = new setIamPolicy(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/connectionProfiles/${connectionProfilesId}:setIamPolicy")).addQueryStringParameters("resource" -> resource.toString))
				}
			}
		}
	}
