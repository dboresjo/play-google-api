...
class Api @Inject() (ws: WSClient) extends PlayApi {
	...
	object projects {
		object locations {
			object global {
				class getProjectFeatureSettings(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ProjectFeatureSettings]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ProjectFeatureSettings])
				}
				object getProjectFeatureSettings {
					def apply(projectsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): getProjectFeatureSettings = new getProjectFeatureSettings(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/global/projectFeatureSettings").addQueryStringParameters("name" -> name.toString))
				...
				class updateProjectFeatureSettings(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					def withProjectFeatureSettings(body: Schema.ProjectFeatureSettings) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.ProjectFeatureSettings])
				}
				object updateProjectFeatureSettings {
					def apply(projectsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): updateProjectFeatureSettings = new updateProjectFeatureSettings(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/global/projectFeatureSettings").addQueryStringParameters("name" -> name.toString))
				}
			}
			object osPolicyAssignments {
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					def withOSPolicyAssignment(body: Schema.OSPolicyAssignment) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object create {
				...
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, osPolicyAssignmentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/osPolicyAssignments/${osPolicyAssignmentsId}").addQueryStringParameters("name" -> name.toString))
				...
				class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					def withOSPolicyAssignment(body: Schema.OSPolicyAssignment) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.Operation])
				}
				object patch {
					def apply(projectsId :PlayApi, locationsId :PlayApi, osPolicyAssignmentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/osPolicyAssignments/${osPolicyAssignmentsId}").addQueryStringParameters("name" -> name.toString))
				}
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListOSPolicyAssignmentsResponse]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListOSPolicyAssignmentsResponse])
				}
				object list {
				...
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.OSPolicyAssignment]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.OSPolicyAssignment])
				}
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, osPolicyAssignmentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/osPolicyAssignments/${osPolicyAssignmentsId}").addQueryStringParameters("name" -> name.toString))
				...
				class listRevisions(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListOSPolicyAssignmentRevisionsResponse]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListOSPolicyAssignmentRevisionsResponse])
				}
			...
			object instances {
				object osPolicyAssignments {
					object reports {
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.OSPolicyAssignmentReport]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.OSPolicyAssignmentReport])
						}
						object get {
						...
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListOSPolicyAssignmentReportsResponse]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListOSPolicyAssignmentReportsResponse])
						}
						object list {
				...
				object inventories {
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Inventory]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.Inventory])
					}
					object get {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListInventoriesResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListInventoriesResponse])
					}
					object list {
				...
				object vulnerabilityReports {
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.VulnerabilityReport]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.VulnerabilityReport])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, instancesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/instances/${instancesId}/vulnerabilityReport").addQueryStringParameters("name" -> name.toString))
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListVulnerabilityReportsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListVulnerabilityReportsResponse])
					}
					object list {
		...
		object patchJobs {
			class cancel(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withCancelPatchJobRequest(body: Schema.CancelPatchJobRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.PatchJob])
			}
			object cancel {
				def apply(projectsId :PlayApi, patchJobsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): cancel = new cancel(ws.url(BASE_URL + s"v1/projects/${projectsId}/patchJobs/${patchJobsId}:cancel").addQueryStringParameters("name" -> name.toString))
			}
			class execute(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withExecutePatchJobRequest(body: Schema.ExecutePatchJobRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.PatchJob])
			}
			object execute {
				def apply(projectsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): execute = new execute(ws.url(BASE_URL + s"v1/projects/${projectsId}/patchJobs:execute").addQueryStringParameters("parent" -> parent.toString))
			}
			class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.PatchJob]) {
				def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.PatchJob])
			}
			object get {
				def apply(projectsId :PlayApi, patchJobsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/patchJobs/${patchJobsId}").addQueryStringParameters("name" -> name.toString))
			...
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListPatchJobsResponse]) {
				def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListPatchJobsResponse])
			}
			object list {
			...
			object instanceDetails {
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListPatchJobInstanceDetailsResponse]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListPatchJobInstanceDetailsResponse])
				}
				object list {
		...
		object patchDeployments {
			class resume(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withResumePatchDeploymentRequest(body: Schema.ResumePatchDeploymentRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.PatchDeployment])
			}
			object resume {
				def apply(projectsId :PlayApi, patchDeploymentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): resume = new resume(ws.url(BASE_URL + s"v1/projects/${projectsId}/patchDeployments/${patchDeploymentsId}:resume").addQueryStringParameters("name" -> name.toString))
			}
			class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Empty]) {
				def apply() = auth.exec(req,_.execute("DELETE")).map(_.json.as[Schema.Empty])
			}
			object delete {
				def apply(projectsId :PlayApi, patchDeploymentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/patchDeployments/${patchDeploymentsId}").addQueryStringParameters("name" -> name.toString))
			...
			class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.PatchDeployment]) {
				def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.PatchDeployment])
			}
			object get {
				def apply(projectsId :PlayApi, patchDeploymentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/patchDeployments/${patchDeploymentsId}").addQueryStringParameters("name" -> name.toString))
			...
			class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				...
				def withUpdateMask(updateMask: String) = new patch(req.addQueryStringParameters("updateMask" -> updateMask.toString))
				def withPatchDeployment(body: Schema.PatchDeployment) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.PatchDeployment])
			}
			object patch {
				def apply(projectsId :PlayApi, patchDeploymentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(ws.url(BASE_URL + s"v1/projects/${projectsId}/patchDeployments/${patchDeploymentsId}").addQueryStringParameters("name" -> name.toString))
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListPatchDeploymentsResponse]) {
				...
				def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListPatchDeploymentsResponse])
			}
			object list {
				def apply(projectsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/patchDeployments").addQueryStringParameters("parent" -> parent.toString))
			...
			class pause(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withPausePatchDeploymentRequest(body: Schema.PausePatchDeploymentRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.PatchDeployment])
			}
			object pause {
				def apply(projectsId :PlayApi, patchDeploymentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): pause = new pause(ws.url(BASE_URL + s"v1/projects/${projectsId}/patchDeployments/${patchDeploymentsId}:pause").addQueryStringParameters("name" -> name.toString))
			}
			class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withPatchDeployment(body: Schema.PatchDeployment) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.PatchDeployment])
			}
			object create {
				def apply(projectsId :PlayApi, parent: String, patchDeploymentId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/patchDeployments").addQueryStringParameters("parent" -> parent.toString, "patchDeploymentId" -> patchDeploymentId.toString))
			}
		}
	}
}
