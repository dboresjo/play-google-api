...
class Api @Inject() (ws: WSClient) extends PlayApi {
	...
	object bookshelves {
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Bookshelf]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.Bookshelf])
		}
		object get {
			def apply(userId: String, shelf: String, source: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"books/v1/users/${userId}/bookshelves/${shelf}")).addQueryStringParameters("source" -> source.toString))
		...
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Bookshelves]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.Bookshelves])
		}
		object list {
			def apply(userId: String, source: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"books/v1/users/${userId}/bookshelves")).addQueryStringParameters("source" -> source.toString))
	...
	object cloudloading {
		...
		object deleteBook {
			def apply(volumeId: String)(using auth: AuthToken, ec: ExecutionContext): deleteBook = new deleteBook(auth(ws.url(BASE_URL + s"books/v1/cloudloading/deleteBook")).addQueryStringParameters("volumeId" -> volumeId.toString))
		...
		class updateBook(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withBooksCloudloadingResource(body: Schema.BooksCloudloadingResource) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.BooksCloudloadingResource])
		}
		object updateBook {
			def apply()(using auth: AuthToken, ec: ExecutionContext): updateBook = new updateBook(auth(ws.url(BASE_URL + s"books/v1/cloudloading/updateBook")).addQueryStringParameters())
		}
	}
	object dictionary {
		class listOfflineMetadata(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Metadata]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.Metadata])
		}
		object listOfflineMetadata {
			def apply(cpksver: String)(using auth: AuthToken, ec: ExecutionContext): listOfflineMetadata = new listOfflineMetadata(auth(ws.url(BASE_URL + s"books/v1/dictionary/listOfflineMetadata")).addQueryStringParameters("cpksver" -> cpksver.toString))
	...
	object familysharing {
		class getFamilyInfo(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.FamilyInfo]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.FamilyInfo])
		}
		object getFamilyInfo {
			def apply(source: String)(using auth: AuthToken, ec: ExecutionContext): getFamilyInfo = new getFamilyInfo(auth(ws.url(BASE_URL + s"books/v1/familysharing/getFamilyInfo")).addQueryStringParameters("source" -> source.toString))
		...
		object share {
			def apply(docId: String, source: String, volumeId: String)(using auth: AuthToken, ec: ExecutionContext): share = new share(auth(ws.url(BASE_URL + s"books/v1/familysharing/share")).addQueryStringParameters("docId" -> docId.toString, "source" -> source.toString, "volumeId" -> volumeId.toString))
		...
		object unshare {
			def apply(docId: String, source: String, volumeId: String)(using auth: AuthToken, ec: ExecutionContext): unshare = new unshare(auth(ws.url(BASE_URL + s"books/v1/familysharing/unshare")).addQueryStringParameters("docId" -> docId.toString, "source" -> source.toString, "volumeId" -> volumeId.toString))
	...
	object layers {
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Layersummary]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.Layersummary])
		}
		object get {
			def apply(volumeId: String, summaryId: String, contentVersion: String, source: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"books/v1/volumes/${volumeId}/layersummary/${summaryId}")).addQueryStringParameters("contentVersion" -> contentVersion.toString, "source" -> source.toString))
		...
		object volumeAnnotations {
			class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Volumeannotation]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.Volumeannotation])
			}
			object get {
				def apply(volumeId: String, layerId: String, annotationId: String, locale: String, source: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"books/v1/volumes/${volumeId}/layers/${layerId}/annotations/${annotationId}")).addQueryStringParameters("locale" -> locale.toString, "source" -> source.toString))
	...
	object myconfig {
		...
		class updateUserSettings(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withUsersettings(body: Schema.Usersettings) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Usersettings])
		}
		object updateUserSettings {
			def apply()(using auth: AuthToken, ec: ExecutionContext): updateUserSettings = new updateUserSettings(auth(ws.url(BASE_URL + s"books/v1/myconfig/updateUserSettings")).addQueryStringParameters())
		}
		...
		class getUserSettings(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Usersettings]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.Usersettings])
		}
		object getUserSettings {
			def apply(country: String)(using auth: AuthToken, ec: ExecutionContext): getUserSettings = new getUserSettings(auth(ws.url(BASE_URL + s"books/v1/myconfig/getUserSettings")).addQueryStringParameters("country" -> country.toString))
	...
	object mylibrary {
		object annotations {
			class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withAnnotation(body: Schema.Annotation) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Annotation])
			}
			object insert {
				def apply(annotationId: String, country: String, showOnlySummaryInResponse: Boolean, source: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(auth(ws.url(BASE_URL + s"books/v1/mylibrary/annotations")).addQueryStringParameters("annotationId" -> annotationId.toString, "country" -> country.toString, "showOnlySummaryInResponse" -> showOnlySummaryInResponse.toString, "source" -> source.toString))
			}
			class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Empty]) {
				def apply() = req.execute("DELETE").map(_.json.as[Schema.Empty])
			}
			object delete {
				def apply(annotationId: String, source: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"books/v1/mylibrary/annotations/${annotationId}")).addQueryStringParameters("source" -> source.toString))
				given Conversion[delete, Future[Schema.Empty]] = (fun: delete) => fun.apply()
			}
			class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withAnnotation(body: Schema.Annotation) = req.withBody(Json.toJson(body)).execute("PUT").map(_.json.as[Schema.Annotation])
			}
			object update {
				def apply(annotationId: String, source: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(auth(ws.url(BASE_URL + s"books/v1/mylibrary/annotations/${annotationId}")).addQueryStringParameters("source" -> source.toString))
			}
			class summary(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AnnotationsSummary]) {
				...
				def apply() = req.execute("POST").map(_.json.as[Schema.AnnotationsSummary])
			}
			object summary {
				def apply(layerIds: String, volumeId: String)(using auth: AuthToken, ec: ExecutionContext): summary = new summary(auth(ws.url(BASE_URL + s"books/v1/mylibrary/annotations/summary")).addQueryStringParameters("layerIds" -> layerIds.toString, "volumeId" -> volumeId.toString))
		...
		object bookshelves {
			...
			object clearVolumes {
				def apply(shelf: String, source: String)(using auth: AuthToken, ec: ExecutionContext): clearVolumes = new clearVolumes(auth(ws.url(BASE_URL + s"books/v1/mylibrary/bookshelves/${shelf}/clearVolumes")).addQueryStringParameters("source" -> source.toString))
			...
			object get {
				def apply(shelf: String, source: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"books/v1/mylibrary/bookshelves/${shelf}")).addQueryStringParameters("source" -> source.toString))
				given Conversion[get, Future[Schema.Bookshelf]] = (fun: get) => fun.apply()
			}
			...
			object addVolume {
				def apply(shelf: String, reason: String, source: String, volumeId: String)(using auth: AuthToken, ec: ExecutionContext): addVolume = new addVolume(auth(ws.url(BASE_URL + s"books/v1/mylibrary/bookshelves/${shelf}/addVolume")).addQueryStringParameters("reason" -> reason.toString, "source" -> source.toString, "volumeId" -> volumeId.toString))
			...
			object list {
				def apply(source: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"books/v1/mylibrary/bookshelves")).addQueryStringParameters("source" -> source.toString))
				given Conversion[list, Future[Schema.Bookshelves]] = (fun: list) => fun.apply()
			}
			...
			object moveVolume {
				def apply(shelf: String, source: String, volumeId: String, volumePosition: Int)(using auth: AuthToken, ec: ExecutionContext): moveVolume = new moveVolume(auth(ws.url(BASE_URL + s"books/v1/mylibrary/bookshelves/${shelf}/moveVolume")).addQueryStringParameters("source" -> source.toString, "volumeId" -> volumeId.toString, "volumePosition" -> volumePosition.toString))
		...
		object readingpositions {
			class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ReadingPosition]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.ReadingPosition])
			}
			object get {
				def apply(volumeId: String, contentVersion: String, source: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"books/v1/mylibrary/readingpositions/${volumeId}")).addQueryStringParameters("contentVersion" -> contentVersion.toString, "source" -> source.toString))
	...
	object notification {
		...
		object get {
			def apply(locale: String, notification_id: String, source: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"books/v1/notification/get")).addQueryStringParameters("locale" -> locale.toString, "notification_id" -> notification_id.toString, "source" -> source.toString))
	...
	object onboarding {
		class listCategories(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Category]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.Category])
		}
		object listCategories {
			def apply(locale: String)(using auth: AuthToken, ec: ExecutionContext): listCategories = new listCategories(auth(ws.url(BASE_URL + s"books/v1/onboarding/listCategories")).addQueryStringParameters("locale" -> locale.toString))
	...
	object personalizedstream {
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Discoveryclusters]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.Discoveryclusters])
		}
		object get {
			def apply(locale: String, maxAllowedMaturityRating: String, source: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"books/v1/personalizedstream/get")).addQueryStringParameters("locale" -> locale.toString, "maxAllowedMaturityRating" -> maxAllowedMaturityRating.toString, "source" -> source.toString))
	...
	object promooffer {
		...
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Offers]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.Offers])
		}
		object get {
			def apply(androidId: String, device: String, manufacturer: String, model: String, product: String, serial: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"books/v1/promooffer/get")).addQueryStringParameters("androidId" -> androidId.toString, "device" -> device.toString, "manufacturer" -> manufacturer.toString, "model" -> model.toString, "product" -> product.toString, "serial" -> serial.toString))
	...
	object series {
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Series]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.Series])
		}
		object get {
			def apply(series_id: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"books/v1/series/get")).addQueryStringParameters("series_id" -> series_id.toString))
		...
		object membership {
			class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Seriesmembership]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.Seriesmembership])
			}
			object get {
				def apply(page_size: Int, page_token: String, series_id: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"books/v1/series/membership/get")).addQueryStringParameters("page_size" -> page_size.toString, "page_token" -> page_token.toString, "series_id" -> series_id.toString))
	...
	object volumes {
		...
		object mybooks {
			...
			object list {
				def apply(acquireMethod: String, country: String, locale: String, maxResults: Int, processingState: String, source: String, startIndex: Int)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"books/v1/volumes/mybooks")).addQueryStringParameters("acquireMethod" -> acquireMethod.toString, "country" -> country.toString, "locale" -> locale.toString, "maxResults" -> maxResults.toString, "processingState" -> processingState.toString, "source" -> source.toString, "startIndex" -> startIndex.toString))
				given Conversion[list, Future[Schema.Volumes]] = (fun: list) => fun.apply()
			}
		}
		object recommended {
			...
			object list {
				def apply(locale: String, maxAllowedMaturityRating: String, source: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"books/v1/volumes/recommended")).addQueryStringParameters("locale" -> locale.toString, "maxAllowedMaturityRating" -> maxAllowedMaturityRating.toString, "source" -> source.toString))
				given Conversion[list, Future[Schema.Volumes]] = (fun: list) => fun.apply()
			}
			class rate(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.BooksVolumesRecommendedRateResponse]) {
				def apply() = req.execute("POST").map(_.json.as[Schema.BooksVolumesRecommendedRateResponse])
			}
			object rate {
				def apply(locale: String, rating: String, source: String, volumeId: String)(using auth: AuthToken, ec: ExecutionContext): rate = new rate(auth(ws.url(BASE_URL + s"books/v1/volumes/recommended/rate")).addQueryStringParameters("locale" -> locale.toString, "rating" -> rating.toString, "source" -> source.toString, "volumeId" -> volumeId.toString))
