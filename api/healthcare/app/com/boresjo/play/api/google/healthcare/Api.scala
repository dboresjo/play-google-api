		...
		object locations {
			...
			object datasets {
				...
				class deidentify(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withDeidentifyDatasetRequest(body: Schema.DeidentifyDatasetRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object deidentify {
				...
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, datasetsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/datasets/${datasetsId}").addQueryStringParameters("name" -> name.toString))
				...
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, datasetsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/datasets/${datasetsId}").addQueryStringParameters("name" -> name.toString))
				...
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListDatasetsResponse]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListDatasetsResponse])
				}
				object list {
				...
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withDataset(body: Schema.Dataset) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, datasetId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/datasets").addQueryStringParameters("parent" -> parent.toString, "datasetId" -> datasetId.toString))
				}
				...
				object consentStores {
					...
					class queryAccessibleData(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withQueryAccessibleDataRequest(body: Schema.QueryAccessibleDataRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					...
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withConsentStore(body: Schema.ConsentStore) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.ConsentStore])
					}
					object patch {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListConsentStoresResponse]) {
						...
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListConsentStoresResponse])
					}
					object list {
						def apply(projectsId :PlayApi, locationsId :PlayApi, datasetsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/datasets/${datasetsId}/consentStores").addQueryStringParameters("parent" -> parent.toString))
					...
					class checkDataAccess(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withCheckDataAccessRequest(body: Schema.CheckDataAccessRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.CheckDataAccessResponse])
					}
					...
					class evaluateUserConsents(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withEvaluateUserConsentsRequest(body: Schema.EvaluateUserConsentsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.EvaluateUserConsentsResponse])
					}
					...
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withConsentStore(body: Schema.ConsentStore) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.ConsentStore])
					}
					object create {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ConsentStore]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ConsentStore])
					}
					object get {
					...
					object consents {
						class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withConsent(body: Schema.Consent) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Consent])
						}
						object create {
						...
						class activate(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withActivateConsentRequest(body: Schema.ActivateConsentRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Consent])
						}
						object activate {
						...
						class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withConsent(body: Schema.Consent) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.Consent])
						}
						object patch {
						...
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListConsentsResponse]) {
							...
							def withFilter(filter: String) = new list(req.addQueryStringParameters("filter" -> filter.toString))
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListConsentsResponse])
						}
						object list {
						...
						class revoke(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withRevokeConsentRequest(body: Schema.RevokeConsentRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Consent])
						}
						object revoke {
						...
						class reject(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withRejectConsentRequest(body: Schema.RejectConsentRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Consent])
						}
						object reject {
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Consent]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.Consent])
						}
						object get {
							def apply(projectsId :PlayApi, locationsId :PlayApi, datasetsId :PlayApi, consentStoresId :PlayApi, consentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/datasets/${datasetsId}/consentStores/${consentStoresId}/consents/${consentsId}").addQueryStringParameters("name" -> name.toString))
						...
						class listRevisions(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListConsentRevisionsResponse]) {
							...
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListConsentRevisionsResponse])
						}
					...
					object attributeDefinitions {
						class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withAttributeDefinition(body: Schema.AttributeDefinition) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.AttributeDefinition])
						}
						object create {
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AttributeDefinition]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AttributeDefinition])
						}
						object get {
							def apply(projectsId :PlayApi, locationsId :PlayApi, datasetsId :PlayApi, consentStoresId :PlayApi, attributeDefinitionsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/datasets/${datasetsId}/consentStores/${consentStoresId}/attributeDefinitions/${attributeDefinitionsId}").addQueryStringParameters("name" -> name.toString))
						...
						class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withAttributeDefinition(body: Schema.AttributeDefinition) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.AttributeDefinition])
						}
						object patch {
						...
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListAttributeDefinitionsResponse]) {
							...
							def withFilter(filter: String) = new list(req.addQueryStringParameters("filter" -> filter.toString))
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListAttributeDefinitionsResponse])
						}
						object list {
					...
					object userDataMappings {
						class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withUserDataMapping(body: Schema.UserDataMapping) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.UserDataMapping])
						}
						object create {
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.UserDataMapping]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.UserDataMapping])
						}
						object get {
							def apply(projectsId :PlayApi, locationsId :PlayApi, datasetsId :PlayApi, consentStoresId :PlayApi, userDataMappingsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/datasets/${datasetsId}/consentStores/${consentStoresId}/userDataMappings/${userDataMappingsId}").addQueryStringParameters("name" -> name.toString))
						...
						class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withUserDataMapping(body: Schema.UserDataMapping) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.UserDataMapping])
						}
						object patch {
						...
						class archive(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withArchiveUserDataMappingRequest(body: Schema.ArchiveUserDataMappingRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.ArchiveUserDataMappingResponse])
						}
						object archive {
						...
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListUserDataMappingsResponse]) {
							...
							def withFilter(filter: String) = new list(req.addQueryStringParameters("filter" -> filter.toString))
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListUserDataMappingsResponse])
						}
						object list {
							def apply(projectsId :PlayApi, locationsId :PlayApi, datasetsId :PlayApi, consentStoresId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/datasets/${datasetsId}/consentStores/${consentStoresId}/userDataMappings").addQueryStringParameters("parent" -> parent.toString))
					...
					object consentArtifacts {
						class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withConsentArtifact(body: Schema.ConsentArtifact) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.ConsentArtifact])
						}
						object create {
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ConsentArtifact]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ConsentArtifact])
						}
						object get {
						...
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListConsentArtifactsResponse]) {
							...
							def withFilter(filter: String) = new list(req.addQueryStringParameters("filter" -> filter.toString))
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListConsentArtifactsResponse])
						}
						object list {
							def apply(projectsId :PlayApi, locationsId :PlayApi, datasetsId :PlayApi, consentStoresId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/datasets/${datasetsId}/consentStores/${consentStoresId}/consentArtifacts").addQueryStringParameters("parent" -> parent.toString))
				...
				object fhirStores {
					...
					class deidentify(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withDeidentifyFhirStoreRequest(body: Schema.DeidentifyFhirStoreRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					object deidentify {
					...
					class `export`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withExportResourcesRequest(body: Schema.ExportResourcesRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					object `export` {
					...
					class rollback(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withRollbackFhirResourcesRequest(body: Schema.RollbackFhirResourcesRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					object rollback {
					...
					class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withImportResourcesRequest(body: Schema.ImportResourcesRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					object `import` {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.FhirStore]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.FhirStore])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, datasetsId :PlayApi, fhirStoresId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/datasets/${datasetsId}/fhirStores/${fhirStoresId}").addQueryStringParameters("name" -> name.toString))
					...
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withFhirStore(body: Schema.FhirStore) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.FhirStore])
					}
					object patch {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListFhirStoresResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListFhirStoresResponse])
					}
					object list {
					...
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withFhirStore(body: Schema.FhirStore) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.FhirStore])
					}
					object create {
					...
					class getFHIRStoreMetrics(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.FhirStoreMetrics]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.FhirStoreMetrics])
					}
					...
					object fhir {
						...
						class conditionalUpdate(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withHttpBody(body: Schema.HttpBody) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.HttpBody])
						}
						...
						class Resource_validate(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withHttpBody(body: Schema.HttpBody) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.HttpBody])
						}
						...
						class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.HttpBody]) {
							def apply() = auth.exec(req,_.execute("DELETE")).map(_.json.as[Schema.HttpBody])
						}
						object delete {
						...
						class conditionalPatch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withHttpBody(body: Schema.HttpBody) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.HttpBody])
						}
						...
						class search(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withSearchResourcesRequest(body: Schema.SearchResourcesRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.HttpBody])
						}
						object search {
				...
				object hl7V2Stores {
					class `export`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withExportMessagesRequest(body: Schema.ExportMessagesRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					object `export` {
					...
					class rollback(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withRollbackHl7V2MessagesRequest(body: Schema.RollbackHl7V2MessagesRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					object rollback {
						def apply(projectsId :PlayApi, locationsId :PlayApi, datasetsId :PlayApi, hl7V2StoresId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): rollback = new rollback(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/datasets/${datasetsId}/hl7V2Stores/${hl7V2StoresId}:rollback").addQueryStringParameters("name" -> name.toString))
					}
					class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withImportMessagesRequest(body: Schema.ImportMessagesRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					object `import` {
					...
					class getHL7v2StoreMetrics(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Hl7V2StoreMetrics]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.Hl7V2StoreMetrics])
					}
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Hl7V2Store]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.Hl7V2Store])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, datasetsId :PlayApi, hl7V2StoresId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/datasets/${datasetsId}/hl7V2Stores/${hl7V2StoresId}").addQueryStringParameters("name" -> name.toString))
					...
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withHl7V2Store(body: Schema.Hl7V2Store) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.Hl7V2Store])
					}
					object patch {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListHl7V2StoresResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListHl7V2StoresResponse])
					}
					object list {
					...
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withHl7V2Store(body: Schema.Hl7V2Store) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Hl7V2Store])
					}
					object create {
					...
					object messages {
						class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withCreateMessageRequest(body: Schema.CreateMessageRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Message])
						}
						object create {
						...
						class ingest(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withIngestMessageRequest(body: Schema.IngestMessageRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.IngestMessageResponse])
						}
						object ingest {
				...
				object dicomStores {
					...
					class deidentify(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withDeidentifyDicomStoreRequest(body: Schema.DeidentifyDicomStoreRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					object deidentify {
					...
					class `export`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withExportDicomDataRequest(body: Schema.ExportDicomDataRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					object `export` {
					...
					class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withImportDicomDataRequest(body: Schema.ImportDicomDataRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					object `import` {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.DicomStore]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.DicomStore])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, datasetsId :PlayApi, dicomStoresId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/datasets/${datasetsId}/dicomStores/${dicomStoresId}").addQueryStringParameters("name" -> name.toString))
					...
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withDicomStore(body: Schema.DicomStore) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.DicomStore])
					}
					object patch {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListDicomStoresResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListDicomStoresResponse])
					}
					object list {
					...
					class setBlobStorageSettings(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withSetBlobStorageSettingsRequest(body: Schema.SetBlobStorageSettingsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
					}
					...
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withDicomStore(body: Schema.DicomStore) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.DicomStore])
					}
					object create {
					...
					class getDICOMStoreMetrics(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.DicomStoreMetrics]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.DicomStoreMetrics])
					}
					...
					object dicomWeb {
						object studies {
							...
							class getStudyMetrics(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.StudyMetrics]) {
								def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.StudyMetrics])
							}
							...
							object series {
								class getSeriesMetrics(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SeriesMetrics]) {
									def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SeriesMetrics])
								}
								...
								object instances {
									class getStorageInfo(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.StorageInfo]) {
										def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.StorageInfo])
									}
			...
			object services {
				object nlp {
					...
					object analyzeEntities {
						def apply(projectsId :PlayApi, locationsId :PlayApi, nlpService: String)(using auth: AuthToken, ec: ExecutionContext): analyzeEntities = new analyzeEntities(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/services/nlp:analyzeEntities").addQueryStringParameters("nlpService" -> nlpService.toString))
					}
				}
			}
		}
