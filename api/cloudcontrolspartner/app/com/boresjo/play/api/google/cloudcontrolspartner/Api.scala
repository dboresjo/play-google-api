...
class Api @Inject() (ws: WSClient) extends PlayApi {
	...
	object organizations {
		object locations {
			...
			object getPartner {
				def apply(organizationsId :PlayApi, locationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): getPartner = new getPartner(auth(ws.url(BASE_URL + s"v1/organizations/${organizationsId}/locations/${locationsId}/partner")).addQueryStringParameters("name" -> name.toString))
			...
			object customers {
				...
				object create {
					def apply(organizationsId :PlayApi, locationsId :PlayApi, parent: String, customerId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v1/organizations/${organizationsId}/locations/${locationsId}/customers")).addQueryStringParameters("parent" -> parent.toString, "customerId" -> customerId.toString))
				}
				class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Empty]) {
					def apply() = req.execute("DELETE").map(_.json.as[Schema.Empty])
				}
				object delete {
					def apply(organizationsId :PlayApi, locationsId :PlayApi, customersId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v1/organizations/${organizationsId}/locations/${locationsId}/customers/${customersId}")).addQueryStringParameters("name" -> name.toString))
				...
				object get {
					def apply(organizationsId :PlayApi, locationsId :PlayApi, customersId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/organizations/${organizationsId}/locations/${locationsId}/customers/${customersId}")).addQueryStringParameters("name" -> name.toString))
				...
				object patch {
					def apply(organizationsId :PlayApi, locationsId :PlayApi, customersId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1/organizations/${organizationsId}/locations/${locationsId}/customers/${customersId}")).addQueryStringParameters("name" -> name.toString))
				}
				...
				object workloads {
					class getPartnerPermissions(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.PartnerPermissions]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.PartnerPermissions])
					}
					object getPartnerPermissions {
						def apply(organizationsId :PlayApi, locationsId :PlayApi, customersId :PlayApi, workloadsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): getPartnerPermissions = new getPartnerPermissions(auth(ws.url(BASE_URL + s"v1/organizations/${organizationsId}/locations/${locationsId}/customers/${customersId}/workloads/${workloadsId}/partnerPermissions")).addQueryStringParameters("name" -> name.toString))
					...
					class getEkmConnections(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.EkmConnections]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.EkmConnections])
					}
					object getEkmConnections {
						def apply(organizationsId :PlayApi, locationsId :PlayApi, customersId :PlayApi, workloadsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): getEkmConnections = new getEkmConnections(auth(ws.url(BASE_URL + s"v1/organizations/${organizationsId}/locations/${locationsId}/customers/${customersId}/workloads/${workloadsId}/ekmConnections")).addQueryStringParameters("name" -> name.toString))
					...
					object get {
						def apply(organizationsId :PlayApi, locationsId :PlayApi, customersId :PlayApi, workloadsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/organizations/${organizationsId}/locations/${locationsId}/customers/${customersId}/workloads/${workloadsId}")).addQueryStringParameters("name" -> name.toString))
					...
					object list {
						def apply(organizationsId :PlayApi, locationsId :PlayApi, customersId :PlayApi, parent: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/organizations/${organizationsId}/locations/${locationsId}/customers/${customersId}/workloads")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
					...
					object accessApprovalRequests {
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListAccessApprovalRequestsResponse]) {
							...
							/** Optional. Hint for how to order the results. */
							def withOrderBy(orderBy: String) = new list(req.addQueryStringParameters("orderBy" -> orderBy.toString))
							def apply() = req.execute("GET").map(_.json.as[Schema.ListAccessApprovalRequestsResponse])
						}
						object list {
							def apply(organizationsId :PlayApi, locationsId :PlayApi, customersId :PlayApi, workloadsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/organizations/${organizationsId}/locations/${locationsId}/customers/${customersId}/workloads/${workloadsId}/accessApprovalRequests")).addQueryStringParameters("parent" -> parent.toString))
					...
					object violations {
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListViolationsResponse]) {
							...
							def apply() = req.execute("GET").map(_.json.as[Schema.ListViolationsResponse])
						}
						object list {
							def apply(organizationsId :PlayApi, locationsId :PlayApi, customersId :PlayApi, workloadsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/organizations/${organizationsId}/locations/${locationsId}/customers/${customersId}/workloads/${workloadsId}/violations")).addQueryStringParameters("parent" -> parent.toString))
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Violation]) {
							def apply() = req.execute("GET").map(_.json.as[Schema.Violation])
						}
						object get {
							def apply(organizationsId :PlayApi, locationsId :PlayApi, customersId :PlayApi, workloadsId :PlayApi, violationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/organizations/${organizationsId}/locations/${locationsId}/customers/${customersId}/workloads/${workloadsId}/violations/${violationsId}")).addQueryStringParameters("name" -> name.toString))
