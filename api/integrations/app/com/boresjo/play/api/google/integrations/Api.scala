...
class Api @Inject() (ws: WSClient) extends PlayApi {
	...
	object connectorPlatformRegions {
		class enumerate(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaEnumerateConnectorPlatformRegionsResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaEnumerateConnectorPlatformRegionsResponse])
		}
		object enumerate {
			def apply()(using auth: AuthToken, ec: ExecutionContext): enumerate = new enumerate(ws.url(BASE_URL + s"v1/connectorPlatformRegions:enumerate").addQueryStringParameters())
	...
	object callback {
		class generateToken(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaGenerateTokenResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaGenerateTokenResponse])
		}
	...
	object projects {
		class getClientmetadata(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaGetClientMetadataResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaGetClientMetadataResponse])
		}
		object getClientmetadata {
			def apply(projectsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): getClientmetadata = new getClientmetadata(ws.url(BASE_URL + s"v1/projects/${projectsId}/clientmetadata").addQueryStringParameters("parent" -> parent.toString))
		...
		object locations {
			class getClients(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaGetClientResponse]) {
				def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaGetClientResponse])
			}
			object getClients {
				def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): getClients = new getClients(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/clients").addQueryStringParameters("parent" -> parent.toString))
			...
			object clients {
				class switch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudIntegrationsV1alphaSwitchEncryptionRequest(body: Schema.GoogleCloudIntegrationsV1alphaSwitchEncryptionRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleProtobufEmpty])
				}
				object switch {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): switch = new switch(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/clients:switch").addQueryStringParameters("parent" -> parent.toString))
				}
				class replace(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudIntegrationsV1alphaReplaceServiceAccountRequest(body: Schema.GoogleCloudIntegrationsV1alphaReplaceServiceAccountRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleProtobufEmpty])
				}
				object replace {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): replace = new replace(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/clients:replace").addQueryStringParameters("parent" -> parent.toString))
				}
				class deprovision(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudIntegrationsV1alphaDeprovisionClientRequest(body: Schema.GoogleCloudIntegrationsV1alphaDeprovisionClientRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleProtobufEmpty])
				}
				object deprovision {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): deprovision = new deprovision(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/clients:deprovision").addQueryStringParameters("parent" -> parent.toString))
				}
				class switchVariableMasking(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudIntegrationsV1alphaSwitchVariableMaskingRequest(body: Schema.GoogleCloudIntegrationsV1alphaSwitchVariableMaskingRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleProtobufEmpty])
				}
				object switchVariableMasking {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): switchVariableMasking = new switchVariableMasking(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/clients:switchVariableMasking").addQueryStringParameters("parent" -> parent.toString))
				}
				class provision(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudIntegrationsV1alphaProvisionClientRequest(body: Schema.GoogleCloudIntegrationsV1alphaProvisionClientRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleProtobufEmpty])
				}
				object provision {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): provision = new provision(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/clients:provision").addQueryStringParameters("parent" -> parent.toString))
				}
			}
			object products {
				object integrations {
					class execute(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudIntegrationsV1alphaExecuteIntegrationsRequest(body: Schema.GoogleCloudIntegrationsV1alphaExecuteIntegrationsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaExecuteIntegrationsResponse])
					}
					object execute {
					...
					class schedule(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudIntegrationsV1alphaScheduleIntegrationsRequest(body: Schema.GoogleCloudIntegrationsV1alphaScheduleIntegrationsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaScheduleIntegrationsResponse])
					}
					object schedule {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaListIntegrationsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaListIntegrationsResponse])
					}
					object list {
					...
					class test(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudIntegrationsV1alphaTestIntegrationsRequest(body: Schema.GoogleCloudIntegrationsV1alphaTestIntegrationsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaTestIntegrationsResponse])
					}
					object test {
					...
					object versions {
						class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							...
							def withGoogleCloudIntegrationsV1alphaIntegrationVersion(body: Schema.GoogleCloudIntegrationsV1alphaIntegrationVersion) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaIntegrationVersion])
						}
						object create {
						...
						class unpublish(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudIntegrationsV1alphaUnpublishIntegrationVersionRequest(body: Schema.GoogleCloudIntegrationsV1alphaUnpublishIntegrationVersionRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleProtobufEmpty])
						}
						object unpublish {
						...
						class publish(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudIntegrationsV1alphaPublishIntegrationVersionRequest(body: Schema.GoogleCloudIntegrationsV1alphaPublishIntegrationVersionRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaPublishIntegrationVersionResponse])
						}
						object publish {
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaIntegrationVersion]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaIntegrationVersion])
						}
						object get {
						...
						class download(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaDownloadIntegrationVersionResponse]) {
							...
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaDownloadIntegrationVersionResponse])
						}
						object download {
						...
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaListIntegrationVersionsResponse]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaListIntegrationVersionsResponse])
						}
						object list {
						...
						class upload(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudIntegrationsV1alphaUploadIntegrationVersionRequest(body: Schema.GoogleCloudIntegrationsV1alphaUploadIntegrationVersionRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaUploadIntegrationVersionResponse])
						}
						object upload {
						...
						class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudIntegrationsV1alphaIntegrationVersion(body: Schema.GoogleCloudIntegrationsV1alphaIntegrationVersion) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaIntegrationVersion])
						}
						object patch {
						...
						class takeoverEditLock(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudIntegrationsV1alphaTakeoverEditLockRequest(body: Schema.GoogleCloudIntegrationsV1alphaTakeoverEditLockRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaTakeoverEditLockResponse])
						}
					...
					object executions {
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaListExecutionsResponse]) {
							...
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaListExecutionsResponse])
						}
						object list {
						...
						class download(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaDownloadExecutionResponse]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaDownloadExecutionResponse])
						}
						object download {
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaExecution]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaExecution])
						}
						object get {
						...
						object suspensions {
							class lift(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
								def withGoogleCloudIntegrationsV1alphaLiftSuspensionRequest(body: Schema.GoogleCloudIntegrationsV1alphaLiftSuspensionRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaLiftSuspensionResponse])
							}
							object lift {
							...
							class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaListSuspensionsResponse]) {
								def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaListSuspensionsResponse])
							}
							object list {
							...
							class resolve(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
								def withGoogleCloudIntegrationsV1alphaResolveSuspensionRequest(body: Schema.GoogleCloudIntegrationsV1alphaResolveSuspensionRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaResolveSuspensionResponse])
							}
							object resolve {
				...
				object cloudFunctions {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudIntegrationsV1alphaCreateCloudFunctionRequest(body: Schema.GoogleCloudIntegrationsV1alphaCreateCloudFunctionRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaCreateCloudFunctionResponse])
					}
					object create {
						def apply(projectsId :PlayApi, locationsId :PlayApi, productsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/products/${productsId}/cloudFunctions").addQueryStringParameters("parent" -> parent.toString))
					}
				}
				object certificates {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudIntegrationsV1alphaCertificate(body: Schema.GoogleCloudIntegrationsV1alphaCertificate) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaCertificate])
					}
					object create {
						def apply(projectsId :PlayApi, locationsId :PlayApi, productsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/products/${productsId}/certificates").addQueryStringParameters("parent" -> parent.toString))
					}
					class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
						def apply() = auth.exec(req,_.execute("DELETE")).map(_.json.as[Schema.GoogleProtobufEmpty])
					}
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaCertificate]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaCertificate])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, productsId :PlayApi, certificatesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/products/${productsId}/certificates/${certificatesId}").addQueryStringParameters("name" -> name.toString))
					...
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudIntegrationsV1alphaCertificate(body: Schema.GoogleCloudIntegrationsV1alphaCertificate) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaCertificate])
					}
					object patch {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaListCertificatesResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaListCertificatesResponse])
					}
					object list {
				...
				object sfdcInstances {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudIntegrationsV1alphaSfdcInstance(body: Schema.GoogleCloudIntegrationsV1alphaSfdcInstance) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaSfdcInstance])
					}
					object create {
						def apply(projectsId :PlayApi, locationsId :PlayApi, productsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/products/${productsId}/sfdcInstances").addQueryStringParameters("parent" -> parent.toString))
					}
					class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
						def apply() = auth.exec(req,_.execute("DELETE")).map(_.json.as[Schema.GoogleProtobufEmpty])
					}
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaSfdcInstance]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaSfdcInstance])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, productsId :PlayApi, sfdcInstancesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/products/${productsId}/sfdcInstances/${sfdcInstancesId}").addQueryStringParameters("name" -> name.toString))
					...
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudIntegrationsV1alphaSfdcInstance(body: Schema.GoogleCloudIntegrationsV1alphaSfdcInstance) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaSfdcInstance])
					}
					object patch {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaListSfdcInstancesResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaListSfdcInstancesResponse])
					}
					object list {
					...
					object sfdcChannels {
						class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudIntegrationsV1alphaSfdcChannel(body: Schema.GoogleCloudIntegrationsV1alphaSfdcChannel) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaSfdcChannel])
						}
						object create {
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaSfdcChannel]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaSfdcChannel])
						}
						object get {
							def apply(projectsId :PlayApi, locationsId :PlayApi, productsId :PlayApi, sfdcInstancesId :PlayApi, sfdcChannelsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/products/${productsId}/sfdcInstances/${sfdcInstancesId}/sfdcChannels/${sfdcChannelsId}").addQueryStringParameters("name" -> name.toString))
						...
						class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudIntegrationsV1alphaSfdcChannel(body: Schema.GoogleCloudIntegrationsV1alphaSfdcChannel) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaSfdcChannel])
						}
						object patch {
						...
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaListSfdcChannelsResponse]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaListSfdcChannelsResponse])
						}
						object list {
				...
				object authConfigs {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudIntegrationsV1alphaAuthConfig(body: Schema.GoogleCloudIntegrationsV1alphaAuthConfig) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaAuthConfig])
					}
					object create {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaAuthConfig]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaAuthConfig])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, productsId :PlayApi, authConfigsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/products/${productsId}/authConfigs/${authConfigsId}").addQueryStringParameters("name" -> name.toString))
					...
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudIntegrationsV1alphaAuthConfig(body: Schema.GoogleCloudIntegrationsV1alphaAuthConfig) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaAuthConfig])
					}
					object patch {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaListAuthConfigsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaListAuthConfigsResponse])
					}
					object list {
			...
			object integrations {
				...
				object execute {
					def apply(projectsId :PlayApi, locationsId :PlayApi, integrationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): execute = new execute(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/integrations/${integrationsId}:execute").addQueryStringParameters("name" -> name.toString))
				}
				class executeEvent(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaExecuteEventResponse]) {
					def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaExecuteEventResponse])
				}
				object executeEvent {
				...
				object test {
					def apply(projectsId :PlayApi, locationsId :PlayApi, integrationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): test = new test(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/integrations/${integrationsId}:test").addQueryStringParameters("name" -> name.toString))
				}
				class schedule(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudIntegrationsV1alphaScheduleIntegrationsRequest(body: Schema.GoogleCloudIntegrationsV1alphaScheduleIntegrationsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaScheduleIntegrationsResponse])
				}
				object schedule {
					def apply(projectsId :PlayApi, locationsId :PlayApi, integrationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): schedule = new schedule(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/integrations/${integrationsId}:schedule").addQueryStringParameters("name" -> name.toString))
				}
				class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
					def apply() = auth.exec(req,_.execute("DELETE")).map(_.json.as[Schema.GoogleProtobufEmpty])
				}
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, integrationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/integrations/${integrationsId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.GoogleProtobufEmpty]] = (fun: delete) => fun.apply()
				}
				object versions {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					class downloadJsonPackage(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaDownloadJsonPackageResponse]) {
						...
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaDownloadJsonPackageResponse])
					}
					...
					object upload {
						def apply(projectsId :PlayApi, locationsId :PlayApi, integrationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): upload = new upload(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/integrations/${integrationsId}/versions:upload").addQueryStringParameters("parent" -> parent.toString))
					}
					class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
						def apply() = auth.exec(req,_.execute("DELETE")).map(_.json.as[Schema.GoogleProtobufEmpty])
					}
					...
					object testCases {
						class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudIntegrationsV1alphaTestCase(body: Schema.GoogleCloudIntegrationsV1alphaTestCase) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaTestCase])
						}
						object create {
						...
						class executeTest(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudIntegrationsV1alphaExecuteTestCaseRequest(body: Schema.GoogleCloudIntegrationsV1alphaExecuteTestCaseRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaExecuteTestCaseResponse])
						}
						object executeTest {
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaTestCase]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaTestCase])
						}
						object get {
						...
						class download(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaDownloadTestCaseResponse]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaDownloadTestCaseResponse])
						}
						object download {
						...
						class listExecutions(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaListTestCaseExecutionsResponse]) {
							...
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaListTestCaseExecutionsResponse])
						}
						...
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaListTestCasesResponse]) {
							...
							def withReadMask(readMask: String) = new list(req.addQueryStringParameters("readMask" -> readMask.toString))
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaListTestCasesResponse])
						}
						object list {
						...
						class upload(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudIntegrationsV1alphaUploadTestCaseRequest(body: Schema.GoogleCloudIntegrationsV1alphaUploadTestCaseRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaUploadTestCaseResponse])
						}
						object upload {
						...
						class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							...
							def withGoogleCloudIntegrationsV1alphaTestCase(body: Schema.GoogleCloudIntegrationsV1alphaTestCase) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaTestCase])
						}
						object patch {
						...
						class takeoverEditLock(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudIntegrationsV1alphaTakeoverTestCaseEditLockRequest(body: Schema.GoogleCloudIntegrationsV1alphaTakeoverTestCaseEditLockRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaTestCase])
						}
						object takeoverEditLock {
				...
				object executions {
					class cancel(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudIntegrationsV1alphaCancelExecutionRequest(body: Schema.GoogleCloudIntegrationsV1alphaCancelExecutionRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaCancelExecutionResponse])
					}
					object cancel {
					...
					class replay(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudIntegrationsV1alphaReplayExecutionRequest(body: Schema.GoogleCloudIntegrationsV1alphaReplayExecutionRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaReplayExecutionResponse])
					}
					object replay {
			...
			object cloudFunctions {
				...
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/cloudFunctions").addQueryStringParameters("parent" -> parent.toString))
				}
			}
			object certificates {
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				...
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/certificates").addQueryStringParameters("parent" -> parent.toString))
				}
				class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
					def apply() = auth.exec(req,_.execute("DELETE")).map(_.json.as[Schema.GoogleProtobufEmpty])
				}
			...
			object sfdcInstances {
				...
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/sfdcInstances").addQueryStringParameters("parent" -> parent.toString))
				}
				class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
					def apply() = auth.exec(req,_.execute("DELETE")).map(_.json.as[Schema.GoogleProtobufEmpty])
				}
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, sfdcInstancesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/sfdcInstances/${sfdcInstancesId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.GoogleProtobufEmpty]] = (fun: delete) => fun.apply()
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaSfdcInstance]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaSfdcInstance])
				...
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, sfdcInstancesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/sfdcInstances/${sfdcInstancesId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[get, Future[Schema.GoogleCloudIntegrationsV1alphaSfdcInstance]] = (fun: get) => fun.apply()
				}
				class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudIntegrationsV1alphaSfdcInstance(body: Schema.GoogleCloudIntegrationsV1alphaSfdcInstance) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaSfdcInstance])
				...
				object sfdcChannels {
					...
					object create {
						def apply(projectsId :PlayApi, locationsId :PlayApi, sfdcInstancesId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/sfdcInstances/${sfdcInstancesId}/sfdcChannels").addQueryStringParameters("parent" -> parent.toString))
					}
					class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
						def apply() = auth.exec(req,_.execute("DELETE")).map(_.json.as[Schema.GoogleProtobufEmpty])
					}
			...
			object authConfigs {
				...
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, authConfigsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/authConfigs/${authConfigsId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.GoogleProtobufEmpty]] = (fun: delete) => fun.apply()
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaAuthConfig]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaAuthConfig])
				...
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, authConfigsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/authConfigs/${authConfigsId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[get, Future[Schema.GoogleCloudIntegrationsV1alphaAuthConfig]] = (fun: get) => fun.apply()
				}
				class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudIntegrationsV1alphaAuthConfig(body: Schema.GoogleCloudIntegrationsV1alphaAuthConfig) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaAuthConfig])
			...
			object templates {
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudIntegrationsV1alphaTemplate(body: Schema.GoogleCloudIntegrationsV1alphaTemplate) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaTemplate])
				}
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/templates").addQueryStringParameters("parent" -> parent.toString))
				}
				class unshare(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudIntegrationsV1alphaUnshareTemplateRequest(body: Schema.GoogleCloudIntegrationsV1alphaUnshareTemplateRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleProtobufEmpty])
				}
				object unshare {
					def apply(projectsId :PlayApi, locationsId :PlayApi, templatesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): unshare = new unshare(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/templates/${templatesId}:unshare").addQueryStringParameters("name" -> name.toString))
				}
				class share(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudIntegrationsV1alphaShareTemplateRequest(body: Schema.GoogleCloudIntegrationsV1alphaShareTemplateRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleProtobufEmpty])
				}
				object share {
					def apply(projectsId :PlayApi, locationsId :PlayApi, templatesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): share = new share(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/templates/${templatesId}:share").addQueryStringParameters("name" -> name.toString))
				}
				class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudIntegrationsV1alphaImportTemplateRequest(body: Schema.GoogleCloudIntegrationsV1alphaImportTemplateRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaImportTemplateResponse])
				}
				object `import` {
					def apply(projectsId :PlayApi, locationsId :PlayApi, templatesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): `import` = new `import`(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/templates/${templatesId}:import").addQueryStringParameters("name" -> name.toString))
				}
				class use(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudIntegrationsV1alphaUseTemplateRequest(body: Schema.GoogleCloudIntegrationsV1alphaUseTemplateRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaUseTemplateResponse])
				}
				object use {
					def apply(projectsId :PlayApi, locationsId :PlayApi, templatesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): use = new use(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/templates/${templatesId}:use").addQueryStringParameters("name" -> name.toString))
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaTemplate]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaTemplate])
				}
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, templatesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/templates/${templatesId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[get, Future[Schema.GoogleCloudIntegrationsV1alphaTemplate]] = (fun: get) => fun.apply()
				}
				class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudIntegrationsV1alphaTemplate(body: Schema.GoogleCloudIntegrationsV1alphaTemplate) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaTemplate])
				}
				object patch {
				...
				class download(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaDownloadTemplateResponse]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaDownloadTemplateResponse])
				}
				object download {
				...
				class upload(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudIntegrationsV1alphaUploadTemplateRequest(body: Schema.GoogleCloudIntegrationsV1alphaUploadTemplateRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaUploadTemplateResponse])
				}
				object upload {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): upload = new upload(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/templates:upload").addQueryStringParameters("parent" -> parent.toString))
				}
				class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
					def apply() = auth.exec(req,_.execute("DELETE")).map(_.json.as[Schema.GoogleProtobufEmpty])
				}
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, templatesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/templates/${templatesId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.GoogleProtobufEmpty]] = (fun: delete) => fun.apply()
				}
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaListTemplatesResponse]) {
					...
					def withFilter(filter: String) = new list(req.addQueryStringParameters("filter" -> filter.toString))
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaListTemplatesResponse])
				}
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/templates").addQueryStringParameters("parent" -> parent.toString))
				...
				class search(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaSearchTemplatesResponse]) {
					...
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaSearchTemplatesResponse])
				}
				object search {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): search = new search(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/templates:search").addQueryStringParameters("parent" -> parent.toString))
			...
			object connections {
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaListConnectionsResponse]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaListConnectionsResponse])
				}
				object list {
				...
				class getConnectionSchemaMetadata(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaConnectionSchemaMetadata]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaConnectionSchemaMetadata])
				}
				...
				object runtimeEntitySchemas {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaListRuntimeEntitySchemasResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaListRuntimeEntitySchemasResponse])
					}
					object list {
				...
				object runtimeActionSchemas {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudIntegrationsV1alphaListRuntimeActionSchemasResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaListRuntimeActionSchemasResponse])
					}
					object list {
			...
			object appsScriptProjects {
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudIntegrationsV1alphaCreateAppsScriptProjectRequest(body: Schema.GoogleCloudIntegrationsV1alphaCreateAppsScriptProjectRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaCreateAppsScriptProjectResponse])
				}
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/appsScriptProjects").addQueryStringParameters("parent" -> parent.toString))
				}
				class link(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudIntegrationsV1alphaLinkAppsScriptProjectRequest(body: Schema.GoogleCloudIntegrationsV1alphaLinkAppsScriptProjectRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudIntegrationsV1alphaLinkAppsScriptProjectResponse])
				}
				object link {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): link = new link(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/appsScriptProjects:link").addQueryStringParameters("parent" -> parent.toString))
				}
			}
		}
	}
