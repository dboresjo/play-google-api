...
class Api @Inject() (ws: WSClient) extends PlayApi {
	...
	object datasets {
		class undelete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withUndeleteDatasetRequest(body: Schema.UndeleteDatasetRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Dataset])
		}
		object undelete {
			def apply(projectsId :PlayApi, datasetsId :PlayApi, datasetId: String, projectId: String)(using auth: AuthToken, ec: ExecutionContext): undelete = new undelete(auth(ws.url(BASE_URL + s"projects/${projectsId}/datasets/${datasetsId}:undelete")).addQueryStringParameters("datasetId" -> datasetId.toString, "projectId" -> projectId.toString))
		}
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			...
			def withDataset(body: Schema.Dataset) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Dataset])
		}
		object insert {
			def apply(projectsId :PlayApi, projectId: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(auth(ws.url(BASE_URL + s"projects/${projectsId}/datasets")).addQueryStringParameters("projectId" -> projectId.toString))
		}
		...
		object get {
			def apply(projectsId :PlayApi, datasetsId :PlayApi, datasetId: String, projectId: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"projects/${projectsId}/datasets/${datasetsId}")).addQueryStringParameters("datasetId" -> datasetId.toString, "projectId" -> projectId.toString))
		...
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			...
			def withDataset(body: Schema.Dataset) = req.withBody(Json.toJson(body)).execute("PUT").map(_.json.as[Schema.Dataset])
		}
		object update {
			def apply(projectsId :PlayApi, datasetsId :PlayApi, datasetId: String, projectId: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(auth(ws.url(BASE_URL + s"projects/${projectsId}/datasets/${datasetsId}")).addQueryStringParameters("datasetId" -> datasetId.toString, "projectId" -> projectId.toString))
		}
		...
		object patch {
			def apply(projectsId :PlayApi, datasetsId :PlayApi, datasetId: String, projectId: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"projects/${projectsId}/datasets/${datasetsId}")).addQueryStringParameters("datasetId" -> datasetId.toString, "projectId" -> projectId.toString))
		}
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.DatasetList]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.DatasetList])
		}
		object list {
			def apply(projectsId :PlayApi, all: Boolean, filter: String, maxResults: Int, pageToken: String, projectId: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"projects/${projectsId}/datasets")).addQueryStringParameters("all" -> all.toString, "filter" -> filter.toString, "maxResults" -> maxResults.toString, "pageToken" -> pageToken.toString, "projectId" -> projectId.toString))
	...
	object jobs {
		class cancel(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.JobCancelResponse]) {
			def apply() = req.execute("POST").map(_.json.as[Schema.JobCancelResponse])
		}
		object cancel {
			def apply(projectsId :PlayApi, jobsId :PlayApi, jobId: String, location: String, projectId: String)(using auth: AuthToken, ec: ExecutionContext): cancel = new cancel(auth(ws.url(BASE_URL + s"projects/${projectsId}/jobs/${jobsId}/cancel")).addQueryStringParameters("jobId" -> jobId.toString, "location" -> location.toString, "projectId" -> projectId.toString))
		...
		object insert {
			def apply(projectsId :PlayApi, projectId: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(auth(ws.url(BASE_URL + s"projects/${projectsId}/jobs")).addQueryStringParameters("projectId" -> projectId.toString))
		}
		...
		object query {
			def apply(projectsId :PlayApi, projectId: String)(using auth: AuthToken, ec: ExecutionContext): query = new query(auth(ws.url(BASE_URL + s"projects/${projectsId}/queries")).addQueryStringParameters("projectId" -> projectId.toString))
		}
		class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Unit]) {
			def apply() = req.execute("DELETE").map(_ => ())
		}
		object delete {
			def apply(projectsId :PlayApi, jobsId :PlayApi, jobId: String, location: String, projectId: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"projects/${projectsId}/jobs/${jobsId}/delete")).addQueryStringParameters("jobId" -> jobId.toString, "location" -> location.toString, "projectId" -> projectId.toString))
			given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
		}
		...
		object get {
			def apply(projectsId :PlayApi, jobsId :PlayApi, jobId: String, location: String, projectId: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"projects/${projectsId}/jobs/${jobsId}")).addQueryStringParameters("jobId" -> jobId.toString, "location" -> location.toString, "projectId" -> projectId.toString))
	...
	object models {
		...
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Model]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.Model])
		}
		object get {
			def apply(projectsId :PlayApi, datasetsId :PlayApi, modelsId :PlayApi, datasetId: String, modelId: String, projectId: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"projects/${projectsId}/datasets/${datasetsId}/models/${modelsId}")).addQueryStringParameters("datasetId" -> datasetId.toString, "modelId" -> modelId.toString, "projectId" -> projectId.toString))
	...
	object projects {
		class getServiceAccount(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GetServiceAccountResponse]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.GetServiceAccountResponse])
		}
		object getServiceAccount {
			def apply(projectsId :PlayApi, projectId: String)(using auth: AuthToken, ec: ExecutionContext): getServiceAccount = new getServiceAccount(auth(ws.url(BASE_URL + s"projects/${projectsId}/serviceAccount")).addQueryStringParameters("projectId" -> projectId.toString))
		...
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ProjectList]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.ProjectList])
		}
		object list {
			def apply(maxResults: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"projects")).addQueryStringParameters("maxResults" -> maxResults.toString, "pageToken" -> pageToken.toString))
			given Conversion[list, Future[Schema.ProjectList]] = (fun: list) => fun.apply()
		}
	}
	object routines {
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withRoutine(body: Schema.Routine) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Routine])
		}
		object insert {
			def apply(projectsId :PlayApi, datasetsId :PlayApi, datasetId: String, projectId: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(auth(ws.url(BASE_URL + s"projects/${projectsId}/datasets/${datasetsId}/routines")).addQueryStringParameters("datasetId" -> datasetId.toString, "projectId" -> projectId.toString))
		}
		...
		object setIamPolicy {
			def apply(projectsId :PlayApi, datasetsId :PlayApi, routinesId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): setIamPolicy = new setIamPolicy(auth(ws.url(BASE_URL + s"projects/${projectsId}/datasets/${datasetsId}/routines/${routinesId}:setIamPolicy")).addQueryStringParameters("resource" -> resource.toString))
		}
		...
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Routine]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.Routine])
		}
		object get {
		...
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withRoutine(body: Schema.Routine) = req.withBody(Json.toJson(body)).execute("PUT").map(_.json.as[Schema.Routine])
		}
		object update {
			def apply(projectsId :PlayApi, datasetsId :PlayApi, routinesId :PlayApi, datasetId: String, projectId: String, routineId: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(auth(ws.url(BASE_URL + s"projects/${projectsId}/datasets/${datasetsId}/routines/${routinesId}")).addQueryStringParameters("datasetId" -> datasetId.toString, "projectId" -> projectId.toString, "routineId" -> routineId.toString))
		}
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListRoutinesResponse]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.ListRoutinesResponse])
		}
		object list {
	...
	object rowAccessPolicies {
		...
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListRowAccessPoliciesResponse]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.ListRowAccessPoliciesResponse])
		}
		object list {
	...
	object tabledata {
		...
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.TableDataList]) {
			...
			def apply() = req.execute("GET").map(_.json.as[Schema.TableDataList])
		}
		object list {
	...
	object tables {
		...
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withTable(body: Schema.Table) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Table])
		}
		object insert {
			def apply(projectsId :PlayApi, datasetsId :PlayApi, datasetId: String, projectId: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(auth(ws.url(BASE_URL + s"projects/${projectsId}/datasets/${datasetsId}/tables")).addQueryStringParameters("datasetId" -> datasetId.toString, "projectId" -> projectId.toString))
		}
		class setIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withSetIamPolicyRequest(body: Schema.SetIamPolicyRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Policy])
		}
		object setIamPolicy {
			def apply(projectsId :PlayApi, datasetsId :PlayApi, tablesId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): setIamPolicy = new setIamPolicy(auth(ws.url(BASE_URL + s"projects/${projectsId}/datasets/${datasetsId}/tables/${tablesId}:setIamPolicy")).addQueryStringParameters("resource" -> resource.toString))
		}
		class getIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withGetIamPolicyRequest(body: Schema.GetIamPolicyRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Policy])
		}
		object getIamPolicy {
			def apply(projectsId :PlayApi, datasetsId :PlayApi, tablesId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): getIamPolicy = new getIamPolicy(auth(ws.url(BASE_URL + s"projects/${projectsId}/datasets/${datasetsId}/tables/${tablesId}:getIamPolicy")).addQueryStringParameters("resource" -> resource.toString))
		}
		class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Unit]) {
			def apply() = req.execute("DELETE").map(_ => ())
		}
		...
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			...
			def withTable(body: Schema.Table) = req.withBody(Json.toJson(body)).execute("PUT").map(_.json.as[Schema.Table])
		}
		object update {
			def apply(projectsId :PlayApi, datasetsId :PlayApi, tablesId :PlayApi, datasetId: String, projectId: String, tableId: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(auth(ws.url(BASE_URL + s"projects/${projectsId}/datasets/${datasetsId}/tables/${tablesId}")).addQueryStringParameters("datasetId" -> datasetId.toString, "projectId" -> projectId.toString, "tableId" -> tableId.toString))
		}
		class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			...
			def withTable(body: Schema.Table) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.Table])
		}
		object patch {
			def apply(projectsId :PlayApi, datasetsId :PlayApi, tablesId :PlayApi, datasetId: String, projectId: String, tableId: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"projects/${projectsId}/datasets/${datasetsId}/tables/${tablesId}")).addQueryStringParameters("datasetId" -> datasetId.toString, "projectId" -> projectId.toString, "tableId" -> tableId.toString))
		}
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.TableList]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.TableList])
		}
		object list {
