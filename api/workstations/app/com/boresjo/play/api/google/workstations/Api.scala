		...
		object locations {
			...
			object workstationClusters {
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					def withWorkstationCluster(body: Schema.WorkstationCluster) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
				}
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, workstationClusterId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workstationClusters")).addQueryStringParameters("parent" -> parent.toString, "workstationClusterId" -> workstationClusterId.toString))
				}
				...
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, workstationClustersId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workstationClusters/${workstationClustersId}")).addQueryStringParameters("name" -> name.toString))
				...
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.WorkstationCluster]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.WorkstationCluster])
				}
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, workstationClustersId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workstationClusters/${workstationClustersId}")).addQueryStringParameters("name" -> name.toString))
				...
				class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					def withWorkstationCluster(body: Schema.WorkstationCluster) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.Operation])
				}
				object patch {
					def apply(projectsId :PlayApi, locationsId :PlayApi, workstationClustersId :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workstationClusters/${workstationClustersId}")).addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
				}
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListWorkstationClustersResponse]) {
					...
					def apply() = req.execute("GET").map(_.json.as[Schema.ListWorkstationClustersResponse])
				}
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workstationClusters")).addQueryStringParameters("parent" -> parent.toString))
				...
				object workstationConfigs {
					...
					object getIamPolicy {
						def apply(projectsId :PlayApi, locationsId :PlayApi, workstationClustersId :PlayApi, workstationConfigsId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): getIamPolicy = new getIamPolicy(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workstationClusters/${workstationClustersId}/workstationConfigs/${workstationConfigsId}:getIamPolicy")).addQueryStringParameters("resource" -> resource.toString))
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.WorkstationConfig]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.WorkstationConfig])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, workstationClustersId :PlayApi, workstationConfigsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workstationClusters/${workstationClustersId}/workstationConfigs/${workstationConfigsId}")).addQueryStringParameters("name" -> name.toString))
					...
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						...
						def withAllowMissing(allowMissing: Boolean) = new patch(req.addQueryStringParameters("allowMissing" -> allowMissing.toString))
						def withWorkstationConfig(body: Schema.WorkstationConfig) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.Operation])
					}
					object patch {
						def apply(projectsId :PlayApi, locationsId :PlayApi, workstationClustersId :PlayApi, workstationConfigsId :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workstationClusters/${workstationClustersId}/workstationConfigs/${workstationConfigsId}")).addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
					}
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						/** Optional. If set, validate the request and preview the review, but do not actually apply it. */
						def withValidateOnly(validateOnly: Boolean) = new create(req.addQueryStringParameters("validateOnly" -> validateOnly.toString))
						def withWorkstationConfig(body: Schema.WorkstationConfig) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
					}
					object create {
						def apply(projectsId :PlayApi, locationsId :PlayApi, workstationClustersId :PlayApi, parent: String, workstationConfigId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workstationClusters/${workstationClustersId}/workstationConfigs")).addQueryStringParameters("parent" -> parent.toString, "workstationConfigId" -> workstationConfigId.toString))
					}
					...
					object setIamPolicy {
						def apply(projectsId :PlayApi, locationsId :PlayApi, workstationClustersId :PlayApi, workstationConfigsId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): setIamPolicy = new setIamPolicy(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workstationClusters/${workstationClustersId}/workstationConfigs/${workstationConfigsId}:setIamPolicy")).addQueryStringParameters("resource" -> resource.toString))
					}
					class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Operation]) {
						/** Optional. If set, validate the request and preview the review, but do not actually apply it. */
						def withValidateOnly(validateOnly: Boolean) = new delete(req.addQueryStringParameters("validateOnly" -> validateOnly.toString))
					...
					object delete {
						def apply(projectsId :PlayApi, locationsId :PlayApi, workstationClustersId :PlayApi, workstationConfigsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workstationClusters/${workstationClustersId}/workstationConfigs/${workstationConfigsId}")).addQueryStringParameters("name" -> name.toString))
						given Conversion[delete, Future[Schema.Operation]] = (fun: delete) => fun.apply()
					}
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListWorkstationConfigsResponse]) {
						...
						/** Optional. next_page_token value returned from a previous List request, if any. */
						def withPageToken(pageToken: String) = new list(req.addQueryStringParameters("pageToken" -> pageToken.toString))
						def apply() = req.execute("GET").map(_.json.as[Schema.ListWorkstationConfigsResponse])
					}
					object list {
						def apply(projectsId :PlayApi, locationsId :PlayApi, workstationClustersId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workstationClusters/${workstationClustersId}/workstationConfigs")).addQueryStringParameters("parent" -> parent.toString))
					...
					class listUsable(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListUsableWorkstationConfigsResponse]) {
						...
						def apply() = req.execute("GET").map(_.json.as[Schema.ListUsableWorkstationConfigsResponse])
					}
					object listUsable {
						def apply(projectsId :PlayApi, locationsId :PlayApi, workstationClustersId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): listUsable = new listUsable(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workstationClusters/${workstationClustersId}/workstationConfigs:listUsable")).addQueryStringParameters("parent" -> parent.toString))
					...
					object workstations {
						...
						class stop(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withStopWorkstationRequest(body: Schema.StopWorkstationRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
						}
						object stop {
							def apply(projectsId :PlayApi, locationsId :PlayApi, workstationClustersId :PlayApi, workstationConfigsId :PlayApi, workstationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): stop = new stop(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workstationClusters/${workstationClustersId}/workstationConfigs/${workstationConfigsId}/workstations/${workstationsId}:stop")).addQueryStringParameters("name" -> name.toString))
						}
						class getIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Policy]) {
							/** Optional. The maximum policy version that will be used to format the policy. Valid values are 0, 1, and 3. Requests specifying an invalid value will be rejected. Requests for policies with any conditional role bindings must specify version 3. Policies with no conditional role bindings may specify any valid value or leave the field unset. The policy in the response might use the policy version that you specified, or it might use a lower policy version. For example, if you specify version 3, but the policy has no conditional role bindings, the response uses version 1. To learn which resources support conditions in their IAM policies, see the [IAM documentation](https://cloud.google.com/iam/help/conditions/resource-policies).<br>Format: int32 */
							def withOptionsRequestedPolicyVersion(optionsRequestedPolicyVersion: Int) = new getIamPolicy(req.addQueryStringParameters("options.requestedPolicyVersion" -> optionsRequestedPolicyVersion.toString))
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Workstation]) {
							def apply() = req.execute("GET").map(_.json.as[Schema.Workstation])
						}
						object get {
							def apply(projectsId :PlayApi, locationsId :PlayApi, workstationClustersId :PlayApi, workstationConfigsId :PlayApi, workstationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workstationClusters/${workstationClustersId}/workstationConfigs/${workstationConfigsId}/workstations/${workstationsId}")).addQueryStringParameters("name" -> name.toString))
						...
						class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							...
							def withAllowMissing(allowMissing: Boolean) = new patch(req.addQueryStringParameters("allowMissing" -> allowMissing.toString))
							def withWorkstation(body: Schema.Workstation) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.Operation])
						}
						object patch {
						...
						class start(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withStartWorkstationRequest(body: Schema.StartWorkstationRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
						}
						object start {
							def apply(projectsId :PlayApi, locationsId :PlayApi, workstationClustersId :PlayApi, workstationConfigsId :PlayApi, workstationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): start = new start(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workstationClusters/${workstationClustersId}/workstationConfigs/${workstationConfigsId}/workstations/${workstationsId}:start")).addQueryStringParameters("name" -> name.toString))
						}
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListWorkstationsResponse]) {
							...
							/** Optional. next_page_token value returned from a previous List request, if any. */
							def withPageToken(pageToken: String) = new list(req.addQueryStringParameters("pageToken" -> pageToken.toString))
							def apply() = req.execute("GET").map(_.json.as[Schema.ListWorkstationsResponse])
						}
						object list {
							def apply(projectsId :PlayApi, locationsId :PlayApi, workstationClustersId :PlayApi, workstationConfigsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workstationClusters/${workstationClustersId}/workstationConfigs/${workstationConfigsId}/workstations")).addQueryStringParameters("parent" -> parent.toString))
						...
						class listUsable(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListUsableWorkstationsResponse]) {
							...
							/** Optional. next_page_token value returned from a previous List request, if any. */
							def withPageToken(pageToken: String) = new listUsable(req.addQueryStringParameters("pageToken" -> pageToken.toString))
							def apply() = req.execute("GET").map(_.json.as[Schema.ListUsableWorkstationsResponse])
						}
						object listUsable {
							def apply(projectsId :PlayApi, locationsId :PlayApi, workstationClustersId :PlayApi, workstationConfigsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): listUsable = new listUsable(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/workstationClusters/${workstationClustersId}/workstationConfigs/${workstationConfigsId}/workstations:listUsable")).addQueryStringParameters("parent" -> parent.toString))
