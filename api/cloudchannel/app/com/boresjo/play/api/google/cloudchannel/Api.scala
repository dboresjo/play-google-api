...
class Api @Inject() (ws: WSClient) extends PlayApi {
	...
	object accounts {
		class register(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			...
			def withGoogleCloudChannelV1RegisterSubscriberRequest(body: Schema.GoogleCloudChannelV1RegisterSubscriberRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudChannelV1RegisterSubscriberResponse])
		}
		object register {
			def apply(accountsId :PlayApi)(using auth: AuthToken, ec: ExecutionContext): register = new register(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}:register")).addQueryStringParameters())
		}
		class listTransferableOffers(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withGoogleCloudChannelV1ListTransferableOffersRequest(body: Schema.GoogleCloudChannelV1ListTransferableOffersRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudChannelV1ListTransferableOffersResponse])
		}
		object listTransferableOffers {
			def apply(accountsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): listTransferableOffers = new listTransferableOffers(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}:listTransferableOffers")).addQueryStringParameters("parent" -> parent.toString))
		}
		class listTransferableSkus(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withGoogleCloudChannelV1ListTransferableSkusRequest(body: Schema.GoogleCloudChannelV1ListTransferableSkusRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudChannelV1ListTransferableSkusResponse])
		}
		object listTransferableSkus {
			def apply(accountsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): listTransferableSkus = new listTransferableSkus(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}:listTransferableSkus")).addQueryStringParameters("parent" -> parent.toString))
		}
		class unregister(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			...
			def withGoogleCloudChannelV1UnregisterSubscriberRequest(body: Schema.GoogleCloudChannelV1UnregisterSubscriberRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudChannelV1UnregisterSubscriberResponse])
		}
		object unregister {
			def apply(accountsId :PlayApi)(using auth: AuthToken, ec: ExecutionContext): unregister = new unregister(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}:unregister")).addQueryStringParameters())
		}
		class checkCloudIdentityAccountsExist(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withGoogleCloudChannelV1CheckCloudIdentityAccountsExistRequest(body: Schema.GoogleCloudChannelV1CheckCloudIdentityAccountsExistRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudChannelV1CheckCloudIdentityAccountsExistResponse])
		}
		object checkCloudIdentityAccountsExist {
			def apply(accountsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): checkCloudIdentityAccountsExist = new checkCloudIdentityAccountsExist(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}:checkCloudIdentityAccountsExist")).addQueryStringParameters("parent" -> parent.toString))
		}
		class listSubscribers(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1ListSubscribersResponse]) {
			...
			def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1ListSubscribersResponse])
		}
		object listSubscribers {
			def apply(accountsId :PlayApi)(using auth: AuthToken, ec: ExecutionContext): listSubscribers = new listSubscribers(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}:listSubscribers")).addQueryStringParameters())
		...
		object skuGroups {
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1ListSkuGroupsResponse]) {
				...
				def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1ListSkuGroupsResponse])
			}
			object list {
				def apply(accountsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/skuGroups")).addQueryStringParameters("parent" -> parent.toString))
			...
			object billableSkus {
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1ListSkuGroupBillableSkusResponse]) {
					...
					def withPageToken(pageToken: String) = new list(req.addQueryStringParameters("pageToken" -> pageToken.toString))
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1ListSkuGroupBillableSkusResponse])
				}
				object list {
					def apply(accountsId :PlayApi, skuGroupsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/skuGroups/${skuGroupsId}/billableSkus")).addQueryStringParameters("parent" -> parent.toString))
		...
		object offers {
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1ListOffersResponse]) {
				...
				def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1ListOffersResponse])
			}
			object list {
				def apply(accountsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/offers")).addQueryStringParameters("parent" -> parent.toString))
		...
		object reportJobs {
			class fetchReportResults(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withGoogleCloudChannelV1FetchReportResultsRequest(body: Schema.GoogleCloudChannelV1FetchReportResultsRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudChannelV1FetchReportResultsResponse])
			}
			object fetchReportResults {
				def apply(accountsId :PlayApi, reportJobsId :PlayApi, reportJob: String)(using auth: AuthToken, ec: ExecutionContext): fetchReportResults = new fetchReportResults(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/reportJobs/${reportJobsId}:fetchReportResults")).addQueryStringParameters("reportJob" -> reportJob.toString))
			}
		}
		object channelPartnerLinks {
			class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withGoogleCloudChannelV1ChannelPartnerLink(body: Schema.GoogleCloudChannelV1ChannelPartnerLink) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudChannelV1ChannelPartnerLink])
			}
			object create {
				def apply(accountsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/channelPartnerLinks")).addQueryStringParameters("parent" -> parent.toString))
			}
			class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1ChannelPartnerLink]) {
				...
				def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1ChannelPartnerLink])
			}
			object get {
				def apply(accountsId :PlayApi, channelPartnerLinksId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/channelPartnerLinks/${channelPartnerLinksId}")).addQueryStringParameters("name" -> name.toString))
				given Conversion[get, Future[Schema.GoogleCloudChannelV1ChannelPartnerLink]] = (fun: get) => fun.apply()
			}
			class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withGoogleCloudChannelV1UpdateChannelPartnerLinkRequest(body: Schema.GoogleCloudChannelV1UpdateChannelPartnerLinkRequest) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleCloudChannelV1ChannelPartnerLink])
			}
			object patch {
				def apply(accountsId :PlayApi, channelPartnerLinksId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/channelPartnerLinks/${channelPartnerLinksId}")).addQueryStringParameters("name" -> name.toString))
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1ListChannelPartnerLinksResponse]) {
				...
				def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1ListChannelPartnerLinksResponse])
			}
			object list {
				def apply(accountsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/channelPartnerLinks")).addQueryStringParameters("parent" -> parent.toString))
			...
			object channelPartnerRepricingConfigs {
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudChannelV1ChannelPartnerRepricingConfig(body: Schema.GoogleCloudChannelV1ChannelPartnerRepricingConfig) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudChannelV1ChannelPartnerRepricingConfig])
				}
				object create {
					def apply(accountsId :PlayApi, channelPartnerLinksId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/channelPartnerLinks/${channelPartnerLinksId}/channelPartnerRepricingConfigs")).addQueryStringParameters("parent" -> parent.toString))
				}
				class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
					def apply() = req.execute("DELETE").map(_.json.as[Schema.GoogleProtobufEmpty])
				}
				object delete {
					def apply(accountsId :PlayApi, channelPartnerLinksId :PlayApi, channelPartnerRepricingConfigsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/channelPartnerLinks/${channelPartnerLinksId}/channelPartnerRepricingConfigs/${channelPartnerRepricingConfigsId}")).addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.GoogleProtobufEmpty]] = (fun: delete) => fun.apply()
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1ChannelPartnerRepricingConfig]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1ChannelPartnerRepricingConfig])
				}
				object get {
					def apply(accountsId :PlayApi, channelPartnerLinksId :PlayApi, channelPartnerRepricingConfigsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/channelPartnerLinks/${channelPartnerLinksId}/channelPartnerRepricingConfigs/${channelPartnerRepricingConfigsId}")).addQueryStringParameters("name" -> name.toString))
					given Conversion[get, Future[Schema.GoogleCloudChannelV1ChannelPartnerRepricingConfig]] = (fun: get) => fun.apply()
				}
				class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudChannelV1ChannelPartnerRepricingConfig(body: Schema.GoogleCloudChannelV1ChannelPartnerRepricingConfig) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleCloudChannelV1ChannelPartnerRepricingConfig])
				}
				object patch {
					def apply(accountsId :PlayApi, channelPartnerLinksId :PlayApi, channelPartnerRepricingConfigsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/channelPartnerLinks/${channelPartnerLinksId}/channelPartnerRepricingConfigs/${channelPartnerRepricingConfigsId}")).addQueryStringParameters("name" -> name.toString))
				}
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1ListChannelPartnerRepricingConfigsResponse]) {
					...
					def withFilter(filter: String) = new list(req.addQueryStringParameters("filter" -> filter.toString))
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1ListChannelPartnerRepricingConfigsResponse])
				}
				object list {
					def apply(accountsId :PlayApi, channelPartnerLinksId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/channelPartnerLinks/${channelPartnerLinksId}/channelPartnerRepricingConfigs")).addQueryStringParameters("parent" -> parent.toString))
					given Conversion[list, Future[Schema.GoogleCloudChannelV1ListChannelPartnerRepricingConfigsResponse]] = (fun: list) => fun.apply()
				}
			}
			object customers {
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudChannelV1Customer(body: Schema.GoogleCloudChannelV1Customer) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudChannelV1Customer])
				}
				object create {
					def apply(accountsId :PlayApi, channelPartnerLinksId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/channelPartnerLinks/${channelPartnerLinksId}/customers")).addQueryStringParameters("parent" -> parent.toString))
				}
				class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudChannelV1ImportCustomerRequest(body: Schema.GoogleCloudChannelV1ImportCustomerRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudChannelV1Customer])
				}
				object `import` {
					def apply(accountsId :PlayApi, channelPartnerLinksId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): `import` = new `import`(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/channelPartnerLinks/${channelPartnerLinksId}/customers:import")).addQueryStringParameters("parent" -> parent.toString))
				}
				class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
					def apply() = req.execute("DELETE").map(_.json.as[Schema.GoogleProtobufEmpty])
				}
				object delete {
					def apply(accountsId :PlayApi, channelPartnerLinksId :PlayApi, customersId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/channelPartnerLinks/${channelPartnerLinksId}/customers/${customersId}")).addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.GoogleProtobufEmpty]] = (fun: delete) => fun.apply()
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1Customer]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1Customer])
				}
				object get {
					def apply(accountsId :PlayApi, channelPartnerLinksId :PlayApi, customersId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/channelPartnerLinks/${channelPartnerLinksId}/customers/${customersId}")).addQueryStringParameters("name" -> name.toString))
				...
				class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					def withGoogleCloudChannelV1Customer(body: Schema.GoogleCloudChannelV1Customer) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleCloudChannelV1Customer])
				}
				object patch {
					def apply(accountsId :PlayApi, channelPartnerLinksId :PlayApi, customersId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/channelPartnerLinks/${channelPartnerLinksId}/customers/${customersId}")).addQueryStringParameters("name" -> name.toString))
				}
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1ListCustomersResponse]) {
					...
					def withFilter(filter: String) = new list(req.addQueryStringParameters("filter" -> filter.toString))
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1ListCustomersResponse])
				}
				object list {
					def apply(accountsId :PlayApi, channelPartnerLinksId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/channelPartnerLinks/${channelPartnerLinksId}/customers")).addQueryStringParameters("parent" -> parent.toString))
		...
		object customers {
			class queryEligibleBillingAccounts(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1QueryEligibleBillingAccountsResponse]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1QueryEligibleBillingAccountsResponse])
			}
			object queryEligibleBillingAccounts {
				def apply(accountsId :PlayApi, customersId :PlayApi, customer: String, skus: String)(using auth: AuthToken, ec: ExecutionContext): queryEligibleBillingAccounts = new queryEligibleBillingAccounts(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}:queryEligibleBillingAccounts")).addQueryStringParameters("customer" -> customer.toString, "skus" -> skus.toString))
			...
			class transferEntitlements(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withGoogleCloudChannelV1TransferEntitlementsRequest(body: Schema.GoogleCloudChannelV1TransferEntitlementsRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
			}
			object transferEntitlements {
				def apply(accountsId :PlayApi, customersId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): transferEntitlements = new transferEntitlements(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}:transferEntitlements")).addQueryStringParameters("parent" -> parent.toString))
			}
			...
			object create {
				def apply(accountsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers")).addQueryStringParameters("parent" -> parent.toString))
			}
			class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withGoogleCloudChannelV1ImportCustomerRequest(body: Schema.GoogleCloudChannelV1ImportCustomerRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudChannelV1Customer])
			}
			object `import` {
				def apply(accountsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): `import` = new `import`(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers:import")).addQueryStringParameters("parent" -> parent.toString))
			}
			class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1Customer]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1Customer])
			}
			object get {
				def apply(accountsId :PlayApi, customersId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}")).addQueryStringParameters("name" -> name.toString))
				given Conversion[get, Future[Schema.GoogleCloudChannelV1Customer]] = (fun: get) => fun.apply()
			}
			...
			object delete {
				def apply(accountsId :PlayApi, customersId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}")).addQueryStringParameters("name" -> name.toString))
				given Conversion[delete, Future[Schema.GoogleProtobufEmpty]] = (fun: delete) => fun.apply()
			}
			class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				/** The update mask that applies to the resource. Optional.<br>Format: google-fieldmask */
			...
			object patch {
				def apply(accountsId :PlayApi, customersId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}")).addQueryStringParameters("name" -> name.toString))
			}
			class transferEntitlementsToGoogle(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withGoogleCloudChannelV1TransferEntitlementsToGoogleRequest(body: Schema.GoogleCloudChannelV1TransferEntitlementsToGoogleRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
			}
			object transferEntitlementsToGoogle {
				def apply(accountsId :PlayApi, customersId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): transferEntitlementsToGoogle = new transferEntitlementsToGoogle(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}:transferEntitlementsToGoogle")).addQueryStringParameters("parent" -> parent.toString))
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1ListCustomersResponse]) {
				/** Optional. The maximum number of customers to return. The service may return fewer than this value. If unspecified, returns at most 10 customers. The maximum value is 50.<br>Format: int32 */
				def withPageSize(pageSize: Int) = new list(req.addQueryStringParameters("pageSize" -> pageSize.toString))
			...
			object list {
				def apply(accountsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers")).addQueryStringParameters("parent" -> parent.toString))
				given Conversion[list, Future[Schema.GoogleCloudChannelV1ListCustomersResponse]] = (fun: list) => fun.apply()
			}
			class provisionCloudIdentity(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withGoogleCloudChannelV1ProvisionCloudIdentityRequest(body: Schema.GoogleCloudChannelV1ProvisionCloudIdentityRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
			}
			object provisionCloudIdentity {
				def apply(accountsId :PlayApi, customersId :PlayApi, customer: String)(using auth: AuthToken, ec: ExecutionContext): provisionCloudIdentity = new provisionCloudIdentity(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}:provisionCloudIdentity")).addQueryStringParameters("customer" -> customer.toString))
			}
			object entitlements {
				class cancel(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudChannelV1CancelEntitlementRequest(body: Schema.GoogleCloudChannelV1CancelEntitlementRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
				}
				object cancel {
					def apply(accountsId :PlayApi, customersId :PlayApi, entitlementsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): cancel = new cancel(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}/entitlements/${entitlementsId}:cancel")).addQueryStringParameters("name" -> name.toString))
				}
				class changeOffer(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudChannelV1ChangeOfferRequest(body: Schema.GoogleCloudChannelV1ChangeOfferRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
				}
				object changeOffer {
					def apply(accountsId :PlayApi, customersId :PlayApi, entitlementsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): changeOffer = new changeOffer(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}/entitlements/${entitlementsId}:changeOffer")).addQueryStringParameters("name" -> name.toString))
				}
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudChannelV1CreateEntitlementRequest(body: Schema.GoogleCloudChannelV1CreateEntitlementRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
				}
				object create {
					def apply(accountsId :PlayApi, customersId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}/entitlements")).addQueryStringParameters("parent" -> parent.toString))
				}
				class suspend(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudChannelV1SuspendEntitlementRequest(body: Schema.GoogleCloudChannelV1SuspendEntitlementRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
				}
				object suspend {
					def apply(accountsId :PlayApi, customersId :PlayApi, entitlementsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): suspend = new suspend(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}/entitlements/${entitlementsId}:suspend")).addQueryStringParameters("name" -> name.toString))
				}
				class listEntitlementChanges(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1ListEntitlementChangesResponse]) {
					...
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1ListEntitlementChangesResponse])
				}
				object listEntitlementChanges {
					def apply(accountsId :PlayApi, customersId :PlayApi, entitlementsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): listEntitlementChanges = new listEntitlementChanges(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}/entitlements/${entitlementsId}:listEntitlementChanges")).addQueryStringParameters("parent" -> parent.toString))
				...
				class changeParameters(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudChannelV1ChangeParametersRequest(body: Schema.GoogleCloudChannelV1ChangeParametersRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
				}
				object changeParameters {
					def apply(accountsId :PlayApi, customersId :PlayApi, entitlementsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): changeParameters = new changeParameters(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}/entitlements/${entitlementsId}:changeParameters")).addQueryStringParameters("name" -> name.toString))
				}
				class lookupOffer(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1Offer]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1Offer])
				}
				object lookupOffer {
					def apply(accountsId :PlayApi, customersId :PlayApi, entitlementsId :PlayApi, entitlement: String)(using auth: AuthToken, ec: ExecutionContext): lookupOffer = new lookupOffer(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}/entitlements/${entitlementsId}:lookupOffer")).addQueryStringParameters("entitlement" -> entitlement.toString))
				...
				class startPaidService(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudChannelV1StartPaidServiceRequest(body: Schema.GoogleCloudChannelV1StartPaidServiceRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
				}
				object startPaidService {
					def apply(accountsId :PlayApi, customersId :PlayApi, entitlementsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): startPaidService = new startPaidService(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}/entitlements/${entitlementsId}:startPaidService")).addQueryStringParameters("name" -> name.toString))
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1Entitlement]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1Entitlement])
				}
				object get {
					def apply(accountsId :PlayApi, customersId :PlayApi, entitlementsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}/entitlements/${entitlementsId}")).addQueryStringParameters("name" -> name.toString))
				...
				class activate(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudChannelV1ActivateEntitlementRequest(body: Schema.GoogleCloudChannelV1ActivateEntitlementRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
				}
				object activate {
					def apply(accountsId :PlayApi, customersId :PlayApi, entitlementsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): activate = new activate(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}/entitlements/${entitlementsId}:activate")).addQueryStringParameters("name" -> name.toString))
				}
				class changeRenewalSettings(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudChannelV1ChangeRenewalSettingsRequest(body: Schema.GoogleCloudChannelV1ChangeRenewalSettingsRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
				}
				object changeRenewalSettings {
					def apply(accountsId :PlayApi, customersId :PlayApi, entitlementsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): changeRenewalSettings = new changeRenewalSettings(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}/entitlements/${entitlementsId}:changeRenewalSettings")).addQueryStringParameters("name" -> name.toString))
				}
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1ListEntitlementsResponse]) {
					...
					def withPageToken(pageToken: String) = new list(req.addQueryStringParameters("pageToken" -> pageToken.toString))
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1ListEntitlementsResponse])
				}
				object list {
					def apply(accountsId :PlayApi, customersId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}/entitlements")).addQueryStringParameters("parent" -> parent.toString))
			...
			object customerRepricingConfigs {
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudChannelV1CustomerRepricingConfig(body: Schema.GoogleCloudChannelV1CustomerRepricingConfig) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudChannelV1CustomerRepricingConfig])
				}
				object create {
					def apply(accountsId :PlayApi, customersId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}/customerRepricingConfigs")).addQueryStringParameters("parent" -> parent.toString))
				}
				class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
					def apply() = req.execute("DELETE").map(_.json.as[Schema.GoogleProtobufEmpty])
				}
				object delete {
					def apply(accountsId :PlayApi, customersId :PlayApi, customerRepricingConfigsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}/customerRepricingConfigs/${customerRepricingConfigsId}")).addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.GoogleProtobufEmpty]] = (fun: delete) => fun.apply()
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1CustomerRepricingConfig]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1CustomerRepricingConfig])
				}
				object get {
					def apply(accountsId :PlayApi, customersId :PlayApi, customerRepricingConfigsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}/customerRepricingConfigs/${customerRepricingConfigsId}")).addQueryStringParameters("name" -> name.toString))
					given Conversion[get, Future[Schema.GoogleCloudChannelV1CustomerRepricingConfig]] = (fun: get) => fun.apply()
				}
				class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudChannelV1CustomerRepricingConfig(body: Schema.GoogleCloudChannelV1CustomerRepricingConfig) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleCloudChannelV1CustomerRepricingConfig])
				}
				object patch {
					def apply(accountsId :PlayApi, customersId :PlayApi, customerRepricingConfigsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}/customerRepricingConfigs/${customerRepricingConfigsId}")).addQueryStringParameters("name" -> name.toString))
				}
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1ListCustomerRepricingConfigsResponse]) {
					...
					def withFilter(filter: String) = new list(req.addQueryStringParameters("filter" -> filter.toString))
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1ListCustomerRepricingConfigsResponse])
				}
				object list {
					def apply(accountsId :PlayApi, customersId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/customers/${customersId}/customerRepricingConfigs")).addQueryStringParameters("parent" -> parent.toString))
		...
		object reports {
			class run(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withGoogleCloudChannelV1RunReportJobRequest(body: Schema.GoogleCloudChannelV1RunReportJobRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
			}
			object run {
				def apply(accountsId :PlayApi, reportsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): run = new run(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/reports/${reportsId}:run")).addQueryStringParameters("name" -> name.toString))
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1ListReportsResponse]) {
				...
				def withLanguageCode(languageCode: String) = new list(req.addQueryStringParameters("languageCode" -> languageCode.toString))
				def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1ListReportsResponse])
			}
			object list {
				def apply(accountsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/accounts/${accountsId}/reports")).addQueryStringParameters("parent" -> parent.toString))
	...
	object products {
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1ListProductsResponse]) {
			...
			/** Optional. The BCP-47 language code. For example, "en-US". The response will localize in the corresponding language code, if specified. The default value is "en-US". */
			def withLanguageCode(languageCode: String) = new list(req.addQueryStringParameters("languageCode" -> languageCode.toString))
			def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1ListProductsResponse])
		}
		object list {
			def apply(account: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/products")).addQueryStringParameters("account" -> account.toString))
		...
		object skus {
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1ListSkusResponse]) {
				...
				/** Optional. The BCP-47 language code. For example, "en-US". The response will localize in the corresponding language code, if specified. The default value is "en-US". */
				def withLanguageCode(languageCode: String) = new list(req.addQueryStringParameters("languageCode" -> languageCode.toString))
				def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudChannelV1ListSkusResponse])
			}
			object list {
				def apply(productsId :PlayApi, parent: String, account: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/products/${productsId}/skus")).addQueryStringParameters("parent" -> parent.toString, "account" -> account.toString))
	...
	object integrators {
		...
		object registerSubscriber {
			def apply(integratorsId :PlayApi)(using auth: AuthToken, ec: ExecutionContext): registerSubscriber = new registerSubscriber(auth(ws.url(BASE_URL + s"v1/integrators/${integratorsId}:registerSubscriber")).addQueryStringParameters())
		}
		...
		object unregisterSubscriber {
			def apply(integratorsId :PlayApi)(using auth: AuthToken, ec: ExecutionContext): unregisterSubscriber = new unregisterSubscriber(auth(ws.url(BASE_URL + s"v1/integrators/${integratorsId}:unregisterSubscriber")).addQueryStringParameters())
		}
		class listSubscribers(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudChannelV1ListSubscribersResponse]) {
			/** Optional. Resource name of the integrator. Required if account is not provided. Otherwise, leave this field empty/unset. */
			def withIntegrator(integrator: String) = new listSubscribers(req.addQueryStringParameters("integrator" -> integrator.toString))
		...
		object listSubscribers {
			def apply(integratorsId :PlayApi)(using auth: AuthToken, ec: ExecutionContext): listSubscribers = new listSubscribers(auth(ws.url(BASE_URL + s"v1/integrators/${integratorsId}:listSubscribers")).addQueryStringParameters())
			given Conversion[listSubscribers, Future[Schema.GoogleCloudChannelV1ListSubscribersResponse]] = (fun: listSubscribers) => fun.apply()
		}
	}
}
