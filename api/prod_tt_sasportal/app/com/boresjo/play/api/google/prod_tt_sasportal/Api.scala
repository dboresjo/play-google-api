...
class Api @Inject() (ws: WSClient) extends PlayApi {
	...
	object nodes {
		...
		object nodes {
			...
			object patch {
				def apply(nodesId :PlayApi, nodesId1 :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(ws.url(BASE_URL + s"v1alpha1/nodes/${nodesId}/nodes/${nodesId1}").addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
			}
		...
		object devices {
			...
			object patch {
				def apply(nodesId :PlayApi, devicesId :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(ws.url(BASE_URL + s"v1alpha1/nodes/${nodesId}/devices/${devicesId}").addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SasPortalListDevicesResponse]) {
				def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SasPortalListDevicesResponse])
			}
		...
		object deployments {
			...
			object patch {
				def apply(nodesId :PlayApi, deploymentsId :PlayApi, updateMask: String, name: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(ws.url(BASE_URL + s"v1alpha1/nodes/${nodesId}/deployments/${deploymentsId}").addQueryStringParameters("updateMask" -> updateMask.toString, "name" -> name.toString))
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SasPortalListDeploymentsResponse]) {
				def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SasPortalListDeploymentsResponse])
			}
	...
	object customers {
		...
		object patch {
			def apply(customersId :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(ws.url(BASE_URL + s"v1alpha1/customers/${customersId}").addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
		}
		object nodes {
			class move(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withSasPortalMoveNodeRequest(body: Schema.SasPortalMoveNodeRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.SasPortalOperation])
		...
		object deployments {
			...
			object patch {
				def apply(customersId :PlayApi, deploymentsId :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(ws.url(BASE_URL + s"v1alpha1/customers/${customersId}/deployments/${deploymentsId}").addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SasPortalListDeploymentsResponse]) {
				def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SasPortalListDeploymentsResponse])
			}
		...
		object devices {
			...
			object patch {
				def apply(customersId :PlayApi, devicesId :PlayApi, updateMask: String, name: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(ws.url(BASE_URL + s"v1alpha1/customers/${customersId}/devices/${devicesId}").addQueryStringParameters("updateMask" -> updateMask.toString, "name" -> name.toString))
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SasPortalListDevicesResponse]) {
				def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.SasPortalListDevicesResponse])
			}
	...
	object deployments {
		...
		object devices {
			...
			object patch {
				def apply(deploymentsId :PlayApi, devicesId :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(ws.url(BASE_URL + s"v1alpha1/deployments/${deploymentsId}/devices/${devicesId}").addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
			}
		}
	}
	object policies {
