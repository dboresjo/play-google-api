...
class Api @Inject() (ws: WSClient) extends PlayApi {
	...
	object platforms {
		...
		class list(private val req: WSRequest)(using signer: RequestSigner, ec: ExecutionContext) extends (() => Future[Schema.ListPlatformsResponse]) {
			val scopes = Seq()
			...
			/** Perform the request */
			def apply() = signer.exec(scopes:_*)(req,_.execute("GET")).map(_.json.as[Schema.ListPlatformsResponse])
		}
		object list {
			def apply(v1Id :PlayApi, parent: String)(using signer: RequestSigner, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/${v1Id}/platforms").addQueryStringParameters("parent" -> parent.toString))
		...
		object channels {
			...
			object list {
				def apply(v1Id :PlayApi, platformsId :PlayApi, parent: String)(using signer: RequestSigner, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/${v1Id}/platforms/${platformsId}/channels").addQueryStringParameters("parent" -> parent.toString))
			...
			object versions {
				...
				object list {
					def apply(v1Id :PlayApi, platformsId :PlayApi, channelsId :PlayApi, parent: String)(using signer: RequestSigner, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/${v1Id}/platforms/${platformsId}/channels/${channelsId}/versions").addQueryStringParameters("parent" -> parent.toString))
				...
				object releases {
					...
					object list {
						def apply(v1Id :PlayApi, platformsId :PlayApi, channelsId :PlayApi, versionsId :PlayApi, parent: String)(using signer: RequestSigner, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/${v1Id}/platforms/${platformsId}/channels/${channelsId}/versions/${versionsId}/releases").addQueryStringParameters("parent" -> parent.toString))
