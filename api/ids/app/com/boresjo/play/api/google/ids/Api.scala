		...
		object locations {
			...
			object endpoints {
				...
				object testIamPermissions {
					def apply(projectsId :PlayApi, locationsId :PlayApi, endpointsId :PlayApi, resource: String)(using signer: RequestSigner, ec: ExecutionContext): testIamPermissions = new testIamPermissions(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/endpoints/${endpointsId}:testIamPermissions").addQueryStringParameters("resource" -> resource.toString))
				}
				...
				object getIamPolicy {
					def apply(projectsId :PlayApi, locationsId :PlayApi, endpointsId :PlayApi, resource: String)(using signer: RequestSigner, ec: ExecutionContext): getIamPolicy = new getIamPolicy(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/endpoints/${endpointsId}:getIamPolicy").addQueryStringParameters("resource" -> resource.toString))
				...
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, endpointsId :PlayApi, name: String)(using signer: RequestSigner, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/endpoints/${endpointsId}").addQueryStringParameters("name" -> name.toString))
				...
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, endpointsId :PlayApi, name: String)(using signer: RequestSigner, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/endpoints/${endpointsId}").addQueryStringParameters("name" -> name.toString))
				...
				class patch(private val req: WSRequest)(using signer: RequestSigner, ec: ExecutionContext) {
					...
					/** Perform the request */
					def withEndpoint(body: Schema.Endpoint) = signer.exec(scopes:_*)(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.Operation])
				}
				object patch {
					def apply(projectsId :PlayApi, locationsId :PlayApi, endpointsId :PlayApi, name: String, updateMask: String)(using signer: RequestSigner, ec: ExecutionContext): patch = new patch(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/endpoints/${endpointsId}").addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
				}
				...
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using signer: RequestSigner, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/endpoints").addQueryStringParameters("parent" -> parent.toString))
				...
				class create(private val req: WSRequest)(using signer: RequestSigner, ec: ExecutionContext) {
					...
					/** Perform the request */
					def withEndpoint(body: Schema.Endpoint) = signer.exec(scopes:_*)(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, endpointId: String)(using signer: RequestSigner, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/endpoints").addQueryStringParameters("parent" -> parent.toString, "endpointId" -> endpointId.toString))
				}
				...
				object setIamPolicy {
					def apply(projectsId :PlayApi, locationsId :PlayApi, endpointsId :PlayApi, resource: String)(using signer: RequestSigner, ec: ExecutionContext): setIamPolicy = new setIamPolicy(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/endpoints/${endpointsId}:setIamPolicy").addQueryStringParameters("resource" -> resource.toString))
				}
			}
		}
	}
