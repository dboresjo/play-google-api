			...
			object global {
				...
				object connectivityTests {
					...
					object testIamPermissions {
						def apply(projectsId :PlayApi, connectivityTestsId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): testIamPermissions = new testIamPermissions(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/global/connectivityTests/${connectivityTestsId}:testIamPermissions")).addQueryStringParameters("resource" -> resource.toString))
					}
					class rerun(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withRerunConnectivityTestRequest(body: Schema.RerunConnectivityTestRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
					}
					object rerun {
						def apply(projectsId :PlayApi, connectivityTestsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): rerun = new rerun(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/global/connectivityTests/${connectivityTestsId}:rerun")).addQueryStringParameters("name" -> name.toString))
					}
					...
					object getIamPolicy {
						def apply(projectsId :PlayApi, connectivityTestsId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): getIamPolicy = new getIamPolicy(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/global/connectivityTests/${connectivityTestsId}:getIamPolicy")).addQueryStringParameters("resource" -> resource.toString))
					...
					object delete {
						def apply(projectsId :PlayApi, connectivityTestsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/global/connectivityTests/${connectivityTestsId}")).addQueryStringParameters("name" -> name.toString))
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ConnectivityTest]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.ConnectivityTest])
					}
					object get {
						def apply(projectsId :PlayApi, connectivityTestsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/global/connectivityTests/${connectivityTestsId}")).addQueryStringParameters("name" -> name.toString))
						given Conversion[get, Future[Schema.ConnectivityTest]] = (fun: get) => fun.apply()
					}
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withConnectivityTest(body: Schema.ConnectivityTest) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.Operation])
					}
					object patch {
						def apply(projectsId :PlayApi, connectivityTestsId :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/global/connectivityTests/${connectivityTestsId}")).addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
					}
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListConnectivityTestsResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.ListConnectivityTestsResponse])
					}
					object list {
						def apply(projectsId :PlayApi, parent: String, pageSize: Int, pageToken: String, filter: String, orderBy: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/global/connectivityTests")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString, "filter" -> filter.toString, "orderBy" -> orderBy.toString))
						given Conversion[list, Future[Schema.ListConnectivityTestsResponse]] = (fun: list) => fun.apply()
					}
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withConnectivityTest(body: Schema.ConnectivityTest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
					}
					object create {
						def apply(projectsId :PlayApi, parent: String, testId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/global/connectivityTests")).addQueryStringParameters("parent" -> parent.toString, "testId" -> testId.toString))
					}
					...
					object setIamPolicy {
						def apply(projectsId :PlayApi, connectivityTestsId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): setIamPolicy = new setIamPolicy(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/global/connectivityTests/${connectivityTestsId}:setIamPolicy")).addQueryStringParameters("resource" -> resource.toString))
					}
				}
			}
		}
