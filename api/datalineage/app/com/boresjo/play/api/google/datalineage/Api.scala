	...
	object projects {
		object locations {
			class searchLinks(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withGoogleCloudDatacatalogLineageV1SearchLinksRequest(body: Schema.GoogleCloudDatacatalogLineageV1SearchLinksRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudDatacatalogLineageV1SearchLinksResponse])
			}
			object searchLinks {
				def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): searchLinks = new searchLinks(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}:searchLinks").addQueryStringParameters("parent" -> parent.toString))
			}
			class processOpenLineageRunEvent(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDatacatalogLineageV1ProcessOpenLineageRunEventResponse]) {
				def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.GoogleCloudDatacatalogLineageV1ProcessOpenLineageRunEventResponse])
			}
			...
			class batchSearchLinkProcesses(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withGoogleCloudDatacatalogLineageV1BatchSearchLinkProcessesRequest(body: Schema.GoogleCloudDatacatalogLineageV1BatchSearchLinkProcessesRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudDatacatalogLineageV1BatchSearchLinkProcessesResponse])
			}
			object batchSearchLinkProcesses {
				def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): batchSearchLinkProcesses = new batchSearchLinkProcesses(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}:batchSearchLinkProcesses").addQueryStringParameters("parent" -> parent.toString))
			}
			object operations {
			...
			object processes {
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudDatacatalogLineageV1Process(body: Schema.GoogleCloudDatacatalogLineageV1Process) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudDatacatalogLineageV1Process])
				}
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, requestId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/processes").addQueryStringParameters("parent" -> parent.toString, "requestId" -> requestId.toString))
				}
				...
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDatacatalogLineageV1Process]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudDatacatalogLineageV1Process])
				}
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, processesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/processes/${processesId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[get, Future[Schema.GoogleCloudDatacatalogLineageV1Process]] = (fun: get) => fun.apply()
				}
				class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudDatacatalogLineageV1Process(body: Schema.GoogleCloudDatacatalogLineageV1Process) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudDatacatalogLineageV1Process])
				}
				object patch {
				...
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDatacatalogLineageV1ListProcessesResponse]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudDatacatalogLineageV1ListProcessesResponse])
				}
				object list {
				...
				object runs {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDatacatalogLineageV1Run(body: Schema.GoogleCloudDatacatalogLineageV1Run) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudDatacatalogLineageV1Run])
					}
					object create {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDatacatalogLineageV1Run]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudDatacatalogLineageV1Run])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, processesId :PlayApi, runsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/processes/${processesId}/runs/${runsId}").addQueryStringParameters("name" -> name.toString))
						given Conversion[get, Future[Schema.GoogleCloudDatacatalogLineageV1Run]] = (fun: get) => fun.apply()
					}
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDatacatalogLineageV1Run(body: Schema.GoogleCloudDatacatalogLineageV1Run) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleCloudDatacatalogLineageV1Run])
					}
					object patch {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDatacatalogLineageV1ListRunsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudDatacatalogLineageV1ListRunsResponse])
					}
					object list {
					...
					object lineageEvents {
						...
						class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudDatacatalogLineageV1LineageEvent(body: Schema.GoogleCloudDatacatalogLineageV1LineageEvent) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudDatacatalogLineageV1LineageEvent])
						}
						object create {
						...
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDatacatalogLineageV1ListLineageEventsResponse]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudDatacatalogLineageV1ListLineageEventsResponse])
						}
						object list {
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDatacatalogLineageV1LineageEvent]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudDatacatalogLineageV1LineageEvent])
						}
						object get {
