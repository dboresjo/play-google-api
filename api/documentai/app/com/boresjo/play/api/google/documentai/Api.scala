	...
	object projects {
		object locations {
			...
			class fetchProcessorTypes(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDocumentaiV1FetchProcessorTypesResponse]) {
				def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudDocumentaiV1FetchProcessorTypesResponse])
			}
			object fetchProcessorTypes {
				def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): fetchProcessorTypes = new fetchProcessorTypes(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}:fetchProcessorTypes").addQueryStringParameters("parent" -> parent.toString))
			...
			object processorTypes {
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDocumentaiV1ListProcessorTypesResponse]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudDocumentaiV1ListProcessorTypesResponse])
				}
				object list {
				...
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDocumentaiV1ProcessorType]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudDocumentaiV1ProcessorType])
				}
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, processorTypesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/processorTypes/${processorTypesId}").addQueryStringParameters("name" -> name.toString))
			...
			object processors {
				class enable(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudDocumentaiV1EnableProcessorRequest(body: Schema.GoogleCloudDocumentaiV1EnableProcessorRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
				}
				object enable {
					def apply(projectsId :PlayApi, locationsId :PlayApi, processorsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): enable = new enable(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/processors/${processorsId}:enable").addQueryStringParameters("name" -> name.toString))
				}
				class setDefaultProcessorVersion(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudDocumentaiV1SetDefaultProcessorVersionRequest(body: Schema.GoogleCloudDocumentaiV1SetDefaultProcessorVersionRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
				}
				...
				class batchProcess(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudDocumentaiV1BatchProcessRequest(body: Schema.GoogleCloudDocumentaiV1BatchProcessRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
				}
				object batchProcess {
					def apply(projectsId :PlayApi, locationsId :PlayApi, processorsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): batchProcess = new batchProcess(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/processors/${processorsId}:batchProcess").addQueryStringParameters("name" -> name.toString))
				}
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudDocumentaiV1Processor(body: Schema.GoogleCloudDocumentaiV1Processor) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudDocumentaiV1Processor])
				}
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/processors").addQueryStringParameters("parent" -> parent.toString))
				}
				...
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, processorsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/processors/${processorsId}").addQueryStringParameters("name" -> name.toString))
				...
				class disable(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudDocumentaiV1DisableProcessorRequest(body: Schema.GoogleCloudDocumentaiV1DisableProcessorRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
				}
				object disable {
					def apply(projectsId :PlayApi, locationsId :PlayApi, processorsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): disable = new disable(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/processors/${processorsId}:disable").addQueryStringParameters("name" -> name.toString))
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDocumentaiV1Processor]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudDocumentaiV1Processor])
				}
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, processorsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/processors/${processorsId}").addQueryStringParameters("name" -> name.toString))
				...
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDocumentaiV1ListProcessorsResponse]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudDocumentaiV1ListProcessorsResponse])
				}
				object list {
				...
				class process(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudDocumentaiV1ProcessRequest(body: Schema.GoogleCloudDocumentaiV1ProcessRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleCloudDocumentaiV1ProcessResponse])
				}
				object process {
					def apply(projectsId :PlayApi, locationsId :PlayApi, processorsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): process = new process(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/processors/${processorsId}:process").addQueryStringParameters("name" -> name.toString))
				}
				object humanReviewConfig {
					class reviewDocument(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDocumentaiV1ReviewDocumentRequest(body: Schema.GoogleCloudDocumentaiV1ReviewDocumentRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
					}
				...
				object processorVersions {
					...
					class undeploy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDocumentaiV1UndeployProcessorVersionRequest(body: Schema.GoogleCloudDocumentaiV1UndeployProcessorVersionRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object undeploy {
					...
					class evaluateProcessorVersion(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDocumentaiV1EvaluateProcessorVersionRequest(body: Schema.GoogleCloudDocumentaiV1EvaluateProcessorVersionRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					...
					class deploy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDocumentaiV1DeployProcessorVersionRequest(body: Schema.GoogleCloudDocumentaiV1DeployProcessorVersionRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object deploy {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDocumentaiV1ListProcessorVersionsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudDocumentaiV1ListProcessorVersionsResponse])
					}
					object list {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDocumentaiV1ProcessorVersion]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudDocumentaiV1ProcessorVersion])
					}
					object get {
					...
					class train(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDocumentaiV1TrainProcessorVersionRequest(body: Schema.GoogleCloudDocumentaiV1TrainProcessorVersionRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object train {
						def apply(projectsId :PlayApi, locationsId :PlayApi, processorsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): train = new train(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/processors/${processorsId}/processorVersions:train").addQueryStringParameters("parent" -> parent.toString))
					}
					object evaluations {
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDocumentaiV1ListEvaluationsResponse]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudDocumentaiV1ListEvaluationsResponse])
						}
						object list {
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDocumentaiV1Evaluation]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.GoogleCloudDocumentaiV1Evaluation])
						}
						object get {
