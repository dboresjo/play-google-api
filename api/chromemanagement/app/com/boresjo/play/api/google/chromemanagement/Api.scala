	...
	object customers {
		object telemetry {
			object users {
				...
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleChromeManagementV1TelemetryUser]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleChromeManagementV1TelemetryUser])
				}
				object get {
					def apply(customersId :PlayApi, usersId :PlayApi, name: String, readMask: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/telemetry/users/${usersId}")).addQueryStringParameters("name" -> name.toString, "readMask" -> readMask.toString))
			...
			object notificationConfigs {
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleChromeManagementV1ListTelemetryNotificationConfigsResponse]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleChromeManagementV1ListTelemetryNotificationConfigsResponse])
				}
				object list {
					def apply(customersId :PlayApi, pageSize: Int, parent: String, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/telemetry/notificationConfigs")).addQueryStringParameters("pageSize" -> pageSize.toString, "parent" -> parent.toString, "pageToken" -> pageToken.toString))
				...
				object delete {
					def apply(customersId :PlayApi, notificationConfigsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/telemetry/notificationConfigs/${notificationConfigsId}")).addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.GoogleProtobufEmpty]] = (fun: delete) => fun.apply()
				}
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleChromeManagementV1TelemetryNotificationConfig(body: Schema.GoogleChromeManagementV1TelemetryNotificationConfig) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleChromeManagementV1TelemetryNotificationConfig])
				}
				object create {
					def apply(customersId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/telemetry/notificationConfigs")).addQueryStringParameters("parent" -> parent.toString))
				}
			}
			object events {
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleChromeManagementV1ListTelemetryEventsResponse]) {
					...
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleChromeManagementV1ListTelemetryEventsResponse])
				}
				object list {
					def apply(customersId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/telemetry/events")).addQueryStringParameters("parent" -> parent.toString))
			...
			object devices {
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleChromeManagementV1ListTelemetryDevicesResponse]) {
					...
					def withFilter(filter: String) = new list(req.addQueryStringParameters("filter" -> filter.toString))
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleChromeManagementV1ListTelemetryDevicesResponse])
				}
				object list {
					def apply(customersId :PlayApi, readMask: String, pageToken: String, parent: String, pageSize: Int)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/telemetry/devices")).addQueryStringParameters("readMask" -> readMask.toString, "pageToken" -> pageToken.toString, "parent" -> parent.toString, "pageSize" -> pageSize.toString))
				...
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleChromeManagementV1TelemetryDevice]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleChromeManagementV1TelemetryDevice])
				}
				object get {
					def apply(customersId :PlayApi, devicesId :PlayApi, readMask: String, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/telemetry/devices/${devicesId}")).addQueryStringParameters("readMask" -> readMask.toString, "name" -> name.toString))
		...
		object reports {
			class countPrintJobsByPrinter(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleChromeManagementV1CountPrintJobsByPrinterResponse]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.GoogleChromeManagementV1CountPrintJobsByPrinterResponse])
			}
			object countPrintJobsByPrinter {
				def apply(customersId :PlayApi, pageToken: String, printerOrgUnitId: String, customer: String, orderBy: String, pageSize: Int, filter: String)(using auth: AuthToken, ec: ExecutionContext): countPrintJobsByPrinter = new countPrintJobsByPrinter(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/reports:countPrintJobsByPrinter")).addQueryStringParameters("pageToken" -> pageToken.toString, "printerOrgUnitId" -> printerOrgUnitId.toString, "customer" -> customer.toString, "orderBy" -> orderBy.toString, "pageSize" -> pageSize.toString, "filter" -> filter.toString))
			...
			class countChromeBrowsersNeedingAttention(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleChromeManagementV1CountChromeBrowsersNeedingAttentionResponse]) {
				...
				def apply() = req.execute("GET").map(_.json.as[Schema.GoogleChromeManagementV1CountChromeBrowsersNeedingAttentionResponse])
			}
			object countChromeBrowsersNeedingAttention {
				def apply(customersId :PlayApi, customer: String)(using auth: AuthToken, ec: ExecutionContext): countChromeBrowsersNeedingAttention = new countChromeBrowsersNeedingAttention(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/reports:countChromeBrowsersNeedingAttention")).addQueryStringParameters("customer" -> customer.toString))
			...
			class countChromeCrashEvents(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleChromeManagementV1CountChromeCrashEventsResponse]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.GoogleChromeManagementV1CountChromeCrashEventsResponse])
			}
			object countChromeCrashEvents {
				def apply(customersId :PlayApi, orgUnitId: String, customer: String, filter: String, orderBy: String)(using auth: AuthToken, ec: ExecutionContext): countChromeCrashEvents = new countChromeCrashEvents(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/reports:countChromeCrashEvents")).addQueryStringParameters("orgUnitId" -> orgUnitId.toString, "customer" -> customer.toString, "filter" -> filter.toString, "orderBy" -> orderBy.toString))
			...
			class countChromeDevicesThatNeedAttention(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleChromeManagementV1CountChromeDevicesThatNeedAttentionResponse]) {
				...
				def apply() = req.execute("GET").map(_.json.as[Schema.GoogleChromeManagementV1CountChromeDevicesThatNeedAttentionResponse])
			}
			object countChromeDevicesThatNeedAttention {
				def apply(customersId :PlayApi, readMask: String, customer: String)(using auth: AuthToken, ec: ExecutionContext): countChromeDevicesThatNeedAttention = new countChromeDevicesThatNeedAttention(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/reports:countChromeDevicesThatNeedAttention")).addQueryStringParameters("readMask" -> readMask.toString, "customer" -> customer.toString))
			...
			class enumeratePrintJobs(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleChromeManagementV1EnumeratePrintJobsResponse]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.GoogleChromeManagementV1EnumeratePrintJobsResponse])
			}
			object enumeratePrintJobs {
				def apply(customersId :PlayApi, pageSize: Int, customer: String, printerOrgUnitId: String, pageToken: String, orderBy: String, filter: String)(using auth: AuthToken, ec: ExecutionContext): enumeratePrintJobs = new enumeratePrintJobs(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/reports:enumeratePrintJobs")).addQueryStringParameters("pageSize" -> pageSize.toString, "customer" -> customer.toString, "printerOrgUnitId" -> printerOrgUnitId.toString, "pageToken" -> pageToken.toString, "orderBy" -> orderBy.toString, "filter" -> filter.toString))
			...
			class countChromeDevicesReachingAutoExpirationDate(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleChromeManagementV1CountChromeDevicesReachingAutoExpirationDateResponse]) {
				...
				def apply() = req.execute("GET").map(_.json.as[Schema.GoogleChromeManagementV1CountChromeDevicesReachingAutoExpirationDateResponse])
			}
			object countChromeDevicesReachingAutoExpirationDate {
				def apply(customersId :PlayApi, customer: String)(using auth: AuthToken, ec: ExecutionContext): countChromeDevicesReachingAutoExpirationDate = new countChromeDevicesReachingAutoExpirationDate(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/reports:countChromeDevicesReachingAutoExpirationDate")).addQueryStringParameters("customer" -> customer.toString))
		...
		object apps {
			class countChromeAppRequests(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleChromeManagementV1CountChromeAppRequestsResponse]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.GoogleChromeManagementV1CountChromeAppRequestsResponse])
			}
			object countChromeAppRequests {
				def apply(customersId :PlayApi, pageSize: Int, orderBy: String, orgUnitId: String, pageToken: String, customer: String)(using auth: AuthToken, ec: ExecutionContext): countChromeAppRequests = new countChromeAppRequests(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/apps:countChromeAppRequests")).addQueryStringParameters("pageSize" -> pageSize.toString, "orderBy" -> orderBy.toString, "orgUnitId" -> orgUnitId.toString, "pageToken" -> pageToken.toString, "customer" -> customer.toString))
			...
			class fetchDevicesRequestingExtension(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleChromeManagementV1FetchDevicesRequestingExtensionResponse]) {
				...
				def apply() = req.execute("GET").map(_.json.as[Schema.GoogleChromeManagementV1FetchDevicesRequestingExtensionResponse])
			}
			object fetchDevicesRequestingExtension {
				def apply(customersId :PlayApi, orgUnitId: String, customer: String, extensionId: String)(using auth: AuthToken, ec: ExecutionContext): fetchDevicesRequestingExtension = new fetchDevicesRequestingExtension(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/apps:fetchDevicesRequestingExtension")).addQueryStringParameters("orgUnitId" -> orgUnitId.toString, "customer" -> customer.toString, "extensionId" -> extensionId.toString))
			...
			class fetchUsersRequestingExtension(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleChromeManagementV1FetchUsersRequestingExtensionResponse]) {
				...
				def apply() = req.execute("GET").map(_.json.as[Schema.GoogleChromeManagementV1FetchUsersRequestingExtensionResponse])
			}
			object fetchUsersRequestingExtension {
				def apply(customersId :PlayApi, extensionId: String, orgUnitId: String, customer: String)(using auth: AuthToken, ec: ExecutionContext): fetchUsersRequestingExtension = new fetchUsersRequestingExtension(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/apps:fetchUsersRequestingExtension")).addQueryStringParameters("extensionId" -> extensionId.toString, "orgUnitId" -> orgUnitId.toString, "customer" -> customer.toString))
			...
			object chrome {
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleChromeManagementV1AppDetails]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleChromeManagementV1AppDetails])
				}
				object get {
					def apply(customersId :PlayApi, chromeId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/apps/chrome/${chromeId}")).addQueryStringParameters("name" -> name.toString))
			...
			object web {
				...
				object get {
					def apply(customersId :PlayApi, webId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/apps/web/${webId}")).addQueryStringParameters("name" -> name.toString))
					given Conversion[get, Future[Schema.GoogleChromeManagementV1AppDetails]] = (fun: get) => fun.apply()
				}
			}
			object android {
				...
				object get {
					def apply(customersId :PlayApi, androidId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/customers/${customersId}/apps/android/${androidId}")).addQueryStringParameters("name" -> name.toString))
					given Conversion[get, Future[Schema.GoogleChromeManagementV1AppDetails]] = (fun: get) => fun.apply()
				}
			}
		}
