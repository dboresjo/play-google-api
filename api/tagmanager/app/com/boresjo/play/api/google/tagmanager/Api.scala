...
class Api @Inject() (ws: WSClient) extends PlayApi {
	...
	object accounts {
		...
		object get {
			def apply(accountsId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}")).addQueryStringParameters("path" -> path.toString))
		...
		object update {
			def apply(accountsId :PlayApi, path: String, fingerprint: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}")).addQueryStringParameters("path" -> path.toString, "fingerprint" -> fingerprint.toString))
		}
		...
		object list {
			def apply(includeGoogleTags: Boolean, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts")).addQueryStringParameters("includeGoogleTags" -> includeGoogleTags.toString, "pageToken" -> pageToken.toString))
			given Conversion[list, Future[Schema.ListAccountsResponse]] = (fun: list) => fun.apply()
		}
		object user_permissions {
			class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withUserPermission(body: Schema.UserPermission) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.UserPermission])
			}
			object create {
				def apply(accountsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/user_permissions")).addQueryStringParameters("parent" -> parent.toString))
			}
			...
			object delete {
				def apply(accountsId :PlayApi, user_permissionsId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/user_permissions/${user_permissionsId}")).addQueryStringParameters("path" -> path.toString))
			...
			class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.UserPermission]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.UserPermission])
			}
			object get {
				def apply(accountsId :PlayApi, user_permissionsId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/user_permissions/${user_permissionsId}")).addQueryStringParameters("path" -> path.toString))
				given Conversion[get, Future[Schema.UserPermission]] = (fun: get) => fun.apply()
			}
			class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withUserPermission(body: Schema.UserPermission) = req.withBody(Json.toJson(body)).execute("PUT").map(_.json.as[Schema.UserPermission])
			}
			object update {
				def apply(accountsId :PlayApi, user_permissionsId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/user_permissions/${user_permissionsId}")).addQueryStringParameters("path" -> path.toString))
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListUserPermissionsResponse]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.ListUserPermissionsResponse])
			}
			object list {
				def apply(accountsId :PlayApi, parent: String, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/user_permissions")).addQueryStringParameters("parent" -> parent.toString, "pageToken" -> pageToken.toString))
		...
		object containers {
			class snippet(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GetContainerSnippetResponse]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.GetContainerSnippetResponse])
			}
			object snippet {
				def apply(accountsId :PlayApi, containersId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): snippet = new snippet(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}:snippet")).addQueryStringParameters("path" -> path.toString))
				given Conversion[snippet, Future[Schema.GetContainerSnippetResponse]] = (fun: snippet) => fun.apply()
			}
			class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withContainer(body: Schema.Container) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Container])
			}
			object create {
				def apply(accountsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers")).addQueryStringParameters("parent" -> parent.toString))
			}
			class move_tag_id(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Container]) {
				def apply() = req.execute("POST").map(_.json.as[Schema.Container])
			}
			object move_tag_id {
				def apply(accountsId :PlayApi, containersId :PlayApi, path: String, tagId: String, tagName: String, copyUsers: Boolean, copySettings: Boolean, allowUserPermissionFeatureUpdate: Boolean, copyTermsOfService: Boolean)(using auth: AuthToken, ec: ExecutionContext): move_tag_id = new move_tag_id(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}:move_tag_id")).addQueryStringParameters("path" -> path.toString, "tagId" -> tagId.toString, "tagName" -> tagName.toString, "copyUsers" -> copyUsers.toString, "copySettings" -> copySettings.toString, "allowUserPermissionFeatureUpdate" -> allowUserPermissionFeatureUpdate.toString, "copyTermsOfService" -> copyTermsOfService.toString))
			...
			object delete {
				def apply(accountsId :PlayApi, containersId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}")).addQueryStringParameters("path" -> path.toString))
				given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
			}
			...
			class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Container]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.Container])
			}
			object get {
				def apply(accountsId :PlayApi, containersId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}")).addQueryStringParameters("path" -> path.toString))
				given Conversion[get, Future[Schema.Container]] = (fun: get) => fun.apply()
			}
			class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withContainer(body: Schema.Container) = req.withBody(Json.toJson(body)).execute("PUT").map(_.json.as[Schema.Container])
			}
			object update {
				def apply(accountsId :PlayApi, containersId :PlayApi, path: String, fingerprint: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}")).addQueryStringParameters("path" -> path.toString, "fingerprint" -> fingerprint.toString))
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListContainersResponse]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.ListContainersResponse])
			}
			object list {
				def apply(accountsId :PlayApi, parent: String, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers")).addQueryStringParameters("parent" -> parent.toString, "pageToken" -> pageToken.toString))
			...
			object lookup {
				def apply(destinationId: String, tagId: String)(using auth: AuthToken, ec: ExecutionContext): lookup = new lookup(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/containers:lookup")).addQueryStringParameters("destinationId" -> destinationId.toString, "tagId" -> tagId.toString))
			...
			object environments {
				class reauthorize(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withEnvironment(body: Schema.Environment) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Environment])
				}
				object reauthorize {
					def apply(accountsId :PlayApi, containersId :PlayApi, environmentsId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): reauthorize = new reauthorize(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/environments/${environmentsId}:reauthorize")).addQueryStringParameters("path" -> path.toString))
				}
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withEnvironment(body: Schema.Environment) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Environment])
				}
				object create {
					def apply(accountsId :PlayApi, containersId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/environments")).addQueryStringParameters("parent" -> parent.toString))
				}
				class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Unit]) {
					def apply() = req.execute("DELETE").map(_ => ())
				}
				object delete {
					def apply(accountsId :PlayApi, containersId :PlayApi, environmentsId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/environments/${environmentsId}")).addQueryStringParameters("path" -> path.toString))
					given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
				}
				...
				object get {
					def apply(accountsId :PlayApi, containersId :PlayApi, environmentsId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/environments/${environmentsId}")).addQueryStringParameters("path" -> path.toString))
					given Conversion[get, Future[Schema.Environment]] = (fun: get) => fun.apply()
				}
				class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withEnvironment(body: Schema.Environment) = req.withBody(Json.toJson(body)).execute("PUT").map(_.json.as[Schema.Environment])
				}
				object update {
					def apply(accountsId :PlayApi, containersId :PlayApi, environmentsId :PlayApi, path: String, fingerprint: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/environments/${environmentsId}")).addQueryStringParameters("path" -> path.toString, "fingerprint" -> fingerprint.toString))
				}
			...
			object versions {
				class set_latest(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ContainerVersion]) {
					def apply() = req.execute("POST").map(_.json.as[Schema.ContainerVersion])
				}
				object set_latest {
					def apply(accountsId :PlayApi, containersId :PlayApi, versionsId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): set_latest = new set_latest(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/versions/${versionsId}:set_latest")).addQueryStringParameters("path" -> path.toString))
				...
				object undelete {
					def apply(accountsId :PlayApi, containersId :PlayApi, versionsId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): undelete = new undelete(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/versions/${versionsId}:undelete")).addQueryStringParameters("path" -> path.toString))
				...
				class live(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ContainerVersion]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.ContainerVersion])
				}
				object live {
					def apply(accountsId :PlayApi, containersId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): live = new live(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/versions:live")).addQueryStringParameters("parent" -> parent.toString))
				...
				object delete {
					def apply(accountsId :PlayApi, containersId :PlayApi, versionsId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/versions/${versionsId}")).addQueryStringParameters("path" -> path.toString))
					given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
				}
			...
			object version_headers {
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListContainerVersionsResponse]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.ListContainerVersionsResponse])
				}
				object list {
				...
				class latest(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ContainerVersionHeader]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.ContainerVersionHeader])
				}
				object latest {
					def apply(accountsId :PlayApi, containersId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): latest = new latest(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/version_headers:latest")).addQueryStringParameters("parent" -> parent.toString))
			...
			object destinations {
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Destination]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.Destination])
				}
				object get {
					def apply(accountsId :PlayApi, containersId :PlayApi, destinationsId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/destinations/${destinationsId}")).addQueryStringParameters("path" -> path.toString))
				...
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListDestinationsResponse]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.ListDestinationsResponse])
				}
				object list {
					def apply(accountsId :PlayApi, containersId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/destinations")).addQueryStringParameters("parent" -> parent.toString))
			...
			object workspaces {
				...
				object delete {
					def apply(accountsId :PlayApi, containersId :PlayApi, workspacesId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/workspaces/${workspacesId}")).addQueryStringParameters("path" -> path.toString))
					given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
				}
				class sync(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.SyncWorkspaceResponse]) {
					def apply() = req.execute("POST").map(_.json.as[Schema.SyncWorkspaceResponse])
				}
				object sync {
					def apply(accountsId :PlayApi, containersId :PlayApi, workspacesId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): sync = new sync(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/workspaces/${workspacesId}:sync")).addQueryStringParameters("path" -> path.toString))
				...
				class create_version(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withCreateContainerVersionRequestVersionOptions(body: Schema.CreateContainerVersionRequestVersionOptions) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.CreateContainerVersionResponse])
				}
				...
				object get {
					def apply(accountsId :PlayApi, containersId :PlayApi, workspacesId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/workspaces/${workspacesId}")).addQueryStringParameters("path" -> path.toString))
					given Conversion[get, Future[Schema.Workspace]] = (fun: get) => fun.apply()
				}
				class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withWorkspace(body: Schema.Workspace) = req.withBody(Json.toJson(body)).execute("PUT").map(_.json.as[Schema.Workspace])
				}
				object update {
				...
				class resolve_conflict(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withEntity(body: Schema.Entity) = req.withBody(Json.toJson(body)).execute("POST").map(_ => ())
				}
				...
				class getStatus(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GetWorkspaceStatusResponse]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.GetWorkspaceStatusResponse])
				}
				object getStatus {
					def apply(accountsId :PlayApi, containersId :PlayApi, workspacesId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): getStatus = new getStatus(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/workspaces/${workspacesId}/status")).addQueryStringParameters("path" -> path.toString))
				...
				object create {
					def apply(accountsId :PlayApi, containersId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/workspaces")).addQueryStringParameters("parent" -> parent.toString))
				}
				object gtag_config {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGtagConfig(body: Schema.GtagConfig) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GtagConfig])
					}
					object create {
						def apply(accountsId :PlayApi, containersId :PlayApi, workspacesId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/workspaces/${workspacesId}/gtag_config")).addQueryStringParameters("parent" -> parent.toString))
					}
					class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Unit]) {
						def apply() = req.execute("DELETE").map(_ => ())
					}
					object delete {
						def apply(accountsId :PlayApi, containersId :PlayApi, workspacesId :PlayApi, gtag_configId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/workspaces/${workspacesId}/gtag_config/${gtag_configId}")).addQueryStringParameters("path" -> path.toString))
						given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
					}
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GtagConfig]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GtagConfig])
					}
					object get {
						def apply(accountsId :PlayApi, containersId :PlayApi, workspacesId :PlayApi, gtag_configId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/workspaces/${workspacesId}/gtag_config/${gtag_configId}")).addQueryStringParameters("path" -> path.toString))
					...
					class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGtagConfig(body: Schema.GtagConfig) = req.withBody(Json.toJson(body)).execute("PUT").map(_.json.as[Schema.GtagConfig])
					}
					object update {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListGtagConfigResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.ListGtagConfigResponse])
					}
					object list {
				...
				object variables {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withVariable(body: Schema.Variable) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Variable])
					}
					object create {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Variable]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.Variable])
					}
					object get {
						def apply(accountsId :PlayApi, containersId :PlayApi, workspacesId :PlayApi, variablesId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/workspaces/${workspacesId}/variables/${variablesId}")).addQueryStringParameters("path" -> path.toString))
					...
					class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withVariable(body: Schema.Variable) = req.withBody(Json.toJson(body)).execute("PUT").map(_.json.as[Schema.Variable])
					}
					object update {
					...
					class revert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.RevertVariableResponse]) {
						def apply() = req.execute("POST").map(_.json.as[Schema.RevertVariableResponse])
					}
					object revert {
						def apply(accountsId :PlayApi, containersId :PlayApi, workspacesId :PlayApi, variablesId :PlayApi, path: String, fingerprint: String)(using auth: AuthToken, ec: ExecutionContext): revert = new revert(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/workspaces/${workspacesId}/variables/${variablesId}:revert")).addQueryStringParameters("path" -> path.toString, "fingerprint" -> fingerprint.toString))
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListVariablesResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.ListVariablesResponse])
					}
					object list {
				...
				object transformations {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withTransformation(body: Schema.Transformation) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Transformation])
					}
					object create {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Transformation]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.Transformation])
					}
					object get {
						def apply(accountsId :PlayApi, containersId :PlayApi, workspacesId :PlayApi, transformationsId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/workspaces/${workspacesId}/transformations/${transformationsId}")).addQueryStringParameters("path" -> path.toString))
					...
					class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withTransformation(body: Schema.Transformation) = req.withBody(Json.toJson(body)).execute("PUT").map(_.json.as[Schema.Transformation])
					}
					object update {
					...
					class revert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.RevertTransformationResponse]) {
						def apply() = req.execute("POST").map(_.json.as[Schema.RevertTransformationResponse])
					}
					object revert {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListTransformationsResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.ListTransformationsResponse])
					}
					object list {
						def apply(accountsId :PlayApi, containersId :PlayApi, workspacesId :PlayApi, parent: String, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/workspaces/${workspacesId}/transformations")).addQueryStringParameters("parent" -> parent.toString, "pageToken" -> pageToken.toString))
				...
				object zones {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withZone(body: Schema.Zone) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Zone])
					}
					object create {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Zone]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.Zone])
					}
					object get {
						def apply(accountsId :PlayApi, containersId :PlayApi, workspacesId :PlayApi, zonesId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/workspaces/${workspacesId}/zones/${zonesId}")).addQueryStringParameters("path" -> path.toString))
					...
					class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withZone(body: Schema.Zone) = req.withBody(Json.toJson(body)).execute("PUT").map(_.json.as[Schema.Zone])
					}
					object update {
					...
					class revert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.RevertZoneResponse]) {
						def apply() = req.execute("POST").map(_.json.as[Schema.RevertZoneResponse])
					}
					object revert {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListZonesResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.ListZonesResponse])
					}
					object list {
				...
				object clients {
					...
					class revert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.RevertClientResponse]) {
						def apply() = req.execute("POST").map(_.json.as[Schema.RevertClientResponse])
					}
					object revert {
				...
				object tags {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withTag(body: Schema.Tag) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Tag])
					}
					object create {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Tag]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.Tag])
					}
					object get {
						def apply(accountsId :PlayApi, containersId :PlayApi, workspacesId :PlayApi, tagsId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/workspaces/${workspacesId}/tags/${tagsId}")).addQueryStringParameters("path" -> path.toString))
					...
					class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withTag(body: Schema.Tag) = req.withBody(Json.toJson(body)).execute("PUT").map(_.json.as[Schema.Tag])
					}
					object update {
					...
					class revert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.RevertTagResponse]) {
						def apply() = req.execute("POST").map(_.json.as[Schema.RevertTagResponse])
					}
					object revert {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListTagsResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.ListTagsResponse])
					}
					object list {
				...
				object triggers {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withTrigger(body: Schema.Trigger) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Trigger])
					}
					object create {
					...
					class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withTrigger(body: Schema.Trigger) = req.withBody(Json.toJson(body)).execute("PUT").map(_.json.as[Schema.Trigger])
					}
					object update {
					...
					class revert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.RevertTriggerResponse]) {
						def apply() = req.execute("POST").map(_.json.as[Schema.RevertTriggerResponse])
					}
					object revert {
				...
				object built_in_variables {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.CreateBuiltInVariableResponse]) {
						def apply() = req.execute("POST").map(_.json.as[Schema.CreateBuiltInVariableResponse])
					}
					object create {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListEnabledBuiltInVariablesResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.ListEnabledBuiltInVariablesResponse])
					}
					object list {
						def apply(accountsId :PlayApi, containersId :PlayApi, workspacesId :PlayApi, parent: String, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/workspaces/${workspacesId}/built_in_variables")).addQueryStringParameters("parent" -> parent.toString, "pageToken" -> pageToken.toString))
					...
					class revert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.RevertBuiltInVariableResponse]) {
						def apply() = req.execute("POST").map(_.json.as[Schema.RevertBuiltInVariableResponse])
					}
					object revert {
				...
				object templates {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withCustomTemplate(body: Schema.CustomTemplate) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.CustomTemplate])
					}
					object create {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.CustomTemplate]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.CustomTemplate])
					}
					object get {
						def apply(accountsId :PlayApi, containersId :PlayApi, workspacesId :PlayApi, templatesId :PlayApi, path: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/workspaces/${workspacesId}/templates/${templatesId}")).addQueryStringParameters("path" -> path.toString))
					...
					class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withCustomTemplate(body: Schema.CustomTemplate) = req.withBody(Json.toJson(body)).execute("PUT").map(_.json.as[Schema.CustomTemplate])
					}
					object update {
						def apply(accountsId :PlayApi, containersId :PlayApi, workspacesId :PlayApi, templatesId :PlayApi, path: String, fingerprint: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(auth(ws.url(BASE_URL + s"tagmanager/v2/accounts/${accountsId}/containers/${containersId}/workspaces/${workspacesId}/templates/${templatesId}")).addQueryStringParameters("path" -> path.toString, "fingerprint" -> fingerprint.toString))
					}
					class revert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.RevertTemplateResponse]) {
						def apply() = req.execute("POST").map(_.json.as[Schema.RevertTemplateResponse])
					}
					object revert {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListTemplatesResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.ListTemplatesResponse])
					}
					object list {
				...
				object folders {
					...
					class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withFolder(body: Schema.Folder) = req.withBody(Json.toJson(body)).execute("PUT").map(_.json.as[Schema.Folder])
					}
					object update {
					...
					class revert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.RevertFolderResponse]) {
						def apply() = req.execute("POST").map(_.json.as[Schema.RevertFolderResponse])
					}
					object revert {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListFoldersResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.ListFoldersResponse])
					}
					object list {
