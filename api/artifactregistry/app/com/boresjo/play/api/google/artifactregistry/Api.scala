...
class Api @Inject() (ws: WSClient) extends PlayApi {
	...
	object projects {
		class getProjectSettings(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ProjectSettings]) {
			def apply() = req.execute("GET").map(_.json.as[Schema.ProjectSettings])
		}
		object getProjectSettings {
			def apply(projectsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): getProjectSettings = new getProjectSettings(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/projectSettings")).addQueryStringParameters("name" -> name.toString))
		...
		class updateProjectSettings(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withProjectSettings(body: Schema.ProjectSettings) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.ProjectSettings])
		}
		object updateProjectSettings {
			def apply(projectsId :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): updateProjectSettings = new updateProjectSettings(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/projectSettings")).addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
		}
		object locations {
			class updateVpcscConfig(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withVPCSCConfig(body: Schema.VPCSCConfig) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.VPCSCConfig])
			}
			object updateVpcscConfig {
				def apply(projectsId :PlayApi, locationsId :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): updateVpcscConfig = new updateVpcscConfig(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/vpcscConfig")).addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
			}
			...
			class getVpcscConfig(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.VPCSCConfig]) {
				def apply() = req.execute("GET").map(_.json.as[Schema.VPCSCConfig])
			}
			object getVpcscConfig {
				def apply(projectsId :PlayApi, locationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): getVpcscConfig = new getVpcscConfig(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/vpcscConfig")).addQueryStringParameters("name" -> name.toString))
			...
			object repositories {
				...
				object testIamPermissions {
					def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): testIamPermissions = new testIamPermissions(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}:testIamPermissions")).addQueryStringParameters("resource" -> resource.toString))
				}
				class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Operation]) {
					def apply() = req.execute("DELETE").map(_.json.as[Schema.Operation])
				}
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}")).addQueryStringParameters("name" -> name.toString))
				...
				object patch {
					def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}")).addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
				}
				...
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
					given Conversion[list, Future[Schema.ListRepositoriesResponse]] = (fun: list) => fun.apply()
				}
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withRepository(body: Schema.Repository) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
				}
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, repositoryId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories")).addQueryStringParameters("parent" -> parent.toString, "repositoryId" -> repositoryId.toString))
				}
				...
				object setIamPolicy {
					def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): setIamPolicy = new setIamPolicy(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}:setIamPolicy")).addQueryStringParameters("resource" -> resource.toString))
				}
				...
				object getIamPolicy {
					def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, resource: String)(using auth: AuthToken, ec: ExecutionContext): getIamPolicy = new getIamPolicy(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}:getIamPolicy")).addQueryStringParameters("resource" -> resource.toString))
				...
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}")).addQueryStringParameters("name" -> name.toString))
				...
				object aptArtifacts {
					class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withImportAptArtifactsRequest(body: Schema.ImportAptArtifactsRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
					}
					object `import` {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): `import` = new `import`(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/aptArtifacts:import")).addQueryStringParameters("parent" -> parent.toString))
					}
					class upload(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withUploadAptArtifactRequest(body: Schema.UploadAptArtifactRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.UploadAptArtifactMediaResponse])
					}
					object upload {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): upload = new upload(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/aptArtifacts:create")).addQueryStringParameters("parent" -> parent.toString))
					}
				}
				object mavenArtifacts {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListMavenArtifactsResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.ListMavenArtifactsResponse])
					}
					object list {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/mavenArtifacts")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.MavenArtifact]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.MavenArtifact])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, mavenArtifactsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/mavenArtifacts/${mavenArtifactsId}")).addQueryStringParameters("name" -> name.toString))
						given Conversion[get, Future[Schema.MavenArtifact]] = (fun: get) => fun.apply()
					}
				}
				object kfpArtifacts {
					class upload(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withUploadKfpArtifactRequest(body: Schema.UploadKfpArtifactRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.UploadKfpArtifactMediaResponse])
					}
					object upload {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): upload = new upload(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/kfpArtifacts:create")).addQueryStringParameters("parent" -> parent.toString))
					}
				}
				object npmPackages {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListNpmPackagesResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.ListNpmPackagesResponse])
					}
					object list {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/npmPackages")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.NpmPackage]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.NpmPackage])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, npmPackagesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/npmPackages/${npmPackagesId}")).addQueryStringParameters("name" -> name.toString))
				...
				object files {
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleDevtoolsArtifactregistryV1File]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleDevtoolsArtifactregistryV1File])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, filesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/files/${filesId}")).addQueryStringParameters("name" -> name.toString))
						given Conversion[get, Future[Schema.GoogleDevtoolsArtifactregistryV1File]] = (fun: get) => fun.apply()
					}
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleDevtoolsArtifactregistryV1File(body: Schema.GoogleDevtoolsArtifactregistryV1File) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleDevtoolsArtifactregistryV1File])
					}
					object patch {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, filesId :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/files/${filesId}")).addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
					}
					class download(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.DownloadFileResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.DownloadFileResponse])
					}
					object download {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, filesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): download = new download(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/files/${filesId}:download")).addQueryStringParameters("name" -> name.toString))
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListFilesResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.ListFilesResponse])
					}
					object list {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String, filter: String, pageSize: Int, pageToken: String, orderBy: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/files")).addQueryStringParameters("parent" -> parent.toString, "filter" -> filter.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString, "orderBy" -> orderBy.toString))
						given Conversion[list, Future[Schema.ListFilesResponse]] = (fun: list) => fun.apply()
					}
					class upload(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withUploadFileRequest(body: Schema.UploadFileRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.UploadFileMediaResponse])
					}
					object upload {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): upload = new upload(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/files:upload")).addQueryStringParameters("parent" -> parent.toString))
					}
					class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Operation]) {
						def apply() = req.execute("DELETE").map(_.json.as[Schema.Operation])
					}
					object delete {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, filesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/files/${filesId}")).addQueryStringParameters("name" -> name.toString))
						given Conversion[delete, Future[Schema.Operation]] = (fun: delete) => fun.apply()
					}
				}
				object dockerImages {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListDockerImagesResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.ListDockerImagesResponse])
					}
					object list {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String, pageSize: Int, pageToken: String, orderBy: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/dockerImages")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString, "orderBy" -> orderBy.toString))
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.DockerImage]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.DockerImage])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, dockerImagesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/dockerImages/${dockerImagesId}")).addQueryStringParameters("name" -> name.toString))
				...
				object packages {
					...
					object delete {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, packagesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/packages/${packagesId}")).addQueryStringParameters("name" -> name.toString))
						given Conversion[delete, Future[Schema.Operation]] = (fun: delete) => fun.apply()
					}
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Package]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.Package])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, packagesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/packages/${packagesId}")).addQueryStringParameters("name" -> name.toString))
						given Conversion[get, Future[Schema.Package]] = (fun: get) => fun.apply()
					}
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withPackage(body: Schema.Package) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.Package])
					}
					object patch {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, packagesId :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/packages/${packagesId}")).addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
					}
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListPackagesResponse]) {
						...
						/** Optional. The field to order the results by. */
						def withOrderBy(orderBy: String) = new list(req.addQueryStringParameters("orderBy" -> orderBy.toString))
						def apply() = req.execute("GET").map(_.json.as[Schema.ListPackagesResponse])
					}
					object list {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/packages")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
					...
					object versions {
						class batchDelete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withBatchDeleteVersionsRequest(body: Schema.BatchDeleteVersionsRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
						}
						object batchDelete {
							def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, packagesId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): batchDelete = new batchDelete(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/packages/${packagesId}/versions:batchDelete")).addQueryStringParameters("parent" -> parent.toString))
						}
						class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Operation]) {
							def apply() = req.execute("DELETE").map(_.json.as[Schema.Operation])
						}
						...
						class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withVersion(body: Schema.Version) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.Version])
						}
						object patch {
					...
					object tags {
						...
						class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withTag(body: Schema.Tag) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.Tag])
						}
						object patch {
				...
				object goModules {
					class upload(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withUploadGoModuleRequest(body: Schema.UploadGoModuleRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.UploadGoModuleMediaResponse])
					}
					object upload {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): upload = new upload(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/goModules:create")).addQueryStringParameters("parent" -> parent.toString))
					}
				}
				object yumArtifacts {
					class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withImportYumArtifactsRequest(body: Schema.ImportYumArtifactsRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
					}
					object `import` {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): `import` = new `import`(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/yumArtifacts:import")).addQueryStringParameters("parent" -> parent.toString))
					}
					class upload(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withUploadYumArtifactRequest(body: Schema.UploadYumArtifactRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.UploadYumArtifactMediaResponse])
					}
					object upload {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): upload = new upload(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/yumArtifacts:create")).addQueryStringParameters("parent" -> parent.toString))
					}
				}
				object googetArtifacts {
					class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withImportGoogetArtifactsRequest(body: Schema.ImportGoogetArtifactsRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
					}
					object `import` {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): `import` = new `import`(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/googetArtifacts:import")).addQueryStringParameters("parent" -> parent.toString))
					}
					class upload(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withUploadGoogetArtifactRequest(body: Schema.UploadGoogetArtifactRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.UploadGoogetArtifactMediaResponse])
					}
					object upload {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): upload = new upload(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/googetArtifacts:create")).addQueryStringParameters("parent" -> parent.toString))
					}
				}
				object genericArtifacts {
					class upload(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withUploadGenericArtifactRequest(body: Schema.UploadGenericArtifactRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.UploadGenericArtifactMediaResponse])
					}
					object upload {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): upload = new upload(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/genericArtifacts:create")).addQueryStringParameters("parent" -> parent.toString))
					}
				}
				object rules {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleDevtoolsArtifactregistryV1Rule(body: Schema.GoogleDevtoolsArtifactregistryV1Rule) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleDevtoolsArtifactregistryV1Rule])
					}
					object create {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String, ruleId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/rules")).addQueryStringParameters("parent" -> parent.toString, "ruleId" -> ruleId.toString))
					}
					class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Empty]) {
						def apply() = req.execute("DELETE").map(_.json.as[Schema.Empty])
					}
					object delete {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, rulesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/rules/${rulesId}")).addQueryStringParameters("name" -> name.toString))
						given Conversion[delete, Future[Schema.Empty]] = (fun: delete) => fun.apply()
					}
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleDevtoolsArtifactregistryV1Rule]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleDevtoolsArtifactregistryV1Rule])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, rulesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/rules/${rulesId}")).addQueryStringParameters("name" -> name.toString))
						given Conversion[get, Future[Schema.GoogleDevtoolsArtifactregistryV1Rule]] = (fun: get) => fun.apply()
					}
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleDevtoolsArtifactregistryV1Rule(body: Schema.GoogleDevtoolsArtifactregistryV1Rule) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleDevtoolsArtifactregistryV1Rule])
					}
					object patch {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, rulesId :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/rules/${rulesId}")).addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
					}
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListRulesResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.ListRulesResponse])
					}
					object list {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/rules")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
				...
				object pythonPackages {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListPythonPackagesResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.ListPythonPackagesResponse])
					}
					object list {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/pythonPackages")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.PythonPackage]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.PythonPackage])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, pythonPackagesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/pythonPackages/${pythonPackagesId}")).addQueryStringParameters("name" -> name.toString))
				...
				object attachments {
					...
					object list {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/attachments")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
					...
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, attachmentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/attachments/${attachmentsId}")).addQueryStringParameters("name" -> name.toString))
						given Conversion[get, Future[Schema.Attachment]] = (fun: get) => fun.apply()
					}
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withAttachment(body: Schema.Attachment) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.Operation])
					}
					object create {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, parent: String, attachmentId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/attachments")).addQueryStringParameters("parent" -> parent.toString, "attachmentId" -> attachmentId.toString))
					}
					class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Operation]) {
						def apply() = req.execute("DELETE").map(_.json.as[Schema.Operation])
					}
					object delete {
						def apply(projectsId :PlayApi, locationsId :PlayApi, repositoriesId :PlayApi, attachmentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v1/projects/${projectsId}/locations/${locationsId}/repositories/${repositoriesId}/attachments/${attachmentsId}")).addQueryStringParameters("name" -> name.toString))
						given Conversion[delete, Future[Schema.Operation]] = (fun: delete) => fun.apply()
					}
				}
			}
