...
class Api @Inject() (ws: WSClient) extends PlayApi {
	...
	object anywhereCaches {
		class resume(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AnywhereCache]) {
			def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.AnywhereCache])
		}
		object resume {
			def apply(bucket: String, anywhereCacheId: String)(using auth: AuthToken, ec: ExecutionContext): resume = new resume(ws.url(BASE_URL + s"b/${bucket}/anywhereCaches/${anywhereCacheId}/resume").addQueryStringParameters())
		...
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withAnywhereCache(body: Schema.AnywhereCache) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
		}
		object insert {
			def apply(bucket: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(ws.url(BASE_URL + s"b/${bucket}/anywhereCaches").addQueryStringParameters())
		}
		class pause(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AnywhereCache]) {
			def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.AnywhereCache])
		}
		object pause {
			def apply(bucket: String, anywhereCacheId: String)(using auth: AuthToken, ec: ExecutionContext): pause = new pause(ws.url(BASE_URL + s"b/${bucket}/anywhereCaches/${anywhereCacheId}/pause").addQueryStringParameters())
		...
		object disable {
			def apply(bucket: String, anywhereCacheId: String)(using auth: AuthToken, ec: ExecutionContext): disable = new disable(ws.url(BASE_URL + s"b/${bucket}/anywhereCaches/${anywhereCacheId}/disable").addQueryStringParameters())
		...
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AnywhereCache]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AnywhereCache])
		}
		object get {
			def apply(bucket: String, anywhereCacheId: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"b/${bucket}/anywhereCaches/${anywhereCacheId}").addQueryStringParameters())
			given Conversion[get, Future[Schema.AnywhereCache]] = (fun: get) => fun.apply()
		}
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withAnywhereCache(body: Schema.AnywhereCache) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.GoogleLongrunningOperation])
		}
		object update {
			def apply(bucket: String, anywhereCacheId: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"b/${bucket}/anywhereCaches/${anywhereCacheId}").addQueryStringParameters())
		}
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.AnywhereCaches]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.AnywhereCaches])
		}
		object list {
			def apply(bucket: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"b/${bucket}/anywhereCaches").addQueryStringParameters("pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
			given Conversion[list, Future[Schema.AnywhereCaches]] = (fun: list) => fun.apply()
		}
	}
	object bucketAccessControls {
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withBucketAccessControl(body: Schema.BucketAccessControl) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.BucketAccessControl])
		}
		object insert {
			def apply(bucket: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(ws.url(BASE_URL + s"b/${bucket}/acl").addQueryStringParameters("userProject" -> userProject.toString))
		}
		...
		object delete {
			def apply(bucket: String, entity: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"b/${bucket}/acl/${entity}").addQueryStringParameters("userProject" -> userProject.toString))
		...
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.BucketAccessControl]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.BucketAccessControl])
		}
		object get {
			def apply(bucket: String, entity: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"b/${bucket}/acl/${entity}").addQueryStringParameters("userProject" -> userProject.toString))
			given Conversion[get, Future[Schema.BucketAccessControl]] = (fun: get) => fun.apply()
		}
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withBucketAccessControl(body: Schema.BucketAccessControl) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.BucketAccessControl])
		}
		object update {
			def apply(bucket: String, entity: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"b/${bucket}/acl/${entity}").addQueryStringParameters("userProject" -> userProject.toString))
		}
		class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withBucketAccessControl(body: Schema.BucketAccessControl) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.BucketAccessControl])
		}
		object patch {
			def apply(bucket: String, entity: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(ws.url(BASE_URL + s"b/${bucket}/acl/${entity}").addQueryStringParameters("userProject" -> userProject.toString))
		}
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.BucketAccessControls]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.BucketAccessControls])
		}
		object list {
			def apply(bucket: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"b/${bucket}/acl").addQueryStringParameters("userProject" -> userProject.toString))
	...
	object buckets {
		class testIamPermissions(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.TestIamPermissionsResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.TestIamPermissionsResponse])
		}
		object testIamPermissions {
			def apply(bucket: String, permissions: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): testIamPermissions = new testIamPermissions(ws.url(BASE_URL + s"b/${bucket}/iam/testPermissions").addQueryStringParameters("permissions" -> permissions.toString, "userProject" -> userProject.toString))
			given Conversion[testIamPermissions, Future[Schema.TestIamPermissionsResponse]] = (fun: testIamPermissions) => fun.apply()
		}
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withBucket(body: Schema.Bucket) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Bucket])
		}
		object insert {
		...
		object restore {
			def apply(bucket: String, generation: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): restore = new restore(ws.url(BASE_URL + s"b/${bucket}/restore").addQueryStringParameters("generation" -> generation.toString, "userProject" -> userProject.toString))
		...
		object setIamPolicy {
			def apply(bucket: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): setIamPolicy = new setIamPolicy(ws.url(BASE_URL + s"b/${bucket}/iam").addQueryStringParameters("userProject" -> userProject.toString))
		}
		class relocate(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withRelocateBucketRequest(body: Schema.RelocateBucketRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
		}
		object relocate {
			def apply(bucket: String)(using auth: AuthToken, ec: ExecutionContext): relocate = new relocate(ws.url(BASE_URL + s"b/${bucket}/relocate").addQueryStringParameters())
		}
		...
		class getStorageLayout(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.BucketStorageLayout]) {
			...
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.BucketStorageLayout])
		}
		object getStorageLayout {
			def apply(bucket: String)(using auth: AuthToken, ec: ExecutionContext): getStorageLayout = new getStorageLayout(ws.url(BASE_URL + s"b/${bucket}/storageLayout").addQueryStringParameters())
		...
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withBucket(body: Schema.Bucket) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.Bucket])
		}
		object update {
		...
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Buckets]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.Buckets])
		}
		object list {
		...
		class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withBucket(body: Schema.Bucket) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.Bucket])
		}
		object patch {
		...
		class lockRetentionPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Bucket]) {
			def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.Bucket])
		}
	...
	object operations {
		...
		object cancel {
			def apply(bucket: String, operationId: String)(using auth: AuthToken, ec: ExecutionContext): cancel = new cancel(ws.url(BASE_URL + s"b/${bucket}/operations/${operationId}/cancel").addQueryStringParameters())
		...
		object get {
			def apply(bucket: String, operationId: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"b/${bucket}/operations/${operationId}").addQueryStringParameters())
		...
		class advanceRelocateBucket(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withAdvanceRelocateBucketOperationRequest(body: Schema.AdvanceRelocateBucketOperationRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_ => ())
		}
		object advanceRelocateBucket {
			def apply(bucket: String, operationId: String)(using auth: AuthToken, ec: ExecutionContext): advanceRelocateBucket = new advanceRelocateBucket(ws.url(BASE_URL + s"b/${bucket}/operations/${operationId}/advanceRelocateBucket").addQueryStringParameters())
		}
		...
		object list {
			def apply(filter: String, bucket: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"b/${bucket}/operations").addQueryStringParameters("filter" -> filter.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
	...
	object defaultObjectAccessControls {
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withObjectAccessControl(body: Schema.ObjectAccessControl) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.ObjectAccessControl])
		}
		object insert {
			def apply(bucket: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(ws.url(BASE_URL + s"b/${bucket}/defaultObjectAcl").addQueryStringParameters("userProject" -> userProject.toString))
		}
		class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Unit]) {
			def apply() = auth.exec(req,_.execute("DELETE")).map(_ => ())
		}
		object delete {
			def apply(bucket: String, entity: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"b/${bucket}/defaultObjectAcl/${entity}").addQueryStringParameters("userProject" -> userProject.toString))
			given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
		}
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ObjectAccessControl]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ObjectAccessControl])
		}
		object get {
			def apply(bucket: String, entity: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"b/${bucket}/defaultObjectAcl/${entity}").addQueryStringParameters("userProject" -> userProject.toString))
			given Conversion[get, Future[Schema.ObjectAccessControl]] = (fun: get) => fun.apply()
		}
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withObjectAccessControl(body: Schema.ObjectAccessControl) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.ObjectAccessControl])
		}
		object update {
			def apply(bucket: String, entity: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"b/${bucket}/defaultObjectAcl/${entity}").addQueryStringParameters("userProject" -> userProject.toString))
		}
		class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withObjectAccessControl(body: Schema.ObjectAccessControl) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.ObjectAccessControl])
		}
		object patch {
			def apply(bucket: String, entity: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(ws.url(BASE_URL + s"b/${bucket}/defaultObjectAcl/${entity}").addQueryStringParameters("userProject" -> userProject.toString))
		}
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ObjectAccessControls]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ObjectAccessControls])
		}
		object list {
	...
	object folders {
		...
		object insert {
			def apply(bucket: String, recursive: Boolean)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(ws.url(BASE_URL + s"b/${bucket}/folders").addQueryStringParameters("recursive" -> recursive.toString))
		}
		class rename(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleLongrunningOperation]) {
			def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
		}
		object rename {
		...
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Folders]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.Folders])
		}
		object list {
	...
	object managedFolders {
		...
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withManagedFolder(body: Schema.ManagedFolder) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.ManagedFolder])
		}
		object insert {
			def apply(bucket: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(ws.url(BASE_URL + s"b/${bucket}/managedFolders").addQueryStringParameters())
		}
		class setIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withPolicy(body: Schema.Policy) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.Policy])
		}
		object setIamPolicy {
			def apply(bucket: String, managedFolder: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): setIamPolicy = new setIamPolicy(ws.url(BASE_URL + s"b/${bucket}/managedFolders/${managedFolder}/iam").addQueryStringParameters("userProject" -> userProject.toString))
		}
		class getIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Policy]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.Policy])
		}
		...
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ManagedFolder]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ManagedFolder])
		}
		object get {
		...
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ManagedFolders]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ManagedFolders])
		}
		object list {
			def apply(bucket: String, pageSize: Int, pageToken: String, prefix: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"b/${bucket}/managedFolders").addQueryStringParameters("pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString, "prefix" -> prefix.toString))
	...
	object notifications {
		...
		object delete {
			def apply(bucket: String, notification: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"b/${bucket}/notificationConfigs/${notification}").addQueryStringParameters("userProject" -> userProject.toString))
			given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
		}
		...
		object get {
			def apply(bucket: String, notification: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"b/${bucket}/notificationConfigs/${notification}").addQueryStringParameters("userProject" -> userProject.toString))
			given Conversion[get, Future[Schema.Notification]] = (fun: get) => fun.apply()
		}
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withNotification(body: Schema.Notification) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Notification])
		}
		object insert {
			def apply(bucket: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(ws.url(BASE_URL + s"b/${bucket}/notificationConfigs").addQueryStringParameters("userProject" -> userProject.toString))
		}
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Notifications]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.Notifications])
		}
		object list {
			def apply(bucket: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"b/${bucket}/notificationConfigs").addQueryStringParameters("userProject" -> userProject.toString))
	...
	object objectAccessControls {
		...
		object insert {
			def apply(bucket: String, generation: String, `object`: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): insert = new insert(ws.url(BASE_URL + s"b/${bucket}/o/${`object`}/acl").addQueryStringParameters("generation" -> generation.toString, "userProject" -> userProject.toString))
		}
		class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Unit]) {
			def apply() = auth.exec(req,_.execute("DELETE")).map(_ => ())
		}
		object delete {
			def apply(bucket: String, entity: String, generation: String, `object`: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"b/${bucket}/o/${`object`}/acl/${entity}").addQueryStringParameters("generation" -> generation.toString, "userProject" -> userProject.toString))
			given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
		}
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ObjectAccessControl]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ObjectAccessControl])
		...
		object get {
			def apply(bucket: String, entity: String, generation: String, `object`: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"b/${bucket}/o/${`object`}/acl/${entity}").addQueryStringParameters("generation" -> generation.toString, "userProject" -> userProject.toString))
			given Conversion[get, Future[Schema.ObjectAccessControl]] = (fun: get) => fun.apply()
		}
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withObjectAccessControl(body: Schema.ObjectAccessControl) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.ObjectAccessControl])
		...
		object update {
			def apply(bucket: String, entity: String, generation: String, `object`: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"b/${bucket}/o/${`object`}/acl/${entity}").addQueryStringParameters("generation" -> generation.toString, "userProject" -> userProject.toString))
		}
		class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withObjectAccessControl(body: Schema.ObjectAccessControl) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.ObjectAccessControl])
		}
		object patch {
			def apply(bucket: String, entity: String, generation: String, `object`: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(ws.url(BASE_URL + s"b/${bucket}/o/${`object`}/acl/${entity}").addQueryStringParameters("generation" -> generation.toString, "userProject" -> userProject.toString))
		}
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ObjectAccessControls]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ObjectAccessControls])
		}
		object list {
			def apply(bucket: String, generation: String, `object`: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"b/${bucket}/o/${`object`}/acl").addQueryStringParameters("generation" -> generation.toString, "userProject" -> userProject.toString))
			given Conversion[list, Future[Schema.ObjectAccessControls]] = (fun: list) => fun.apply()
		}
	}
	object objects {
		class compose(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withComposeRequest(body: Schema.ComposeRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Object])
		}
		object compose {
		...
		class insert(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withObject(body: Schema.Object) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Object])
		}
		object insert {
		...
		class restore(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Object]) {
			...
			def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.Object])
		}
		object restore {
		...
		object setIamPolicy {
			def apply(bucket: String, generation: String, `object`: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): setIamPolicy = new setIamPolicy(ws.url(BASE_URL + s"b/${bucket}/o/${`object`}/iam").addQueryStringParameters("generation" -> generation.toString, "userProject" -> userProject.toString))
		}
		class getIamPolicy(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Policy]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.Policy])
		}
		object getIamPolicy {
			def apply(bucket: String, generation: String, `object`: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): getIamPolicy = new getIamPolicy(ws.url(BASE_URL + s"b/${bucket}/o/${`object`}/iam").addQueryStringParameters("generation" -> generation.toString, "userProject" -> userProject.toString))
			given Conversion[getIamPolicy, Future[Schema.Policy]] = (fun: getIamPolicy) => fun.apply()
		}
		class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Unit]) {
			def apply() = auth.exec(req,_.execute("DELETE")).map(_ => ())
		...
		class rewrite(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withObject(body: Schema.Object) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.RewriteResponse])
		}
		object rewrite {
		...
		class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Object]) {
			...
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.Object])
		}
		object get {
		...
		class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withObject(body: Schema.Object) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.Object])
		}
		object update {
		...
		class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withObject(body: Schema.Object) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PATCH")).map(_.json.as[Schema.Object])
		}
		object patch {
		...
		class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Objects]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.Objects])
		}
		object list {
		...
		class bulkRestore(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			def withBulkRestoreObjectsRequest(body: Schema.BulkRestoreObjectsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.GoogleLongrunningOperation])
		}
		object bulkRestore {
			def apply(bucket: String)(using auth: AuthToken, ec: ExecutionContext): bulkRestore = new bulkRestore(ws.url(BASE_URL + s"b/${bucket}/o/bulkRestore").addQueryStringParameters())
		}
		class testIamPermissions(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.TestIamPermissionsResponse]) {
			def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.TestIamPermissionsResponse])
		}
	...
	object projects {
		object hmacKeys {
			class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.HmacKey]) {
				def apply() = auth.exec(req,_.execute("POST")).map(_.json.as[Schema.HmacKey])
			}
			object create {
				def apply(projectId: String, serviceAccountEmail: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"projects/${projectId}/hmacKeys").addQueryStringParameters("serviceAccountEmail" -> serviceAccountEmail.toString, "userProject" -> userProject.toString))
			...
			object delete {
				def apply(accessId: String, projectId: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"projects/${projectId}/hmacKeys/${accessId}").addQueryStringParameters("userProject" -> userProject.toString))
				given Conversion[delete, Future[Unit]] = (fun: delete) => fun.apply()
			}
			class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.HmacKeyMetadata]) {
				def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.HmacKeyMetadata])
			}
			object get {
				def apply(accessId: String, projectId: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"projects/${projectId}/hmacKeys/${accessId}").addQueryStringParameters("userProject" -> userProject.toString))
				given Conversion[get, Future[Schema.HmacKeyMetadata]] = (fun: get) => fun.apply()
			}
			class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withHmacKeyMetadata(body: Schema.HmacKeyMetadata) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.HmacKeyMetadata])
			}
			object update {
				def apply(accessId: String, projectId: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"projects/${projectId}/hmacKeys/${accessId}").addQueryStringParameters("userProject" -> userProject.toString))
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.HmacKeysMetadata]) {
				def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.HmacKeysMetadata])
			}
			object list {
		...
		object serviceAccount {
			...
			object get {
				def apply(projectId: String, userProject: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"projects/${projectId}/serviceAccount").addQueryStringParameters("userProject" -> userProject.toString))
