...
class Api @Inject() (ws: WSClient) extends PlayApi {
	...
	object accounts {
		object finalizedProposals {
			...
			class pause(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withPauseProposalDealsRequest(body: Schema.PauseProposalDealsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Proposal])
			}
			object pause {
				def apply(accountId: String, proposalId: String)(using auth: AuthToken, ec: ExecutionContext): pause = new pause(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/finalizedProposals/${proposalId}:pause").addQueryStringParameters())
			}
			class resume(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withResumeProposalDealsRequest(body: Schema.ResumeProposalDealsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Proposal])
			}
			object resume {
				def apply(accountId: String, proposalId: String)(using auth: AuthToken, ec: ExecutionContext): resume = new resume(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/finalizedProposals/${proposalId}:resume").addQueryStringParameters())
			}
		}
		object clients {
			...
			object create {
				def apply(accountId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/clients").addQueryStringParameters())
			}
			...
			object get {
				def apply(accountId: String, clientAccountId: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/clients/${clientAccountId}").addQueryStringParameters())
			...
			object update {
				def apply(accountId: String, clientAccountId: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/clients/${clientAccountId}").addQueryStringParameters())
			}
			...
			object list {
				def apply(accountId: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/clients").addQueryStringParameters("pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
			...
			object users {
				...
				object list {
					def apply(accountId: String, clientAccountId: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/clients/${clientAccountId}/users").addQueryStringParameters("pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
					given Conversion[list, Future[Schema.ListClientUsersResponse]] = (fun: list) => fun.apply()
				}
				class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withClientUser(body: Schema.ClientUser) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.ClientUser])
				}
				object update {
					def apply(accountId: String, clientAccountId: String, userId: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/clients/${clientAccountId}/users/${userId}").addQueryStringParameters())
				}
				...
				object get {
					def apply(accountId: String, clientAccountId: String, userId: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/clients/${clientAccountId}/users/${userId}").addQueryStringParameters())
					given Conversion[get, Future[Schema.ClientUser]] = (fun: get) => fun.apply()
				}
			}
			object invitations {
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withClientUserInvitation(body: Schema.ClientUserInvitation) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.ClientUserInvitation])
				}
				object create {
					def apply(accountId: String, clientAccountId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/clients/${clientAccountId}/invitations").addQueryStringParameters())
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ClientUserInvitation]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ClientUserInvitation])
				}
				object get {
					def apply(accountId: String, clientAccountId: String, invitationId: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/clients/${clientAccountId}/invitations/${invitationId}").addQueryStringParameters())
				...
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListClientUserInvitationsResponse]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListClientUserInvitationsResponse])
				}
				object list {
					def apply(accountId: String, clientAccountId: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/clients/${clientAccountId}/invitations").addQueryStringParameters("pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
		...
		object products {
			...
			object get {
				def apply(accountId: String, productId: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/products/${productId}").addQueryStringParameters())
			...
			object list {
				def apply(accountId: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/products").addQueryStringParameters("pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
		...
		object creatives {
			class stopWatching(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withStopWatchingCreativeRequest(body: Schema.StopWatchingCreativeRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Empty])
			}
			object stopWatching {
				def apply(accountId: String, creativeId: String)(using auth: AuthToken, ec: ExecutionContext): stopWatching = new stopWatching(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/creatives/${creativeId}:stopWatching").addQueryStringParameters())
			}
			class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withCreative(body: Schema.Creative) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.Creative])
			}
			object update {
				def apply(accountId: String, creativeId: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/creatives/${creativeId}").addQueryStringParameters())
			}
			...
			object list {
				def apply(accountId: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/creatives").addQueryStringParameters("pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
			...
			class watch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withWatchCreativeRequest(body: Schema.WatchCreativeRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Empty])
			}
			object watch {
				def apply(accountId: String, creativeId: String)(using auth: AuthToken, ec: ExecutionContext): watch = new watch(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/creatives/${creativeId}:watch").addQueryStringParameters())
			}
			class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
			...
			object create {
				def apply(accountId: String, duplicateIdMode: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/creatives").addQueryStringParameters("duplicateIdMode" -> duplicateIdMode.toString))
			}
			...
			object get {
				def apply(accountId: String, creativeId: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/creatives/${creativeId}").addQueryStringParameters())
			...
			object dealAssociations {
				class add(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withAddDealAssociationRequest(body: Schema.AddDealAssociationRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Empty])
				}
				object add {
					def apply(accountId: String, creativeId: String)(using auth: AuthToken, ec: ExecutionContext): add = new add(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/creatives/${creativeId}/dealAssociations:add").addQueryStringParameters())
				}
				class remove(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withRemoveDealAssociationRequest(body: Schema.RemoveDealAssociationRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Empty])
				}
				object remove {
					def apply(accountId: String, creativeId: String)(using auth: AuthToken, ec: ExecutionContext): remove = new remove(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/creatives/${creativeId}/dealAssociations:remove").addQueryStringParameters())
				}
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListDealAssociationsResponse]) {
					...
					def withQuery(query: String) = new list(req.addQueryStringParameters("query" -> query.toString))
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListDealAssociationsResponse])
				}
				object list {
					def apply(accountId: String, creativeId: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/creatives/${creativeId}/dealAssociations").addQueryStringParameters("pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
		...
		object publisherProfiles {
			...
			object get {
				def apply(accountId: String, publisherProfileId: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/publisherProfiles/${publisherProfileId}").addQueryStringParameters())
			...
			object list {
				def apply(accountId: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/publisherProfiles").addQueryStringParameters("pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
		...
		object proposals {
			...
			object cancelNegotiation {
				def apply(accountId: String, proposalId: String)(using auth: AuthToken, ec: ExecutionContext): cancelNegotiation = new cancelNegotiation(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/proposals/${proposalId}:cancelNegotiation").addQueryStringParameters())
			}
			class completeSetup(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withCompleteSetupRequest(body: Schema.CompleteSetupRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Proposal])
			}
			object completeSetup {
				def apply(accountId: String, proposalId: String)(using auth: AuthToken, ec: ExecutionContext): completeSetup = new completeSetup(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/proposals/${proposalId}:completeSetup").addQueryStringParameters())
			}
			...
			object get {
				def apply(accountId: String, proposalId: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/proposals/${proposalId}").addQueryStringParameters())
				given Conversion[get, Future[Schema.Proposal]] = (fun: get) => fun.apply()
			}
			class update(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withProposal(body: Schema.Proposal) = auth.exec(req.withBody(Json.toJson(body)),_.execute("PUT")).map(_.json.as[Schema.Proposal])
			}
			object update {
				def apply(accountId: String, proposalId: String)(using auth: AuthToken, ec: ExecutionContext): update = new update(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/proposals/${proposalId}").addQueryStringParameters())
			}
			class resume(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withResumeProposalRequest(body: Schema.ResumeProposalRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Proposal])
			}
			object resume {
				def apply(accountId: String, proposalId: String)(using auth: AuthToken, ec: ExecutionContext): resume = new resume(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/proposals/${proposalId}:resume").addQueryStringParameters())
			}
			...
			object accept {
				def apply(accountId: String, proposalId: String)(using auth: AuthToken, ec: ExecutionContext): accept = new accept(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/proposals/${proposalId}:accept").addQueryStringParameters())
			}
			class pause(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withPauseProposalRequest(body: Schema.PauseProposalRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Proposal])
			}
			object pause {
				def apply(accountId: String, proposalId: String)(using auth: AuthToken, ec: ExecutionContext): pause = new pause(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/proposals/${proposalId}:pause").addQueryStringParameters())
			}
			class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withProposal(body: Schema.Proposal) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Proposal])
			}
			object create {
				def apply(accountId: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/proposals").addQueryStringParameters())
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListProposalsResponse]) {
				/** An optional PQL filter query used to query for proposals. Nested repeated fields, such as proposal.deals.targetingCriterion, cannot be filtered. */
				def withFilter(filter: String) = new list(req.addQueryStringParameters("filter" -> filter.toString))
			...
			class addNote(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withAddNoteRequest(body: Schema.AddNoteRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Note])
			}
			object addNote {
				def apply(accountId: String, proposalId: String)(using auth: AuthToken, ec: ExecutionContext): addNote = new addNote(ws.url(BASE_URL + s"v2beta1/accounts/${accountId}/proposals/${proposalId}:addNote").addQueryStringParameters())
			}
		}
	}
	object bidders {
		object accounts {
			object filterSets {
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.FilterSet]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.FilterSet])
				}
				object get {
					def apply(biddersId :PlayApi, accountsId :PlayApi, filterSetsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v2beta1/bidders/${biddersId}/accounts/${accountsId}/filterSets/${filterSetsId}").addQueryStringParameters("name" -> name.toString))
				...
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListFilterSetsResponse]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListFilterSetsResponse])
				}
				object list {
				...
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withFilterSet(body: Schema.FilterSet) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.FilterSet])
				}
				object create {
				...
				object delete {
					def apply(biddersId :PlayApi, accountsId :PlayApi, filterSetsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v2beta1/bidders/${biddersId}/accounts/${accountsId}/filterSets/${filterSetsId}").addQueryStringParameters("name" -> name.toString))
				...
				object bidResponseErrors {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListBidResponseErrorsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListBidResponseErrorsResponse])
					}
					object list {
				...
				object bidMetrics {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListBidMetricsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListBidMetricsResponse])
					}
					object list {
				...
				object filteredBids {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListFilteredBidsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListFilteredBidsResponse])
					}
					object list {
					...
					object details {
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListCreativeStatusBreakdownByDetailResponse]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListCreativeStatusBreakdownByDetailResponse])
						}
						object list {
					...
					object creatives {
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListCreativeStatusBreakdownByCreativeResponse]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListCreativeStatusBreakdownByCreativeResponse])
						}
						object list {
				...
				object bidResponsesWithoutBids {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListBidResponsesWithoutBidsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListBidResponsesWithoutBidsResponse])
					}
					object list {
				...
				object filteredBidRequests {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListFilteredBidRequestsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListFilteredBidRequestsResponse])
					}
					object list {
				...
				object impressionMetrics {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListImpressionMetricsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListImpressionMetricsResponse])
					}
					object list {
				...
				object losingBids {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListLosingBidsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListLosingBidsResponse])
					}
					object list {
				...
				object nonBillableWinningBids {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListNonBillableWinningBidsResponse]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListNonBillableWinningBidsResponse])
					}
					object list {
		...
		object filterSets {
			...
			object get {
				def apply(biddersId :PlayApi, filterSetsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v2beta1/bidders/${biddersId}/filterSets/${filterSetsId}").addQueryStringParameters("name" -> name.toString))
				given Conversion[get, Future[Schema.FilterSet]] = (fun: get) => fun.apply()
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListFilterSetsResponse]) {
				def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListFilterSetsResponse])
			...
			object list {
				def apply(biddersId :PlayApi, ownerName: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v2beta1/bidders/${biddersId}/filterSets").addQueryStringParameters("ownerName" -> ownerName.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
				given Conversion[list, Future[Schema.ListFilterSetsResponse]] = (fun: list) => fun.apply()
			}
			class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withFilterSet(body: Schema.FilterSet) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.FilterSet])
			...
			object create {
				def apply(biddersId :PlayApi, ownerName: String, isTransient: Boolean)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v2beta1/bidders/${biddersId}/filterSets").addQueryStringParameters("ownerName" -> ownerName.toString, "isTransient" -> isTransient.toString))
			}
			class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Empty]) {
				def apply() = auth.exec(req,_.execute("DELETE")).map(_.json.as[Schema.Empty])
			}
			object delete {
				def apply(biddersId :PlayApi, filterSetsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v2beta1/bidders/${biddersId}/filterSets/${filterSetsId}").addQueryStringParameters("name" -> name.toString))
				given Conversion[delete, Future[Schema.Empty]] = (fun: delete) => fun.apply()
			}
			object bidResponseErrors {
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListBidResponseErrorsResponse]) {
	...
	object buyers {
		object filterSets {
			...
			object get {
				def apply(buyersId :PlayApi, filterSetsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v2beta1/buyers/${buyersId}/filterSets/${filterSetsId}").addQueryStringParameters("name" -> name.toString))
				given Conversion[get, Future[Schema.FilterSet]] = (fun: get) => fun.apply()
			}
			class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListFilterSetsResponse]) {
				def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListFilterSetsResponse])
			...
			object list {
				def apply(buyersId :PlayApi, ownerName: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v2beta1/buyers/${buyersId}/filterSets").addQueryStringParameters("ownerName" -> ownerName.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
				given Conversion[list, Future[Schema.ListFilterSetsResponse]] = (fun: list) => fun.apply()
			}
			class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
				def withFilterSet(body: Schema.FilterSet) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.FilterSet])
			...
			object create {
				def apply(buyersId :PlayApi, ownerName: String, isTransient: Boolean)(using auth: AuthToken, ec: ExecutionContext): create = new create(ws.url(BASE_URL + s"v2beta1/buyers/${buyersId}/filterSets").addQueryStringParameters("ownerName" -> ownerName.toString, "isTransient" -> isTransient.toString))
			}
			class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.Empty]) {
				def apply() = auth.exec(req,_.execute("DELETE")).map(_.json.as[Schema.Empty])
			}
			object delete {
				def apply(buyersId :PlayApi, filterSetsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v2beta1/buyers/${buyersId}/filterSets/${filterSetsId}").addQueryStringParameters("name" -> name.toString))
				given Conversion[delete, Future[Schema.Empty]] = (fun: delete) => fun.apply()
			}
			object bidResponseErrors {
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListBidResponseErrorsResponse]) {
