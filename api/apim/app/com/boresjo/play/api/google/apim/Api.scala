	...
	object projects {
		object locations {
			class listApiObservationTags(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListApiObservationTagsResponse]) {
				...
				def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListApiObservationTagsResponse])
			}
			object listApiObservationTags {
				def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): listApiObservationTags = new listApiObservationTags(ws.url(BASE_URL + s"v1alpha/projects/${projectsId}/locations/${locationsId}:listApiObservationTags").addQueryStringParameters("parent" -> parent.toString))
			...
			object get {
				def apply(projectsId :PlayApi, locationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1alpha/projects/${projectsId}/locations/${locationsId}").addQueryStringParameters("name" -> name.toString))
			...
			object operations {
				...
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, operationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1alpha/projects/${projectsId}/locations/${locationsId}/operations/${operationsId}").addQueryStringParameters("name" -> name.toString))
				...
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, operationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1alpha/projects/${projectsId}/locations/${locationsId}/operations/${operationsId}").addQueryStringParameters("name" -> name.toString))
				...
				object cancel {
					def apply(projectsId :PlayApi, locationsId :PlayApi, operationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): cancel = new cancel(ws.url(BASE_URL + s"v1alpha/projects/${projectsId}/locations/${locationsId}/operations/${operationsId}:cancel").addQueryStringParameters("name" -> name.toString))
				}
			}
			object observationJobs {
				class enable(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withEnableObservationJobRequest(body: Schema.EnableObservationJobRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object enable {
					def apply(projectsId :PlayApi, locationsId :PlayApi, observationJobsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): enable = new enable(ws.url(BASE_URL + s"v1alpha/projects/${projectsId}/locations/${locationsId}/observationJobs/${observationJobsId}:enable").addQueryStringParameters("name" -> name.toString))
				}
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					def withObservationJob(body: Schema.ObservationJob) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object create {
				...
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, observationJobsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1alpha/projects/${projectsId}/locations/${locationsId}/observationJobs/${observationJobsId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.Operation]] = (fun: delete) => fun.apply()
				}
				class disable(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withDisableObservationJobRequest(body: Schema.DisableObservationJobRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object disable {
				...
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ObservationJob]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ObservationJob])
				}
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, observationJobsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1alpha/projects/${projectsId}/locations/${locationsId}/observationJobs/${observationJobsId}").addQueryStringParameters("name" -> name.toString))
				...
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListObservationJobsResponse]) {
					...
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListObservationJobsResponse])
				}
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1alpha/projects/${projectsId}/locations/${locationsId}/observationJobs").addQueryStringParameters("parent" -> parent.toString))
				...
				object apiObservations {
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ApiObservation]) {
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ApiObservation])
					}
					object get {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListApiObservationsResponse]) {
						...
						def withPageToken(pageToken: String) = new list(req.addQueryStringParameters("pageToken" -> pageToken.toString))
						def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListApiObservationsResponse])
					}
					object list {
					...
					class batchEditTags(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withBatchEditTagsApiObservationsRequest(body: Schema.BatchEditTagsApiObservationsRequest) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.BatchEditTagsApiObservationsResponse])
					}
					...
					object apiOperations {
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ApiOperation]) {
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ApiOperation])
						}
						object get {
						...
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListApiOperationsResponse]) {
							...
							def withPageToken(pageToken: String) = new list(req.addQueryStringParameters("pageToken" -> pageToken.toString))
							def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListApiOperationsResponse])
						}
						object list {
			...
			object observationSources {
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					/** Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000). */
					def withRequestId(requestId: String) = new create(req.addQueryStringParameters("requestId" -> requestId.toString))
					def withObservationSource(body: Schema.ObservationSource) = auth.exec(req.withBody(Json.toJson(body)),_.execute("POST")).map(_.json.as[Schema.Operation])
				}
				object create {
				...
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ObservationSource]) {
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ObservationSource])
				}
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, observationSourcesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(ws.url(BASE_URL + s"v1alpha/projects/${projectsId}/locations/${locationsId}/observationSources/${observationSourcesId}").addQueryStringParameters("name" -> name.toString))
				...
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.ListObservationSourcesResponse]) {
					...
					def withPageToken(pageToken: String) = new list(req.addQueryStringParameters("pageToken" -> pageToken.toString))
					def apply() = auth.exec(req,_.execute("GET")).map(_.json.as[Schema.ListObservationSourcesResponse])
				}
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(ws.url(BASE_URL + s"v1alpha/projects/${projectsId}/locations/${locationsId}/observationSources").addQueryStringParameters("parent" -> parent.toString))
				...
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, observationSourcesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(ws.url(BASE_URL + s"v1alpha/projects/${projectsId}/locations/${locationsId}/observationSources/${observationSourcesId}").addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.Operation]] = (fun: delete) => fun.apply()
				}
			}
		}
