...
class Api @Inject() (ws: WSClient) extends PlayApi {
	...
	object projects {
		object operations {
			...
			object list {
				def apply(projectsId :PlayApi, name: String, filter: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/operations")).addQueryStringParameters("name" -> name.toString, "filter" -> filter.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
			...
			object get {
				def apply(projectsId :PlayApi, operationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/operations/${operationsId}")).addQueryStringParameters("name" -> name.toString))
			...
			object cancel {
				def apply(projectsId :PlayApi, operationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): cancel = new cancel(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/operations/${operationsId}:cancel")).addQueryStringParameters("name" -> name.toString))
		...
		object locations {
			...
			object get {
				def apply(projectsId :PlayApi, locationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}")).addQueryStringParameters("name" -> name.toString))
			...
			object list {
				def apply(projectsId :PlayApi, name: String, filter: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations")).addQueryStringParameters("name" -> name.toString, "filter" -> filter.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
			...
			object operations {
				...
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, name: String, filter: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/operations")).addQueryStringParameters("name" -> name.toString, "filter" -> filter.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
					given Conversion[list, Future[Schema.GoogleLongrunningListOperationsResponse]] = (fun: list) => fun.apply()
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleLongrunningOperation]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleLongrunningOperation])
				...
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, operationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/operations/${operationsId}")).addQueryStringParameters("name" -> name.toString))
					given Conversion[get, Future[Schema.GoogleLongrunningOperation]] = (fun: get) => fun.apply()
				}
				class cancel(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
					def apply() = req.execute("POST").map(_.json.as[Schema.GoogleProtobufEmpty])
				...
				object cancel {
					def apply(projectsId :PlayApi, locationsId :PlayApi, operationsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): cancel = new cancel(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/operations/${operationsId}:cancel")).addQueryStringParameters("name" -> name.toString))
					given Conversion[cancel, Future[Schema.GoogleProtobufEmpty]] = (fun: cancel) => fun.apply()
				}
			}
			object agents {
				class updateGenerativeSettings(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					def withGoogleCloudDialogflowCxV3GenerativeSettings(body: Schema.GoogleCloudDialogflowCxV3GenerativeSettings) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleCloudDialogflowCxV3GenerativeSettings])
				}
				object updateGenerativeSettings {
					def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): updateGenerativeSettings = new updateGenerativeSettings(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/generativeSettings")).addQueryStringParameters("name" -> name.toString))
				}
				class restore(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudDialogflowCxV3RestoreAgentRequest(body: Schema.GoogleCloudDialogflowCxV3RestoreAgentRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
				}
				object restore {
					def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): restore = new restore(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}:restore")).addQueryStringParameters("name" -> name.toString))
				}
				class validate(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudDialogflowCxV3ValidateAgentRequest(body: Schema.GoogleCloudDialogflowCxV3ValidateAgentRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3AgentValidationResult])
				}
				object validate {
					def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): validate = new validate(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}:validate")).addQueryStringParameters("name" -> name.toString))
				}
				...
				class `export`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudDialogflowCxV3ExportAgentRequest(body: Schema.GoogleCloudDialogflowCxV3ExportAgentRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
				}
				object `export` {
					def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): `export` = new `export`(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}:export")).addQueryStringParameters("name" -> name.toString))
				}
				class getValidationResult(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3AgentValidationResult]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3AgentValidationResult])
				}
				object getValidationResult {
					def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, name: String, languageCode: String)(using auth: AuthToken, ec: ExecutionContext): getValidationResult = new getValidationResult(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/validationResult")).addQueryStringParameters("name" -> name.toString, "languageCode" -> languageCode.toString))
				...
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}")).addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.GoogleProtobufEmpty]] = (fun: delete) => fun.apply()
				}
				class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudDialogflowCxV3Agent(body: Schema.GoogleCloudDialogflowCxV3Agent) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Agent])
				}
				object patch {
					def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}")).addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
				}
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudDialogflowCxV3Agent(body: Schema.GoogleCloudDialogflowCxV3Agent) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Agent])
				}
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents")).addQueryStringParameters("parent" -> parent.toString))
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3Agent]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Agent])
				}
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}")).addQueryStringParameters("name" -> name.toString))
				...
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3ListAgentsResponse]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3ListAgentsResponse])
				}
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
					given Conversion[list, Future[Schema.GoogleCloudDialogflowCxV3ListAgentsResponse]] = (fun: list) => fun.apply()
				}
				object environments {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3Environment(body: Schema.GoogleCloudDialogflowCxV3Environment) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object create {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/environments")).addQueryStringParameters("parent" -> parent.toString))
					}
					class runContinuousTest(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3RunContinuousTestRequest(body: Schema.GoogleCloudDialogflowCxV3RunContinuousTestRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object runContinuousTest {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, environmentsId :PlayApi, environment: String)(using auth: AuthToken, ec: ExecutionContext): runContinuousTest = new runContinuousTest(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/environments/${environmentsId}:runContinuousTest")).addQueryStringParameters("environment" -> environment.toString))
					}
					class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
						def apply() = req.execute("DELETE").map(_.json.as[Schema.GoogleProtobufEmpty])
					}
					object delete {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, environmentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/environments/${environmentsId}")).addQueryStringParameters("name" -> name.toString))
						given Conversion[delete, Future[Schema.GoogleProtobufEmpty]] = (fun: delete) => fun.apply()
					}
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3Environment]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Environment])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, environmentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/environments/${environmentsId}")).addQueryStringParameters("name" -> name.toString))
						given Conversion[get, Future[Schema.GoogleCloudDialogflowCxV3Environment]] = (fun: get) => fun.apply()
					}
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3Environment(body: Schema.GoogleCloudDialogflowCxV3Environment) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object patch {
					...
					class deployFlow(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3DeployFlowRequest(body: Schema.GoogleCloudDialogflowCxV3DeployFlowRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object deployFlow {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, environmentsId :PlayApi, environment: String)(using auth: AuthToken, ec: ExecutionContext): deployFlow = new deployFlow(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/environments/${environmentsId}:deployFlow")).addQueryStringParameters("environment" -> environment.toString))
					}
					...
					object experiments {
						class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudDialogflowCxV3Experiment(body: Schema.GoogleCloudDialogflowCxV3Experiment) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Experiment])
						}
						object create {
							def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, environmentsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/environments/${environmentsId}/experiments")).addQueryStringParameters("parent" -> parent.toString))
						}
						class stop(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudDialogflowCxV3StopExperimentRequest(body: Schema.GoogleCloudDialogflowCxV3StopExperimentRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Experiment])
						}
						object stop {
							def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, environmentsId :PlayApi, experimentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): stop = new stop(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/environments/${environmentsId}/experiments/${experimentsId}:stop")).addQueryStringParameters("name" -> name.toString))
						}
						class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
							def apply() = req.execute("DELETE").map(_.json.as[Schema.GoogleProtobufEmpty])
						}
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3Experiment]) {
							def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Experiment])
						}
						object get {
							def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, environmentsId :PlayApi, experimentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/environments/${environmentsId}/experiments/${experimentsId}")).addQueryStringParameters("name" -> name.toString))
						...
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3ListExperimentsResponse]) {
							def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3ListExperimentsResponse])
						}
						object list {
						...
						class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudDialogflowCxV3Experiment(body: Schema.GoogleCloudDialogflowCxV3Experiment) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Experiment])
						}
						object patch {
						...
						class start(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudDialogflowCxV3StartExperimentRequest(body: Schema.GoogleCloudDialogflowCxV3StartExperimentRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Experiment])
						}
						object start {
							def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, environmentsId :PlayApi, experimentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): start = new start(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/environments/${environmentsId}/experiments/${experimentsId}:start")).addQueryStringParameters("name" -> name.toString))
						}
					}
					object continuousTestResults {
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3ListContinuousTestResultsResponse]) {
							def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3ListContinuousTestResultsResponse])
						}
						object list {
					...
					object sessions {
						class matchIntent(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudDialogflowCxV3MatchIntentRequest(body: Schema.GoogleCloudDialogflowCxV3MatchIntentRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3MatchIntentResponse])
						}
						object matchIntent {
							def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, environmentsId :PlayApi, sessionsId :PlayApi, session: String)(using auth: AuthToken, ec: ExecutionContext): matchIntent = new matchIntent(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/environments/${environmentsId}/sessions/${sessionsId}:matchIntent")).addQueryStringParameters("session" -> session.toString))
						}
						class serverStreamingDetectIntent(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudDialogflowCxV3DetectIntentRequest(body: Schema.GoogleCloudDialogflowCxV3DetectIntentRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3DetectIntentResponse])
						}
						object serverStreamingDetectIntent {
							def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, environmentsId :PlayApi, sessionsId :PlayApi, session: String)(using auth: AuthToken, ec: ExecutionContext): serverStreamingDetectIntent = new serverStreamingDetectIntent(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/environments/${environmentsId}/sessions/${sessionsId}:serverStreamingDetectIntent")).addQueryStringParameters("session" -> session.toString))
						}
						class detectIntent(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudDialogflowCxV3DetectIntentRequest(body: Schema.GoogleCloudDialogflowCxV3DetectIntentRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3DetectIntentResponse])
						}
						object detectIntent {
							def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, environmentsId :PlayApi, sessionsId :PlayApi, session: String)(using auth: AuthToken, ec: ExecutionContext): detectIntent = new detectIntent(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/environments/${environmentsId}/sessions/${sessionsId}:detectIntent")).addQueryStringParameters("session" -> session.toString))
						}
						class fulfillIntent(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudDialogflowCxV3FulfillIntentRequest(body: Schema.GoogleCloudDialogflowCxV3FulfillIntentRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3FulfillIntentResponse])
						}
						object fulfillIntent {
							def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, environmentsId :PlayApi, sessionsId :PlayApi, session: String)(using auth: AuthToken, ec: ExecutionContext): fulfillIntent = new fulfillIntent(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/environments/${environmentsId}/sessions/${sessionsId}:fulfillIntent")).addQueryStringParameters("session" -> session.toString))
						}
						object entityTypes {
							class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
								def withGoogleCloudDialogflowCxV3SessionEntityType(body: Schema.GoogleCloudDialogflowCxV3SessionEntityType) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3SessionEntityType])
							}
							object create {
							...
							class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3SessionEntityType]) {
								def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3SessionEntityType])
							}
							object get {
								def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, environmentsId :PlayApi, sessionsId :PlayApi, entityTypesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/environments/${environmentsId}/sessions/${sessionsId}/entityTypes/${entityTypesId}")).addQueryStringParameters("name" -> name.toString))
							...
							class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
								def withGoogleCloudDialogflowCxV3SessionEntityType(body: Schema.GoogleCloudDialogflowCxV3SessionEntityType) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleCloudDialogflowCxV3SessionEntityType])
							}
							object patch {
							...
							class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3ListSessionEntityTypesResponse]) {
								def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3ListSessionEntityTypesResponse])
							}
							object list {
					...
					object deployments {
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3ListDeploymentsResponse]) {
							def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3ListDeploymentsResponse])
						}
						object list {
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3Deployment]) {
							def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Deployment])
						}
						object get {
				...
				object changelogs {
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3ListChangelogsResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3ListChangelogsResponse])
					}
					object list {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3Changelog]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Changelog])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, changelogsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/changelogs/${changelogsId}")).addQueryStringParameters("name" -> name.toString))
						given Conversion[get, Future[Schema.GoogleCloudDialogflowCxV3Changelog]] = (fun: get) => fun.apply()
					}
				}
				object webhooks {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3Webhook(body: Schema.GoogleCloudDialogflowCxV3Webhook) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Webhook])
					}
					object create {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/webhooks")).addQueryStringParameters("parent" -> parent.toString))
					}
					class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
						def apply() = req.execute("DELETE").map(_.json.as[Schema.GoogleProtobufEmpty])
					}
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3Webhook]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Webhook])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, webhooksId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/webhooks/${webhooksId}")).addQueryStringParameters("name" -> name.toString))
						given Conversion[get, Future[Schema.GoogleCloudDialogflowCxV3Webhook]] = (fun: get) => fun.apply()
					}
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3Webhook(body: Schema.GoogleCloudDialogflowCxV3Webhook) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Webhook])
					}
					object patch {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3ListWebhooksResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3ListWebhooksResponse])
					}
					object list {
				...
				object generators {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3Generator(body: Schema.GoogleCloudDialogflowCxV3Generator) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Generator])
					}
					object create {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3Generator]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Generator])
					}
					object get {
					...
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3Generator(body: Schema.GoogleCloudDialogflowCxV3Generator) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Generator])
					}
					object patch {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3ListGeneratorsResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3ListGeneratorsResponse])
					}
					object list {
				...
				object intents {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3Intent(body: Schema.GoogleCloudDialogflowCxV3Intent) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Intent])
					}
					object create {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, parent: String, languageCode: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/intents")).addQueryStringParameters("parent" -> parent.toString, "languageCode" -> languageCode.toString))
					}
					class `export`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3ExportIntentsRequest(body: Schema.GoogleCloudDialogflowCxV3ExportIntentsRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object `export` {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): `export` = new `export`(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/intents:export")).addQueryStringParameters("parent" -> parent.toString))
					}
					class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3ImportIntentsRequest(body: Schema.GoogleCloudDialogflowCxV3ImportIntentsRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object `import` {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): `import` = new `import`(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/intents:import")).addQueryStringParameters("parent" -> parent.toString))
					}
					class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
						def apply() = req.execute("DELETE").map(_.json.as[Schema.GoogleProtobufEmpty])
					}
					object delete {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, intentsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/intents/${intentsId}")).addQueryStringParameters("name" -> name.toString))
						given Conversion[delete, Future[Schema.GoogleProtobufEmpty]] = (fun: delete) => fun.apply()
					}
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3Intent]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Intent])
					}
					object get {
					...
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3Intent(body: Schema.GoogleCloudDialogflowCxV3Intent) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Intent])
					}
					object patch {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3ListIntentsResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3ListIntentsResponse])
					}
					object list {
				...
				object transitionRouteGroups {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3TransitionRouteGroup(body: Schema.GoogleCloudDialogflowCxV3TransitionRouteGroup) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3TransitionRouteGroup])
					}
					object create {
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3TransitionRouteGroup]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3TransitionRouteGroup])
					}
					object get {
					...
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3TransitionRouteGroup(body: Schema.GoogleCloudDialogflowCxV3TransitionRouteGroup) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleCloudDialogflowCxV3TransitionRouteGroup])
					}
					object patch {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponse])
					}
					object list {
				...
				object flows {
					class validate(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3ValidateFlowRequest(body: Schema.GoogleCloudDialogflowCxV3ValidateFlowRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3FlowValidationResult])
					}
					object validate {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, flowsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): validate = new validate(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/flows/${flowsId}:validate")).addQueryStringParameters("name" -> name.toString))
					}
					class `export`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3ExportFlowRequest(body: Schema.GoogleCloudDialogflowCxV3ExportFlowRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object `export` {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, flowsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): `export` = new `export`(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/flows/${flowsId}:export")).addQueryStringParameters("name" -> name.toString))
					}
					class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
						def apply() = req.execute("DELETE").map(_.json.as[Schema.GoogleProtobufEmpty])
					}
					...
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3Flow(body: Schema.GoogleCloudDialogflowCxV3Flow) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Flow])
					}
					object patch {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3ListFlowsResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3ListFlowsResponse])
					}
					object list {
					...
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3Flow(body: Schema.GoogleCloudDialogflowCxV3Flow) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Flow])
					}
					object create {
					...
					class getValidationResult(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3FlowValidationResult]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3FlowValidationResult])
					}
					object getValidationResult {
					...
					class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3ImportFlowRequest(body: Schema.GoogleCloudDialogflowCxV3ImportFlowRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object `import` {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): `import` = new `import`(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/flows:import")).addQueryStringParameters("parent" -> parent.toString))
					}
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3Flow]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Flow])
					}
					object get {
					...
					class train(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3TrainFlowRequest(body: Schema.GoogleCloudDialogflowCxV3TrainFlowRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object train {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, flowsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): train = new train(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/flows/${flowsId}:train")).addQueryStringParameters("name" -> name.toString))
					}
					object versions {
						class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudDialogflowCxV3Version(body: Schema.GoogleCloudDialogflowCxV3Version) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
						}
						object create {
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3Version]) {
							def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Version])
						}
						object get {
							def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, flowsId :PlayApi, versionsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/flows/${flowsId}/versions/${versionsId}")).addQueryStringParameters("name" -> name.toString))
						...
						class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudDialogflowCxV3Version(body: Schema.GoogleCloudDialogflowCxV3Version) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Version])
						}
						object patch {
						...
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3ListVersionsResponse]) {
							def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3ListVersionsResponse])
						}
						object list {
						...
						class load(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudDialogflowCxV3LoadVersionRequest(body: Schema.GoogleCloudDialogflowCxV3LoadVersionRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
						}
						object load {
							def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, flowsId :PlayApi, versionsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): load = new load(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/flows/${flowsId}/versions/${versionsId}:load")).addQueryStringParameters("name" -> name.toString))
						}
						class compareVersions(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudDialogflowCxV3CompareVersionsRequest(body: Schema.GoogleCloudDialogflowCxV3CompareVersionsRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3CompareVersionsResponse])
						}
						object compareVersions {
							def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, flowsId :PlayApi, versionsId :PlayApi, baseVersion: String)(using auth: AuthToken, ec: ExecutionContext): compareVersions = new compareVersions(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/flows/${flowsId}/versions/${versionsId}:compareVersions")).addQueryStringParameters("baseVersion" -> baseVersion.toString))
						}
					}
					object transitionRouteGroups {
						class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					...
					object pages {
						class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudDialogflowCxV3Page(body: Schema.GoogleCloudDialogflowCxV3Page) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Page])
						}
						object create {
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3Page]) {
							def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Page])
						}
						object get {
						...
						class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
							def withGoogleCloudDialogflowCxV3Page(body: Schema.GoogleCloudDialogflowCxV3Page) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleCloudDialogflowCxV3Page])
						}
						object patch {
						...
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3ListPagesResponse]) {
							def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3ListPagesResponse])
						}
						object list {
				...
				object sessions {
					...
					class submitAnswerFeedback(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3SubmitAnswerFeedbackRequest(body: Schema.GoogleCloudDialogflowCxV3SubmitAnswerFeedbackRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3AnswerFeedback])
					}
					object submitAnswerFeedback {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, sessionsId :PlayApi, session: String)(using auth: AuthToken, ec: ExecutionContext): submitAnswerFeedback = new submitAnswerFeedback(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/sessions/${sessionsId}:submitAnswerFeedback")).addQueryStringParameters("session" -> session.toString))
					}
					class serverStreamingDetectIntent(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3DetectIntentRequest(body: Schema.GoogleCloudDialogflowCxV3DetectIntentRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3DetectIntentResponse])
					}
				...
				object testCases {
					class run(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3RunTestCaseRequest(body: Schema.GoogleCloudDialogflowCxV3RunTestCaseRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object run {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, testCasesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): run = new run(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/testCases/${testCasesId}:run")).addQueryStringParameters("name" -> name.toString))
					}
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3TestCase(body: Schema.GoogleCloudDialogflowCxV3TestCase) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3TestCase])
					}
					object create {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/testCases")).addQueryStringParameters("parent" -> parent.toString))
					}
					class `export`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3ExportTestCasesRequest(body: Schema.GoogleCloudDialogflowCxV3ExportTestCasesRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object `export` {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): `export` = new `export`(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/testCases:export")).addQueryStringParameters("parent" -> parent.toString))
					}
					class batchDelete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3BatchDeleteTestCasesRequest(body: Schema.GoogleCloudDialogflowCxV3BatchDeleteTestCasesRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleProtobufEmpty])
					}
					object batchDelete {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): batchDelete = new batchDelete(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/testCases:batchDelete")).addQueryStringParameters("parent" -> parent.toString))
					}
					class batchRun(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3BatchRunTestCasesRequest(body: Schema.GoogleCloudDialogflowCxV3BatchRunTestCasesRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object batchRun {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): batchRun = new batchRun(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/testCases:batchRun")).addQueryStringParameters("parent" -> parent.toString))
					}
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3TestCase]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3TestCase])
					}
					object get {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, testCasesId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/testCases/${testCasesId}")).addQueryStringParameters("name" -> name.toString))
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3ListTestCasesResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3ListTestCasesResponse])
					}
					object list {
					...
					class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3ImportTestCasesRequest(body: Schema.GoogleCloudDialogflowCxV3ImportTestCasesRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object `import` {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): `import` = new `import`(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/testCases:import")).addQueryStringParameters("parent" -> parent.toString))
					}
					class calculateCoverage(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3CalculateCoverageResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3CalculateCoverageResponse])
					}
					object calculateCoverage {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, agent: String, `type`: String)(using auth: AuthToken, ec: ExecutionContext): calculateCoverage = new calculateCoverage(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/testCases:calculateCoverage")).addQueryStringParameters("agent" -> agent.toString, "type" -> `type`.toString))
					...
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3TestCase(body: Schema.GoogleCloudDialogflowCxV3TestCase) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleCloudDialogflowCxV3TestCase])
					}
					object patch {
					...
					object results {
						class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3ListTestCaseResultsResponse]) {
							def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3ListTestCaseResultsResponse])
						}
						object list {
						...
						class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3TestCaseResult]) {
							def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3TestCaseResult])
						}
						object get {
				...
				object entityTypes {
					class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3EntityType(body: Schema.GoogleCloudDialogflowCxV3EntityType) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3EntityType])
					}
					object create {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, parent: String, languageCode: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/entityTypes")).addQueryStringParameters("parent" -> parent.toString, "languageCode" -> languageCode.toString))
					}
					class `export`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3ExportEntityTypesRequest(body: Schema.GoogleCloudDialogflowCxV3ExportEntityTypesRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object `export` {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): `export` = new `export`(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/entityTypes:export")).addQueryStringParameters("parent" -> parent.toString))
					}
					class `import`(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3ImportEntityTypesRequest(body: Schema.GoogleCloudDialogflowCxV3ImportEntityTypesRequest) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleLongrunningOperation])
					}
					object `import` {
						def apply(projectsId :PlayApi, locationsId :PlayApi, agentsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): `import` = new `import`(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/agents/${agentsId}/entityTypes:import")).addQueryStringParameters("parent" -> parent.toString))
					}
					class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
						def apply() = req.execute("DELETE").map(_.json.as[Schema.GoogleProtobufEmpty])
					}
					...
					class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3EntityType]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3EntityType])
					}
					object get {
					...
					class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
						def withGoogleCloudDialogflowCxV3EntityType(body: Schema.GoogleCloudDialogflowCxV3EntityType) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleCloudDialogflowCxV3EntityType])
					}
					object patch {
					...
					class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3ListEntityTypesResponse]) {
						def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3ListEntityTypesResponse])
					}
					object list {
			...
			object securitySettings {
				class create(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudDialogflowCxV3SecuritySettings(body: Schema.GoogleCloudDialogflowCxV3SecuritySettings) = req.withBody(Json.toJson(body)).execute("POST").map(_.json.as[Schema.GoogleCloudDialogflowCxV3SecuritySettings])
				}
				object create {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String)(using auth: AuthToken, ec: ExecutionContext): create = new create(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/securitySettings")).addQueryStringParameters("parent" -> parent.toString))
				}
				class delete(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleProtobufEmpty]) {
					def apply() = req.execute("DELETE").map(_.json.as[Schema.GoogleProtobufEmpty])
				}
				object delete {
					def apply(projectsId :PlayApi, locationsId :PlayApi, securitySettingsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): delete = new delete(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/securitySettings/${securitySettingsId}")).addQueryStringParameters("name" -> name.toString))
					given Conversion[delete, Future[Schema.GoogleProtobufEmpty]] = (fun: delete) => fun.apply()
				}
				class get(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3SecuritySettings]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3SecuritySettings])
				}
				object get {
					def apply(projectsId :PlayApi, locationsId :PlayApi, securitySettingsId :PlayApi, name: String)(using auth: AuthToken, ec: ExecutionContext): get = new get(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/securitySettings/${securitySettingsId}")).addQueryStringParameters("name" -> name.toString))
					given Conversion[get, Future[Schema.GoogleCloudDialogflowCxV3SecuritySettings]] = (fun: get) => fun.apply()
				}
				class patch(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) {
					def withGoogleCloudDialogflowCxV3SecuritySettings(body: Schema.GoogleCloudDialogflowCxV3SecuritySettings) = req.withBody(Json.toJson(body)).execute("PATCH").map(_.json.as[Schema.GoogleCloudDialogflowCxV3SecuritySettings])
				}
				object patch {
					def apply(projectsId :PlayApi, locationsId :PlayApi, securitySettingsId :PlayApi, name: String, updateMask: String)(using auth: AuthToken, ec: ExecutionContext): patch = new patch(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/securitySettings/${securitySettingsId}")).addQueryStringParameters("name" -> name.toString, "updateMask" -> updateMask.toString))
				}
				class list(private val req: WSRequest)(using auth: AuthToken, ec: ExecutionContext) extends (() => Future[Schema.GoogleCloudDialogflowCxV3ListSecuritySettingsResponse]) {
					def apply() = req.execute("GET").map(_.json.as[Schema.GoogleCloudDialogflowCxV3ListSecuritySettingsResponse])
				}
				object list {
					def apply(projectsId :PlayApi, locationsId :PlayApi, parent: String, pageSize: Int, pageToken: String)(using auth: AuthToken, ec: ExecutionContext): list = new list(auth(ws.url(BASE_URL + s"v3/projects/${projectsId}/locations/${locationsId}/securitySettings")).addQueryStringParameters("parent" -> parent.toString, "pageSize" -> pageSize.toString, "pageToken" -> pageToken.toString))
